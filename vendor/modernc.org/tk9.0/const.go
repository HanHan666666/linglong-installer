...
// Named colors. Writing, for example, 'Background(Aqua)' is the same as
// writing 'Background("aqua")' but the compiler can catch any typos in the
// color name.
const (
	Aqua                 = "aqua"                 // R:0 G:255 B:255
