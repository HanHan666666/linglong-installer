...
const m_PACKAGE_STRING = "libXau 1.0.10"
const m_PACKAGE_TARNAME = "libXau"
const m_PACKAGE_URL = ""
const m_PACKAGE_VERSION = "1.0.10"
...
func XXauLockAuth(tls *libc.TLS, file_name uintptr, retries int32, timeout int32, dead int64) (r int32) {
	...
	libc.X__builtin_snprintf(tls, bp, uint64(1025), __ccgo_ts+37, libc.VaList(bp+2192, file_name))
	libc.X__builtin_snprintf(tls, bp+1025, uint64(1025), __ccgo_ts+42, libc.VaList(bp+2192, file_name))
	...
	for retries > 0 {
		if creat_fd == -int32(1) {
			creat_fd = libc.Xopen(tls, bp, libc.Int32FromInt32(m_O_WRONLY1)|libc.Int32FromInt32(m_O_CREAT1)|libc.Int32FromInt32(m_O_EXCL1), libc.VaList(bp+2192, int32(0600)))
			if creat_fd == -int32(1) {
