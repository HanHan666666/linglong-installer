...
func XXauDisposeAuth(tls *libc.TLS, auth uintptr) {
	if auth != 0 {
		...
		if (*TXauth)(unsafe.Pointer(auth)).Fdata != 0 {
			libc.Xmemset(tls, (*TXauth)(unsafe.Pointer(auth)).Fdata, 0, uint32((*TXauth)(unsafe.Pointer(auth)).Fdata_length))
...
func XXauFileName(tls *libc.TLS) (r uintptr) {
	...
	size = libc.Xstrlen(tls, name) + libc.Xstrlen(tls, slashDotXauthority+1) + uint32(2)
	...
	for {
		...
		if (libc.Int32FromUint16(family) == int32(m_FamilyWild) || libc.Int32FromUint16((*TXauth)(unsafe.Pointer(entry)).Ffamily) == int32(m_FamilyWild) || libc.Int32FromUint16((*TXauth)(unsafe.Pointer(entry)).Ffamily) == libc.Int32FromUint16(family) && (libc.Int32FromUint16(address_length) == libc.Int32FromUint16((*TXauth)(unsafe.Pointer(entry)).Faddress_length) && libc.Xmemcmp(tls, (*TXauth)(unsafe.Pointer(entry)).Faddress, address, uint32(address_length)) == 0)) && (libc.Int32FromUint16(number_length) == 0 || libc.Int32FromUint16((*TXauth)(unsafe.Pointer(entry)).Fnumber_length) == 0 || libc.Int32FromUint16(number_length) == libc.Int32FromUint16((*TXauth)(unsafe.Pointer(entry)).Fnumber_length) && libc.Xmemcmp(tls, (*TXauth)(unsafe.Pointer(entry)).Fnumber, number, uint32(number_length)) == 0) {
			...
			for {
				...
				if *(*int32)(unsafe.Pointer(type_lengths + uintptr(type1)*4)) == libc.Int32FromUint16((*TXauth)(unsafe.Pointer(entry)).Fname_length) && !(libc.Xstrncmp(tls, *(*uintptr)(unsafe.Pointer(types + uintptr(type1)*4)), (*TXauth)(unsafe.Pointer(entry)).Fname, uint32((*TXauth)(unsafe.Pointer(entry)).Fname_length)) != 0) {
					break
				}
				goto _2
			_2:
...
func XXauLockAuth(tls *libc.TLS, file_name uintptr, retries int32, timeout int32, dead int32) (r int32) {
	bp := tls.Alloc(2224)
	defer tls.Free(2224)
	var creat_fd int32
	var now Ttime_t
	...
	_, _ = creat_fd, now
	creat_fd = -int32(1)
	if libc.Xstrlen(tls, file_name) > uint32(1022) {
		return int32(m_LOCK_ERROR)
	}
	libc.X__builtin_snprintf(tls, bp, uint32(1025), __ccgo_ts+37, libc.VaList(bp+2216, file_name))
	libc.X__builtin_snprintf(tls, bp+1025, uint32(1025), __ccgo_ts+42, libc.VaList(bp+2216, file_name))
	if libc.Xstat(tls, bp, bp+2056) != -int32(1) {
		 ...
		 */
		if dead == 0 || now-(*(*Tstat)(unsafe.Pointer(bp + 2056))).Fst_ctim.Ftv_sec > int64(dead) {
			libc.Xremove(tls, bp)
	...
	for retries > 0 {
		if creat_fd == -int32(1) {
			creat_fd = libc.Xopen(tls, bp, libc.Int32FromInt32(m_O_WRONLY1)|libc.Int32FromInt32(m_O_CREAT1)|libc.Int32FromInt32(m_O_EXCL1), libc.VaList(bp+2216, int32(0600)))
			if creat_fd == -int32(1) {
		...
		if creat_fd != -int32(1) {
			...
			if int32(1) == libc.Xpathconf(tls, bp, m__PC_LINK_MAX) {
...
func _read_short(tls *libc.TLS, shortp uintptr, file uintptr) (r int32) {
	...
	if libc.Xfread(tls, bp, uint32(2), uint32(1), file) != uint32(1) {
		return 0
	}
...
func _read_counted_string(tls *libc.TLS, countp uintptr, stringp uintptr, file uintptr) (r int32) {
	...
	if libc.Int32FromUint16(*(*uint16)(unsafe.Pointer(bp))) == 0 {
		...
		data = libc.Xmalloc(tls, uint32(*(*uint16)(unsafe.Pointer(bp))))
		if !(data != 0) {
			return 0
		}
		if libc.Xfread(tls, data, uint32(1), uint32(*(*uint16)(unsafe.Pointer(bp))), file) != uint32(*(*uint16)(unsafe.Pointer(bp))) {
			libc.Xmemset(tls, data, 0, uint32(*(*uint16)(unsafe.Pointer(bp))))
			libc.Xfree(tls, data)
			return 0
		}
	}
...
func XXauReadAuth(tls *libc.TLS, auth_file uintptr) (r uintptr) {
	...
	if _read_counted_string(tls, bp+2, bp+4, auth_file) == 0 {
		return libc.UintptrFromInt32(0)
	}
	if _read_counted_string(tls, bp+8, bp+12, auth_file) == 0 {
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Faddress)
		return libc.UintptrFromInt32(0)
	}
	if _read_counted_string(tls, bp+16, bp+20, auth_file) == 0 {
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Faddress)
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Fnumber)
		return libc.UintptrFromInt32(0)
	}
	if _read_counted_string(tls, bp+24, bp+28, auth_file) == 0 {
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Faddress)
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Fnumber)
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Fname)
		return libc.UintptrFromInt32(0)
	}
	ret = libc.Xmalloc(tls, uint32(32))
	if !(ret != 0) {
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Faddress)
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Fnumber)
		libc.Xfree(tls, (*(*TXauth)(unsafe.Pointer(bp))).Fname)
		if (*(*TXauth)(unsafe.Pointer(bp))).Fdata != 0 {
			libc.Xmemset(tls, (*(*TXauth)(unsafe.Pointer(bp))).Fdata, 0, uint32((*(*TXauth)(unsafe.Pointer(bp))).Fdata_length))
...
func XXauUnlockAuth(tls *libc.TLS, file_name uintptr) (r int32) {
	...
	libc.X__builtin_snprintf(tls, bp, uint32(1025), __ccgo_ts+37, libc.VaList(bp+2064, file_name))
	libc.X__builtin_snprintf(tls, bp+1025, uint32(1025), __ccgo_ts+42, libc.VaList(bp+2064, file_name))
	/*
...
func _write_short(tls *libc.TLS, s uint16, file uintptr) (r int32) {
	...
	if libc.Xfwrite(tls, bp, uint32(2), uint32(1), file) != uint32(1) {
		return 0
	}
	return int32(1)
}
...
func _write_counted_string(tls *libc.TLS, count uint16, string1 uintptr, file uintptr) (r int32) {
	...
	if libc.Xfwrite(tls, string1, uint32(1), uint32(count), file) != uint32(count) {
		return 0
	}
	return int32(1)
}
