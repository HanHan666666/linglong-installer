...
func XRMD160Update(tls *libc.TLS, ctx uintptr, input uintptr, len1 Tsize_t) {
	...
	*(*Tuint64_t)(unsafe.Pointer(ctx + 24)) += uint64(uint32(8) * len1)
	off = uint32(0)
	if len1 >= need {
		if have != 0 {
...
func XRMD160Final(tls *libc.TLS, digest uintptr, ctx uintptr) {
	...
	if digest != libc.UintptrFromInt32(0) {
		...
		libc.Xmemset(tls, ctx, 0, uint32(96))
	}
}
...
func XSHA1Update(tls *libc.TLS, context uintptr, data uintptr, len1 Tsize_t) {
	...
	*(*Tuint64_t)(unsafe.Pointer(context + 24)) += uint64(len1 << libc.Int32FromInt32(3))
	if j+len1 > uint32(63) {
...
func XSHA1Final(tls *libc.TLS, digest uintptr, context uintptr) {
	...
	if digest != 0 {
		...
		libc.Xmemset(tls, context, 0, uint32(96))
	}
}
...
func XMD2FileChunk(tls *libc.TLS, filename uintptr, buf uintptr, off Toff_t, len1 Toff_t) (r uintptr) {
	...
	var v4 bool
	var v5 uintptr
	var _ /* buffer at bp+152 */ [1024]Tuint8_t
	var _ /* ctx at bp+1176 */ TMD2_CTX
	var _ /* sb at bp+0 */ Tstat
	_, _, _, _, _, _, _, _ = fd, nr, save_errno, v1, v2, v3, v4, v5
	XMD2Init(tls, bp+1176)
	...
	for {
		...
		v2 = libc.Xread(tls, fd, bp+152, libc.Uint32FromInt64(v3))
		nr = v2
		if !(v2 > 0) {
			break
		}
		XMD2Update(tls, bp+1176, bp+152, libc.Uint32FromInt32(nr))
		if v4 = len1 > 0; v4 {
			len1 -= int64(nr)
		}
		if v4 && len1 == 0 {
...
func XMD4FileChunk(tls *libc.TLS, filename uintptr, buf uintptr, off Toff_t, len1 Toff_t) (r uintptr) {
	...
	var v5 uintptr
	var _ /* buffer at bp+152 */ [1024]Tuint8_t
	var _ /* ctx at bp+1176 */ TMD4_CTX
	var _ /* sb at bp+0 */ Tstat
	_, _, _, _, _, _, _, _ = fd, nr, save_errno, v1, v2, v3, v4, v5
	XMD4Init(tls, bp+1176)
	v1 = libc.Xopen(tls, filename, m_O_RDONLY, 0)
	fd = v1
	if v1 < 0 {
		return libc.UintptrFromInt32(0)
	...
	for {
		...
		XMD4Update(tls, bp+1176, bp+152, libc.Uint32FromInt32(nr))
		if v4 = len1 > 0; v4 {
			len1 -= int64(nr)
		}
		if v4 && len1 == 0 {
...
func XMD5FileChunk(tls *libc.TLS, filename uintptr, buf uintptr, off Toff_t, len1 Toff_t) (r uintptr) {
	...
	var v5 uintptr
	var _ /* buffer at bp+152 */ [1024]Tuint8_t
	var _ /* ctx at bp+1176 */ TMD5_CTX
	var _ /* sb at bp+0 */ Tstat
	_, _, _, _, _, _, _, _ = fd, nr, save_errno, v1, v2, v3, v4, v5
	XMD5Init(tls, bp+1176)
	v1 = libc.Xopen(tls, filename, m_O_RDONLY, 0)
	fd = v1
	if v1 < 0 {
		return libc.UintptrFromInt32(0)
	...
	for {
		...
		XMD5Update(tls, bp+1176, bp+152, libc.Uint32FromInt32(nr))
		if v4 = len1 > 0; v4 {
			len1 -= int64(nr)
		}
		if v4 && len1 == 0 {
...
func XRMD160FileChunk(tls *libc.TLS, filename uintptr, buf uintptr, off Toff_t, len1 Toff_t) (r uintptr) {
	...
	var v5 uintptr
	var _ /* buffer at bp+152 */ [1024]Tuint8_t
	var _ /* ctx at bp+1176 */ TRMD160_CTX
	var _ /* sb at bp+0 */ Tstat
	_, _, _, _, _, _, _, _ = fd, nr, save_errno, v1, v2, v3, v4, v5
	XRMD160Init(tls, bp+1176)
	v1 = libc.Xopen(tls, filename, m_O_RDONLY, 0)
	fd = v1
	if v1 < 0 {
		return libc.UintptrFromInt32(0)
	...
	for {
		...
		XRMD160Update(tls, bp+1176, bp+152, libc.Uint32FromInt32(nr))
		if v4 = len1 > 0; v4 {
			len1 -= int64(nr)
		}
		if v4 && len1 == 0 {
...
func XSHA1FileChunk(tls *libc.TLS, filename uintptr, buf uintptr, off Toff_t, len1 Toff_t) (r uintptr) {
	...
	var v5 uintptr
	var _ /* buffer at bp+152 */ [1024]Tuint8_t
	var _ /* ctx at bp+1176 */ TSHA1_CTX
	var _ /* sb at bp+0 */ Tstat
	_, _, _, _, _, _, _, _ = fd, nr, save_errno, v1, v2, v3, v4, v5
	XSHA1Init(tls, bp+1176)
	v1 = libc.Xopen(tls, filename, m_O_RDONLY, 0)
	fd = v1
	if v1 < 0 {
		return libc.UintptrFromInt32(0)
	...
	for {
		...
		XSHA1Update(tls, bp+1176, bp+152, libc.Uint32FromInt32(nr))
		if v4 = len1 > 0; v4 {
			len1 -= int64(nr)
		}
		if v4 && len1 == 0 {
...
func XSHA256FileChunk(tls *libc.TLS, filename uintptr, buf uintptr, off Toff_t, len1 Toff_t) (r uintptr) {
	...
	var v5 uintptr
	var _ /* buffer at bp+152 */ [1024]Tuint8_t
	var _ /* ctx at bp+1176 */ TSHA2_CTX
	var _ /* sb at bp+0 */ Tstat
	_, _, _, _, _, _, _, _ = fd, nr, save_errno, v1, v2, v3, v4, v5
	XSHA256Init(tls, bp+1176)
	v1 = libc.Xopen(tls, filename, m_O_RDONLY, 0)
	fd = v1
	if v1 < 0 {
		return libc.UintptrFromInt32(0)
	...
	for {
		...
		XSHA256Update(tls, bp+1176, bp+152, libc.Uint32FromInt32(nr))
		if v4 = len1 > 0; v4 {
			len1 -= int64(nr)
		}
		if v4 && len1 == 0 {
...
func XSHA384FileChunk(tls *libc.TLS, filename uintptr, buf uintptr, off Toff_t, len1 Toff_t) (r uintptr) {
	...
	for {
		...
		XSHA512Update(tls, bp+1176, bp+152, libc.Uint32FromInt32(nr))
		if v4 = len1 > 0; v4 {
			len1 -= int64(nr)
		}
		if v4 && len1 == 0 {
