				...
				for {
					...
					if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 {
						...
						for {
							...
							libc.Xprintf(tls, __ccgo_ts+1750, libc.VaList(bp+4448, int32(_den[libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(line + uintptr(x))))>>int32(5)])))
							goto _11
						_11:
							;
							x++
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	for {
		...
		if (*TXftGlyph)(unsafe.Pointer(glyph)).Fpicture != 0 {
			...
			switch width {
			case int32(1):
				*(*int8)(unsafe.Pointer(char8 + uintptr(j))) = libc.Int8FromUint64(wire)
			case int32(2):
