...
func XXftDefaultParseBool(tls *libc.TLS, v uintptr) (r int32) {
	...
	if libc.BoolInt32(libc.Uint32FromInt32(int32(c0))-uint32('A') < uint32(26)) != 0 {
		c0 = int8(libc.Xtolower(tls, int32(c0)))
	}
	...
	if int32(c0) == int32('o') {
		...
		if libc.BoolInt32(libc.Uint32FromInt32(int32(c1))-uint32('A') < uint32(26)) != 0 {
			c1 = int8(libc.Xtolower(tls, int32(c1)))
		}
		if int32(c1) == int32('n') {
			return int32(1)
		}
...
func XXftDefaultGetBool(tls *libc.TLS, dpy uintptr, object uintptr, screen int32, def int32) (r1 int32) {
	...
	return *(*TFcBool)(unsafe.Pointer(bp + 4))
}
...
func XXftDefaultGetDouble(tls *libc.TLS, dpy uintptr, object uintptr, screen int32, def float64) (r1 float64) {
	...
	return *(*float64)(unsafe.Pointer(bp + 4))
}
...
func _XftFontInfoFill(tls *libc.TLS, dpy uintptr, pattern uintptr, fi uintptr) (r TFcBool) {
	...
	var _ /* autohint at bp+68 */ TFcBool
	var _ /* bitmap at bp+84 */ TFcBool
	var _ /* dsize at bp+8 */ float64
	var _ /* face at bp+80 */ TFT_Face
	var _ /* filename at bp+0 */ uintptr
	var _ /* fm1 at bp+28 */ TFcMatrix
	var _ /* font_matrix at bp+24 */ uintptr
	var _ /* global_advance at bp+72 */ TFcBool
	var _ /* hint_style at bp+76 */ int32
	var _ /* hinting at bp+60 */ TFcBool
	var _ /* id at bp+4 */ int32
	var _ /* vertical_layout at bp+64 */ TFcBool
	...
	if *(*uintptr)(unsafe.Pointer(bp)) != 0 {
		...
		if libfontconfig.XFcPatternGetFTFace(tls, pattern, __ccgo_ts+1236, 0, bp+80) == int32(_FcResultMatch) && *(*TFT_Face)(unsafe.Pointer(bp + 80)) != 0 {
			(*TXftFontInfo)(unsafe.Pointer(fi)).Ffile = __XftGetFaceFile(tls, *(*TFT_Face)(unsafe.Pointer(bp + 80)))
		}
	}
	...
	if XXftDebug(tls)&int32(m_XFT_DBG_OPEN) != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+1267, libc.VaList(bp+96, v1, *(*int32)(unsafe.Pointer(bp + 4)), *(*float64)(unsafe.Pointer(bp + 8))))
	}
	/*
	 * Get antialias value
	 */
	...
	for libfontconfig.XFcPatternGetMatrix(tls, pattern, __ccgo_ts+1304, mid, bp+24) == int32(_FcResultMatch) {
		...
		(*TFcMatrix)(unsafe.Pointer(bp + 28)).Fyy = v4
		(*TFcMatrix)(unsafe.Pointer(bp + 28)).Fxx = v4
		v5 = libc.Float64FromInt32(0)
		(*TFcMatrix)(unsafe.Pointer(bp + 28)).Fyx = v5
		(*TFcMatrix)(unsafe.Pointer(bp + 28)).Fxy = v5
		(*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fxx = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx) / libc.Float64FromInt32(0x10000)
		(*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fyy = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy) / libc.Float64FromInt32(0x10000)
		(*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fxy = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy) / libc.Float64FromInt32(0x10000)
		(*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fyx = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx) / libc.Float64FromInt32(0x10000)
		libfontconfig.XFcMatrixMultiply(tls, bp+28, *(*uintptr)(unsafe.Pointer(bp + 24)), bp+28)
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fxx))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fyy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fxy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 28))).Fyx))
		mid++
	}
	...
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+1311, 0, bp+84) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 84)) = m_FcFalse
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	/* disable bitmaps when anti-aliasing or transforming glyphs */
	if !(*(*TFcBool)(unsafe.Pointer(bp + 84)) != 0) && (*TXftFontInfo)(unsafe.Pointer(fi)).Fantialias != 0 || (*TXftFontInfo)(unsafe.Pointer(fi)).Ftransform != 0 {
		p6 = fi + 56
		*(*TFT_Int)(unsafe.Pointer(p6)) = TFT_Int(*(*TFT_Int)(unsafe.Pointer(p6)) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(3))
	}
	/* disable hinting if requested */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+652, 0, bp+60) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 60)) = int32(m_FcTrue)
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	...
	switch libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+642, 0, bp+76) {
	case int32(_FcResultNoMatch):
		*(*int32)(unsafe.Pointer(bp + 76)) = int32(m_FC_HINT_FULL)
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	if !(*(*TFcBool)(unsafe.Pointer(bp + 60)) != 0) || *(*int32)(unsafe.Pointer(bp + 76)) == m_FC_HINT_NONE {
		p7 = fi + 56
	...
	if (*TXftFontInfo)(unsafe.Pointer(fi)).Fantialias != 0 {
		if m_FC_HINT_NONE < *(*int32)(unsafe.Pointer(bp + 76)) && *(*int32)(unsafe.Pointer(bp + 76)) < int32(m_FC_HINT_FULL) {
	...
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+1326, 0, bp+64) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 64)) = m_FcFalse
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	if *(*TFcBool)(unsafe.Pointer(bp + 64)) != 0 {
		p8 = fi + 56
		*(*TFT_Int)(unsafe.Pointer(p8)) = TFT_Int(*(*TFT_Int)(unsafe.Pointer(p8)) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(4))
	}
	/* force autohinting if requested */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+633, 0, bp+68) {
	case int32(_FcResultNoMatch):
	...
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+1341, 0, bp+72) {
	case int32(_FcResultNoMatch):
				...
				for {
					...
					if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 {
						...
						for {
							...
							libc.Xprintf(tls, __ccgo_ts+1750, libc.VaList(bp+4376, int32(_den[libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(line + uintptr(x))))>>int32(5)])))
							goto _11
						_11:
							;
							x++
...
func XXftListFonts(tls *libc.TLS, dpy uintptr, screen int32, va1 uintptr) (r uintptr) {
	...
	for {
		...
		case int32(_FcTypeInteger):
			*(*int32)(unsafe.Pointer(bp + 4)) = libc.VaInt32(&va)
		case int32(_FcTypeDouble):
			*(*float64)(unsafe.Pointer(bp + 4)) = libc.VaFloat64(&va)
		case int32(_FcTypeString):
			*(*uintptr)(unsafe.Pointer(bp + 4)) = libc.VaUintptr(&va)
		case int32(_FcTypeBool):
			*(*TFcBool)(unsafe.Pointer(bp + 4)) = libc.VaInt32(&va)
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	for {
		...
		if (*TXftGlyph)(unsafe.Pointer(glyph)).Fpicture != 0 {
			...
			switch width {
			case int32(1):
				*(*int8)(unsafe.Pointer(char8 + uintptr(j))) = libc.Int8FromUint32(wire)
			case int32(2):
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	for {
		...
		if v7 != 0 {
			...
			switch width {
			case int32(1):
				*(*int8)(unsafe.Pointer(char8 + uintptr(j))) = libc.Int8FromUint32(g)
			case int32(2):
