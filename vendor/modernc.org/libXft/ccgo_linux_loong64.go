...
const m_PACKAGE_STRING = "libXft 2.3.4"
const m_PACKAGE_TARNAME = "libXft"
const m_PACKAGE_URL = ""
const m_PACKAGE_VERSION = "2.3.4"
const m_PACKAGE_VERSION_MAJOR = 2
const m_PACKAGE_VERSION_MINOR = 3
const m_PACKAGE_VERSION_PATCHLEVEL = 4
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	if ((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 || int32((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) != int32(0xffff)) && __XftSmoothGlyphPossible(tls, draw) != 0 {
		...
		for {
			...
			if v8 = glyph >= uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs); !v8 {
		...
		for {
			...
			if v12 = glyph >= uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs); !v12 {
...
func XXftGlyphSpecCore(tls *libc.TLS, draw uintptr, color uintptr, public uintptr, glyphs uintptr, nglyphs int32) {
	...
	if ((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 || int32((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) != int32(0xffff)) && __XftSmoothGlyphPossible(tls, draw) != 0 {
		...
		for {
			...
			if v9 = glyph >= uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs); !v9 {
		...
		for {
			...
			if v12 = glyph1 >= uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs); !v12 {
...
func XXftGlyphFontSpecCore(tls *libc.TLS, draw uintptr, color uintptr, glyphs uintptr, nglyphs int32) {
	...
	if (i != nglyphs || int32((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) != int32(0xffff)) && __XftSmoothGlyphPossible(tls, draw) != 0 {
		...
		for {
			...
			if v10 = glyph >= uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs); !v10 {
		...
		for {
			...
			if v13 = glyph1 >= uint32((*TXftFontInt)(unsafe.Pointer(font1)).Fnum_glyphs); !v13 {
...
func XXftDefaultParseBool(tls *libc.TLS, v uintptr) (r int32) {
	...
	if libc.BoolInt32(uint32(int32(c0))-uint32('A') < uint32(26)) != 0 {
	...
	if int32(c0) == int32('o') {
		...
		if libc.BoolInt32(uint32(int32(c1))-uint32('A') < uint32(26)) != 0 {
...
func XXftDrawStringUtf8(tls *libc.TLS, draw uintptr, color uintptr, pub uintptr, x int32, y int32, string1 uintptr, len1 int32) {
	...
	for {
		...
		if i == size {
			glyphs_new = libc.Xmalloc(tls, uint64(size)*uint64(2)*uint64(4))
			if !(glyphs_new != 0) {
				if glyphs != bp {
					libc.Xfree(tls, glyphs)
				}
			...
			libc.Xmemcpy(tls, glyphs_new, glyphs, uint64(size)*uint64(4))
			size *= int32(2)
			if glyphs != bp {
				libc.Xfree(tls, glyphs)
			}
...
func XXftDrawSetClipRectangles(tls *libc.TLS, draw uintptr, xOrigin int32, yOrigin int32, rects uintptr, n int32) (r int32) {
	...
	libc.Xmemcpy(tls, new1+libc.UintptrFromInt32(1)*12, rects, uint64(n)*uint64(8))
	/*
	 * Destroy existing clip
	 */
	switch (*TXftDraw)(unsafe.Pointer(draw)).Fclip_type {
...
func XXftGlyphExtents(tls *libc.TLS, dpy uintptr, pub uintptr, glyphs uintptr, nglyphs int32, extents uintptr) {
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	for n != 0 {
		...
		n--
		if v5 = glyph < uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs); v5 {
...
func __XftGetFile(tls *libc.TLS, file uintptr, id int32) (r uintptr) {
	...
	XXftMemAlloc(tls, int32(m_XFT_MEM_FILE), int32(libc.Uint64FromInt64(96)+libc.Xstrlen(tls, file)+libc.Uint64FromInt32(1)))
	if XXftDebug(tls)&int32(m_XFT_DBG_REF) != 0 {
...
func __XftReleaseFile(tls *libc.TLS, f uintptr) {
	...
	*(*int32)(unsafe.Pointer(v2))--
	...
	XXftMemFree(tls, int32(m_XFT_MEM_FILE), int32(libc.Uint64FromInt64(96)+v4))
	libc.Xfree(tls, f)
}
...
func _XftFontInfoFill(tls *libc.TLS, dpy uintptr, pattern uintptr, fi uintptr) (r TFcBool) {
	...
	nhash = int32(libc.Uint64FromInt64(104)/libc.Uint64FromInt64(4) - libc.Uint64FromInt32(1))
	for {
		v9 = nhash
		nhash--
		if !(v9 != 0) {
...
func XXftFontOpenInfo(tls *libc.TLS, dpy uintptr, pattern uintptr, fi uintptr) (r uintptr) {
	 ...
	 */
	num_glyphs = int32((*TFT_FaceRec_)(unsafe.Pointer(face)).Fnum_glyphs) + int32(1)
	alloc_size = int32(libc.Uint64FromInt64(232) + uint64(num_glyphs)*libc.Uint64FromInt64(8) + uint64(hash_value)*libc.Uint64FromInt64(8))
	font = libc.Xmalloc(tls, uint64(alloc_size))
	if !(font != 0) {
		goto bail2
	}
...
func _XftFontDestroy(tls *libc.TLS, dpy uintptr, public uintptr) {
	...
	XXftMemFree(tls, int32(m_XFT_MEM_FONT), int32(libc.Uint64FromInt64(232)+uint64((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs)*libc.Uint64FromInt64(8)+uint64((*TXftFontInt)(unsafe.Pointer(font)).Fhash_value)*libc.Uint64FromInt64(8)))
	libc.Xfree(tls, font)
}
...
func __XftFontValidateMemory(tls *libc.TLS, dpy uintptr, public uintptr) {
	...
	glyphindex = uint32(0)
	for {
		if !(glyphindex < uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs)) {
			break
		}
		...
		if subpixel != 0 { /* convert mono to ARGB32 values */
			...
			if mode == int32(_FT_RENDER_MODE_NORMAL) { /* convert mono to 8-bit gray */
				...
				for {
					...
					libc.Xmemcpy(tls, dstLine, srcLine, uint64(bytes))
					goto _5
				_5:
					;
					h--
	...
	case int32(_FT_PIXEL_MODE_GRAY):
		if subpixel != 0 { /* convert gray to ARGB32 values */
			...
			for {
				...
				libc.Xmemcpy(tls, dstLine, srcLine, uint64(width))
				goto _8
			_8:
				;
				h--
	...
	for {
		...
		if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fspacing >= int32(m_FC_MONO) {
			if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Ftransform != 0 {
				...
				libfreetype.XFT_Vector_Transform(tls, bp+4144, font+48+48)
				(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FxOff = int16((*(*TFT_Vector)(unsafe.Pointer(bp + 4144))).Fx >> libc.Int32FromInt32(6))
				(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FyOff = int16(-((*(*TFT_Vector)(unsafe.Pointer(bp + 4144))).Fy >> libc.Int32FromInt32(6)))
			} else {
				if int64((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fload_flags)&(libc.Int64FromInt64(1)<<libc.Int32FromInt32(4)) != 0 {
		...
		height = int32((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Frows)
		if XXftDebug(tls)&int32(m_XFT_DBG_GLYPH) != 0 {
			libc.Xprintf(tls, __ccgo_ts+1392, libc.VaList(bp+4168, int32(glyphindex)))
				...
				for {
					...
					if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 {
						...
						for {
							...
							libc.Xprintf(tls, __ccgo_ts+1456, libc.VaList(bp+4168, int32(_den[int32(*(*uint8)(unsafe.Pointer(line + uintptr(x))))>>int32(5)])))
							goto _11
						_11:
							;
							x++
		...
		libc.Xmemset(tls, bufBitmap, 0, uint64(size))
		...
		*(*TGlyph)(unsafe.Pointer(bp)) = uint64(glyphindex)
		(*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory = uint64(size) + uint64(32)
		if (*TXftFontInt)(unsafe.Pointer(font)).Fformat != 0 {
			if !((*TXftFontInt)(unsafe.Pointer(font)).Fglyphset != 0) {
			...
			if mode == int32(_FT_RENDER_MODE_MONO) {
				...
				if (*struct {
					...
					for {
						...
						v15 = line1
						line1++
						*(*uint8)(unsafe.Pointer(v15)) = uint8(c)
					}
				}
			} else {
			...
			if size != 0 {
				...
				if (*TXftGlyph)(unsafe.Pointer(xftg)).Fbitmap != 0 {
					libc.Xmemcpy(tls, (*TXftGlyph)(unsafe.Pointer(xftg)).Fbitmap, bufBitmap, uint64(size))
				}
			} else {
...
func XXftFontCheckGlyph(tls *libc.TLS, dpy uintptr, pub uintptr, need_bitmaps TFcBool, glyph TFT_UInt, missing uintptr, nmissing uintptr) (r TFcBool) {
	...
	font = pub
	if glyph >= uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs) {
		return m_FcFalse
	}
...
func X_XftFontUncacheGlyph(tls *libc.TLS, dpy uintptr, pub uintptr) {
	...
	*(*TFT_UInt)(unsafe.Pointer(bp)) = uint32(0)
	for {
		if !(*(*TFT_UInt)(unsafe.Pointer(bp)) < uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs)) {
			break
		}
...
func XXftNameUnparse(tls *libc.TLS, pat uintptr, dest uintptr, len1 int32) (r TFcBool) {
	...
	if libc.Xstrlen(tls, name)+uint64(1) > uint64(len1) {
		...
		libc.Xfree(tls, name)
		libfontconfig.XFcPatternDel(tls, new1, __ccgo_ts+1731)
		...
		if libc.Xstrlen(tls, name)+uint64(1) > uint64(len1) {
			libc.Xstrncpy(tls, dest, name, uint64(len1)-uint64(1))
...
func XXftGlyphRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, pub uintptr, dst TPicture, srcx int32, srcy int32, x int32, y int32, glyphs uintptr, nglyphs int32) {
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	chars = bp + 1028
	if uint64(nglyphs*size) > uint64(4096) {
	...
	for {
		...
		switch width {
		case int32(1):
			*(*int8)(unsafe.Pointer(char8 + uintptr(i))) = int8(wire)
		case int32(2):
...
func XXftGlyphSpecRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, pub uintptr, dst TPicture, srcx int32, srcy int32, glyphs uintptr, nglyphs int32) {
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	for {
		...
		if g >= uint32((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs) || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(g)*8)) != 0) {
			g = uint32(0)
		}
...
func XXftGlyphFontSpecRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, srcx int32, srcy int32, glyphs uintptr, nglyphs int32) {
	...
	for {
		...
		g = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*16))).Fglyph
		/* Substitute default for non-existant glyphs */
		if g >= uint32((*TXftFontInt)(unsafe.Pointer(font1)).Fnum_glyphs) || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font1)).Fglyphs + uintptr(g)*8)) != 0) {
			g = uint32(0)
		}
	...
	for {
		...
		g = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*16))).Fglyph
		/* Substitute default for non-existant glyphs */
		if g >= uint32((*TXftFontInt)(unsafe.Pointer(font2)).Fnum_glyphs) || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font2)).Fglyphs + uintptr(g)*8)) != 0) {
			g = uint32(0)
		}
		/*
		 * check to see if the glyph is placed where it would
	...
	for {
		...
		g = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*16))).Fglyph
		/* Substitute default for non-existant glyphs */
		if g >= uint32((*TXftFontInt)(unsafe.Pointer(font3)).Fnum_glyphs) || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font3)).Fglyphs + uintptr(g)*8)) != 0) {
			g = uint32(0)
		}
...
var _XftXlfdSlants = [3]TXftSymbolic{
	0: {
		Fname: __ccgo_ts + 1777,
	},
	1: {
		Fname:  __ccgo_ts + 1779,
...
func XXftXlfdParse(tls *libc.TLS, xlfd_orig uintptr, ignore_scalable TFcBool, complete TFcBool) (r uintptr) {
	...
	if !(libfontconfig.XFcPatternAddString(tls, pat, __ccgo_ts+1783, xlfd_orig) != 0) {
		goto bail
	}
	_XftSplitStr(tls, foundry, save)
	if *(*int8)(unsafe.Pointer(save)) != 0 && libc.Xstrcmp(tls, save, __ccgo_ts+1788) != 0 {
		if !(libfontconfig.XFcPatternAddString(tls, pat, __ccgo_ts+1790, save) != 0) {
			goto bail
		}
	}
	_XftSplitStr(tls, family, save)
	if *(*int8)(unsafe.Pointer(save)) != 0 && libc.Xstrcmp(tls, save, __ccgo_ts+1788) != 0 {
		if !(libfontconfig.XFcPatternAddString(tls, pat, __ccgo_ts+1798, save) != 0) {
			goto bail
		}
	}
	...
	if !(libfontconfig.XFcPatternAddInteger(tls, pat, __ccgo_ts+1805, weight_value) != 0) {
		goto bail
	}
	...
	if !(libfontconfig.XFcPatternAddInteger(tls, pat, __ccgo_ts+1812, slant_value) != 0) {
		goto bail
	}
	dpixel = float64(*(*int32)(unsafe.Pointer(bp)))
	if *(*int32)(unsafe.Pointer(bp + 4)) > 0 {
		if !(libfontconfig.XFcPatternAddDouble(tls, pat, __ccgo_ts+1818, float64(*(*int32)(unsafe.Pointer(bp + 4)))/float64(10)) != 0) {
			goto bail
		}
