// Code generated for linux/riscv64 by 'generator --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libfontconfig/include/linux/riscv64 -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libfreetype/include/linux/riscv64 -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libX11/include/linux/riscv64 -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libXrender/include/linux/riscv64 -lfontconfig -lfreetype -lX11 -lXrender -o libxft.go --package-name libxft src/.libs/libXft.a', DO NOT EDIT.
...
const m_FREETYPE_MINOR = 13
const m_FREETYPE_PATCH = 2
...
func __XftPutField(tls *libc.TLS, pixel TCARD32, shift int32, len1 int32) (r uint64) {
	...
	if len1 <= int32(8) {
		l_pixel = l_pixel & libc.Uint64FromInt32((libc.Int32FromInt32(1)<<len1-libc.Int32FromInt32(1))<<(libc.Int32FromInt32(8)-len1))
	}
	if shift < 0 {
...
func XXftDrawStringUtf8(tls *libc.TLS, draw uintptr, color uintptr, pub uintptr, x int32, y int32, string1 uintptr, len1 int32) {
	...
	for {
		...
		if i == size {
			glyphs_new = libc.Xmalloc(tls, libc.Uint64FromInt32(size*libc.Int32FromInt32(2))*uint64(4))
			if !(glyphs_new != 0) {
				if glyphs != bp {
					libc.Xfree(tls, glyphs)
				}
...
func _XftFontInfoFill(tls *libc.TLS, dpy uintptr, pattern uintptr, fi uintptr) (r TFcBool) {
	 ...
	 */
	libc.Xmemset(tls, fi, int32('\000'), uint64(112))
	/*
	...
	case int32(_FcResultMatch):
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx = int64(float64(libc.Float64FromInt64(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).Fxx))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy = int64(float64(libc.Float64FromInt64(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).Fyy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy = int64(float64(libc.Float64FromInt64(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).Fxy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx = int64(float64(libc.Float64FromInt64(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).Fyx))
	default:
		goto bail1
	}
	mid = int32(1)
	for libfontconfig.XFcPatternGetMatrix(tls, pattern, __ccgo_ts+1304, mid, bp+32) == int32(_FcResultMatch) {
		...
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx = int64(float64(libc.Float64FromInt64(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 40))).Fxx))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy = int64(float64(libc.Float64FromInt64(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 40))).Fyy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy = int64(float64(libc.Float64FromInt64(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 40))).Fxy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx = int64(float64(libc.Float64FromInt64(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 40))).Fyx))
		mid++
	}
	...
	nhash = libc.Int32FromUint64(libc.Uint64FromInt64(112)/libc.Uint64FromInt64(4) - libc.Uint64FromInt32(1))
	for {
		v11 = nhash
		nhash--
		if !(v11 != 0) {
...
func XXftFontOpenInfo(tls *libc.TLS, dpy uintptr, pattern uintptr, fi uintptr) (r uintptr) {
	 ...
	 */
	num_glyphs = libc.Uint32FromInt64((*TFT_FaceRec_)(unsafe.Pointer(face)).Fnum_glyphs) + uint32(1)
	...
	*(*uintptr)(unsafe.Pointer(bucket)) = font
	...
	libc.Xmemset(tls, (*TXftFontInt)(unsafe.Pointer(font)).Fglyphs, int32('\000'), uint64(num_glyphs)*uint64(8))
...
func _XftFontDestroy(tls *libc.TLS, dpy uintptr, public uintptr) {
	...
	XXftMemFree(tls, int32(_XFT_MEM_FONT), libc.Uint64FromInt64(256)+uint64((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs)*libc.Uint64FromInt64(8)+libc.Uint64FromInt32((*TXftFontInt)(unsafe.Pointer(font)).Fhash_value)*libc.Uint64FromInt64(8))
	libc.Xfree(tls, font)
}
...
func _m3x3_transform(tls *libc.TLS, v uintptr, m uintptr) {
	...
	(*TFT_Vector)(unsafe.Pointer(v)).Fx = int64(float64(x**(*float64)(unsafe.Pointer(m))) + float64(y**(*float64)(unsafe.Pointer(m + 1*8))) + *(*float64)(unsafe.Pointer(m + 2*8)) + libc.Float64FromFloat64(0.5))
	(*TFT_Vector)(unsafe.Pointer(v)).Fy = int64(float64(x**(*float64)(unsafe.Pointer(m + 1*24))) + float64(y**(*float64)(unsafe.Pointer(m + 1*24 + 1*8))) + *(*float64)(unsafe.Pointer(m + 1*24 + 2*8)) + libc.Float64FromFloat64(0.5))
}
	...
	for {
		...
		for {
			...
			if libc.Int32FromUint8((*TFT_Bitmap)(unsafe.Pointer(source)).Fpixel_mode) == int32(_FT_PIXEL_MODE_BGRA) {
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fx < int64(-sampling_width) || (*(*TFT_Vector)(unsafe.Pointer(bp))).Fx > libc.Int64FromUint32((*TFT_Bitmap)(unsafe.Pointer(source)).Fwidth+libc.Uint32FromInt32(sampling_width)) {
					goto _2
				}
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fy < int64(-sampling_height) || (*(*TFT_Vector)(unsafe.Pointer(bp))).Fy > libc.Int64FromUint32((*TFT_Bitmap)(unsafe.Pointer(source)).Frows+libc.Uint32FromInt32(sampling_height)) {
					goto _2
				}
			} else {
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fx < 0 || (*(*TFT_Vector)(unsafe.Pointer(bp))).Fx >= libc.Int64FromUint32((*TFT_Bitmap)(unsafe.Pointer(source)).Fwidth) {
					goto _2
				}
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fy < 0 || (*(*TFT_Vector)(unsafe.Pointer(bp))).Fy >= libc.Int64FromUint32((*TFT_Bitmap)(unsafe.Pointer(source)).Frows) {
					goto _2
				}
			}
			...
			case int32(_FT_PIXEL_MODE_MONO): /* convert mono to 8-bit gray, scale using nearest pixel */
				...
				if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(src + uintptr((*(*TFT_Vector)(unsafe.Pointer(bp))).Fx>>libc.Int32FromInt32(3)))))&(int32(0x80)>>((*(*TFT_Vector)(unsafe.Pointer(bp))).Fx&int64(7))) != 0 {
			...
			case int32(_FT_PIXEL_MODE_BGRA): /* scale by averaging all relevant source pixels, keep BGRA format */
				*(*[4]int32)(unsafe.Pointer(bp + 32)) = [4]int32{}
				...
				for {
					...
					if src_y < 0 || int64(src_y) >= libc.Int64FromUint32((*TFT_Bitmap)(unsafe.Pointer(source)).Frows) {
						goto _3
					}
					...
					for {
						...
						if src_x < 0 || int64(src_x) >= libc.Int64FromUint32((*TFT_Bitmap)(unsafe.Pointer(source)).Fwidth) {
							goto _4
						}
						i = 0
						for {
							...
							*(*int32)(unsafe.Pointer(bp + 32 + uintptr(i)*4)) += libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(src + uintptr(src_x*int32(4)+i))))
							goto _5
						_5:
							;
							i++
				...
				for {
					...
					*(*uint8)(unsafe.Pointer(dst_line + uintptr(int32(4)*x+i))) = libc.Uint8FromInt32((*(*[4]int32)(unsafe.Pointer(bp + 32)))[i] / sample_count)
					goto _6
				_6:
					;
					i++
...
_17:
	...
	libc.Xmemcpy(tls, dstLine, srcLine, libc.Uint64FromInt32(width)*uint64(4))
	goto _16
_16:
	;
	h--
...
func XXftFontLoadGlyphs(tls *libc.TLS, dpy uintptr, pub uintptr, need_bitmaps TFcBool, glyphs uintptr, nglyph int32) {
	...
	for {
		...
		height = libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Frows)
		if XXftDebug(tls)&int32(m_XFT_DBG_GLYPH) != 0 {
			libc.Xprintf(tls, __ccgo_ts+1686, libc.VaList(bp+4448, libc.Int32FromUint32(glyphindex)))
				...
				for {
					...
					if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 {
						...
						for {
							...
							libc.Xprintf(tls, __ccgo_ts+1750, libc.VaList(bp+4448, libc.Int32FromUint8(_den[libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(line + uintptr(x))))>>int32(5)])))
							goto _11
						_11:
							;
							x++
						...
						for {
							...
							libc.Xprintf(tls, __ccgo_ts+1750, libc.VaList(bp+4448, v13))
							goto _12
						_12:
							;
							x++
		...
		size = __compute_xrender_bitmap_size(tls, bp+4104, glyphslot, mode, v14, bp+4160)
		if size < 0 {
			continue
		}
		...
		*(*TGlyph)(unsafe.Pointer(bp)) = uint64(glyphindex)
		...
		(*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory = libc.Uint64FromInt32(size) + uint64((*TXftFontInt)(unsafe.Pointer(font)).Fsizeof_glyph)
		if (*TXftFontInt)(unsafe.Pointer(font)).Fformat != 0 {
			if !((*TXftFontInt)(unsafe.Pointer(font)).Fglyphset != 0) {
			...
			if libc.Int32FromUint8((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fbitmap.Fpixel_mode) == int32(_FT_PIXEL_MODE_BGRA) {
				...
				*(*TXImage)(unsafe.Pointer(bp + 4304)) = TXImage{
					Fwidth:            libc.Int32FromUint32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4104))).Fwidth),
					Fheight:           libc.Int32FromUint32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4104))).Frows),
					...
					Fdepth:            int32(32),
					Fbytes_per_line:   libc.Int32FromUint32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4104))).Fwidth*libc.Uint32FromInt32(4) - libc.Uint32FromInt32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4104))).Fpitch)),
				...
				if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fmatrix.Fxy != 0 || (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fmatrix.Fyx != 0 {
					*(*uint64)(unsafe.Pointer(xftg + 24)) += (*TXftFontInt)(unsafe.Pointer(font)).Fmax_glyph_memory - libc.Uint64FromInt32(size)
				} else {
					*(*uint64)(unsafe.Pointer(xftg + 24)) += libc.Uint64FromInt32(size) * uint64(255)
				}
			} else {
...
var _XftMemNotice = libc.Uint64FromInt32(libc.Int32FromInt32(1) * libc.Int32FromInt32(1024) * libc.Int32FromInt32(1024))
...
func XXftGlyphRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, pub uintptr, dst TPicture, srcx int32, srcy int32, x int32, y int32, glyphs uintptr, nglyphs int32) {
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	chars = bp + 1028
	if libc.Uint64FromInt32(nglyphs) > uint64(0xffffffffffffffff)/size {
		goto bail1
	}
	needed = libc.Uint64FromInt32(nglyphs) * size
