...
const m_FREETYPE_MINOR = 12
const m_FREETYPE_PATCH = 1
...
const m_FT_LLONG_MAX = "LLONG_MAX"
const m_FT_LLONG_MIN = "LLONG_MIN"
...
const m_FT_RASTER_FLAG_SDF = 0x8
...
const m_FT_ULLONG_MAX = "ULLONG_MAX"
...
const m_PACKAGE_STRING = "libXft 2.3.6"
const m_PACKAGE_TARNAME = "libXft"
const m_PACKAGE_URL = ""
const m_PACKAGE_VERSION = "2.3.6"
const m_PACKAGE_VERSION_MAJOR = 2
const m_PACKAGE_VERSION_MINOR = 3
const m_PACKAGE_VERSION_PATCHLEVEL = 6
...
type T_XDisplay = struct {
	...
	Fcookiejar                    uintptr
	Flast_request_read_upper32bit uint32
	Frequest_upper32bit           uint32
...
type T_XAsyncErrorState = struct {
	Fmin_sequence_number uint32
	Fmax_sequence_number uint32
	Ferror_code          uint8
	Fmajor_opcode        uint8
...
const _FT_GLYPH_FORMAT_SVG = 1398163232
...
type TFT_ULong = uint32

type TFT_F2Dot14 = int16

type TFT_F26Dot6 = int32

type TFT_Fixed = int32

type TFT_Error = int32

type TFT_Pointer = uintptr

type TFT_Offset = uint32

type TFT_PtrDist = int32
...
const _FT_Err_Invalid_SVG_Document = 24
...
const _FT_Err_Missing_SVG_Hooks = 158
...
const _FT_RENDER_MODE_SDF = 5
const _FT_RENDER_MODE_MAX = 6
...
type TGlyphSet = uint32

type TPicture = uint32

type TPictFormat = uint32
...
func XXftColorAllocName(tls *libc.TLS, dpy uintptr, visual uintptr, cmap TColormap, name uintptr, result uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	var _ /* exact at bp+12 */ TXColor
	var _ /* screen at bp+0 */ TXColor
	if !(libx11.XXAllocNamedColor(tls, dpy, cmap, name, bp, bp+12) != 0) {
		/* XXX stick standard colormap stuff here */
		return m_False
	}
	(*TXftColor)(unsafe.Pointer(result)).Fpixel = (*(*TXColor)(unsafe.Pointer(bp))).Fpixel
	(*TXftColor)(unsafe.Pointer(result)).Fcolor.Fred = (*(*TXColor)(unsafe.Pointer(bp + 12))).Fred
	(*TXftColor)(unsafe.Pointer(result)).Fcolor.Fgreen = (*(*TXColor)(unsafe.Pointer(bp + 12))).Fgreen
	(*TXftColor)(unsafe.Pointer(result)).Fcolor.Fblue = (*(*TXColor)(unsafe.Pointer(bp + 12))).Fblue
	(*TXftColor)(unsafe.Pointer(result)).Fcolor.Falpha = uint16(0xffff)
	return int32(m_True)
}

func _maskbase(tls *libc.TLS, m uint32) (r int16) {
	var i int16
	_ = i
	if !(m != 0) {
		return 0
	...
	i = 0
	for !(m&libc.Uint32FromInt32(1) != 0) {
		m >>= uint32(1)
		i++
	}
	return i
...
func _masklen(tls *libc.TLS, m uint32) (r int16) {
	var y uint32
	_ = y
	y = m >> int32(1) & uint32(033333333333)
	y = m - y - y>>int32(1)&uint32(033333333333)
	return libc.Int16FromUint32((y + y>>libc.Int32FromInt32(3)) & libc.Uint32FromUint32(030707070707) % libc.Uint32FromInt32(077))
}
...
func XXftColorFree(tls *libc.TLS, dpy uintptr, visual uintptr, cmap TColormap, color uintptr) {
	if (*TVisual)(unsafe.Pointer(visual)).Fclass != int32(m_TrueColor) {
		libx11.XXFreeColors(tls, dpy, cmap, color, int32(1), uint32(0))
	}
}
...
func XXftRectCore(tls *libc.TLS, draw uintptr, color uintptr, x int32, y int32, width uint32, height uint32) {
	if libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) >= int32(0x8000) {
...
func __XftSharpGlyphMono(tls *libc.TLS, draw uintptr, glyph uintptr, x int32, y int32) {
	...
	width = libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fwidth)
	stride = (width + int32(31)) & ^libc.Int32FromInt32(31) >> int32(3)
	height = libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fheight)
	...
	for {
		...
		xspan = x
		for w != 0 {
			if libc.Int32FromUint8(bits)&libc.Int32FromUint8(bitsMask) != 0 {
				lenspan = 0
				for cond := true; cond; cond = libc.Int32FromUint8(bits)&libc.Int32FromUint8(bitsMask) != 0 {
					lenspan++
					if lenspan == w {
						break
					}
					bitsMask = libc.Uint8FromInt32(libc.Int32FromUint8(bitsMask) >> int32(1))
					if !(bitsMask != 0) {
						v3 = src
						src++
				...
				libx11.XXFillRectangle(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Fdrawable, (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc, xspan, y, libc.Uint32FromInt32(lenspan), uint32(1))
				xspan += lenspan
				w -= lenspan
			} else {
				for cond := true; cond; cond = !(libc.Int32FromUint8(bits)&libc.Int32FromUint8(bitsMask) != 0) {
...
func __XftSharpGlyphGray(tls *libc.TLS, draw uintptr, glyph uintptr, x int32, y int32) {
	...
	for {
		...
		xspan = x
		for w != 0 {
			if libc.Int32FromUint8(bits) >= int32(0x80) {
				lenspan = 0
				for cond := true; cond; cond = libc.Int32FromUint8(bits) >= int32(0x80) {
					lenspan++
					if lenspan == w {
						break
					}
...
func __XftExamineBitfield(tls *libc.TLS, mask uint32, shift uintptr, len1 uintptr) {
	var l, s int32
	_, _ = l, s
	s = 0
	for mask&uint32(1) == uint32(0) {
		mask >>= uint32(1)
		s++
	}
	l = 0
	for mask&uint32(1) == uint32(1) {
		mask >>= uint32(1)
		l++
	}
...
func __XftGetField(tls *libc.TLS, l_pixel uint32, shift int32, len1 int32) (r TCARD32) {
	var pixel TCARD32
	_ = pixel
	pixel = l_pixel
	pixel = pixel & libc.Uint32FromInt32((libc.Int32FromInt32(1)<<len1-libc.Int32FromInt32(1))<<shift)
...
func __XftPutField(tls *libc.TLS, pixel TCARD32, shift int32, len1 int32) (r uint32) {
	var l_pixel uint32
	_ = l_pixel
	l_pixel = pixel
	shift = shift - (int32(8) - len1)
	if len1 <= int32(8) {
		l_pixel = l_pixel & libc.Uint32FromInt32((libc.Int32FromInt32(1)<<len1-libc.Int32FromInt32(1))<<(libc.Int32FromInt32(8)-len1))
	}
	if shift < 0 {
		l_pixel >>= libc.Uint32FromInt32(-shift)
	} else {
		l_pixel <<= libc.Uint32FromInt32(shift)
	}
	return l_pixel
...
func __XftSmoothGlyphMono(tls *libc.TLS, image uintptr, xftg uintptr, x int32, y int32, color uintptr) {
	...
	width = libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fwidth)
	stride = (width + int32(31)) & ^libc.Int32FromInt32(31) >> int32(3)
	height = libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fheight)
	...
	pixel = __XftPutField(tls, libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fred)>>int32(8)), *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4))) | __XftPutField(tls, libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fgreen)>>int32(8)), *(*int32)(unsafe.Pointer(bp + 8)), *(*int32)(unsafe.Pointer(bp + 12))) | __XftPutField(tls, libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fblue)>>int32(8)), *(*int32)(unsafe.Pointer(bp + 16)), *(*int32)(unsafe.Pointer(bp + 20)))
	...
	for {
		...
		for {
			...
			if libc.Int32FromUint8(bits)&libc.Int32FromUint8(bitsMask) != 0 {
				(*(*func(*libc.TLS, uintptr, int32, int32, uint32) int32)(unsafe.Pointer(&struct{ uintptr }{(*TXImage)(unsafe.Pointer(image)).Ff.Fput_pixel})))(tls, image, xspan, y, pixel)
			}
			bitsMask = libc.Uint8FromInt32(libc.Int32FromUint8(bitsMask) >> int32(1))
			if !(bitsMask != 0) {
				v4 = src
...
func _fbOver24(tls *libc.TLS, x TCARD32, y TCARD32) (r TCARD32) {
	...
	t = uint16(0)
	t = libc.Uint16FromInt32(libc.Int32FromUint16(uint16(uint8(y>>libc.Int32FromInt32(0))))*libc.Int32FromUint16(a) + libc.Int32FromInt32(0x80))
	t = libc.Uint16FromInt32(libc.Int32FromUint16(libc.Uint16FromInt32((libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)+libc.Int32FromUint16(t))>>libc.Int32FromInt32(8))) + libc.Int32FromUint16(uint16(uint8(x>>libc.Int32FromInt32(0)))))
	m = uint32(libc.Uint8FromInt32(libc.Int32FromUint16(t)|(libc.Int32FromInt32(0)-libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)))) << libc.Int32FromInt32(0)
	t = libc.Uint16FromInt32(libc.Int32FromUint16(uint16(uint8(y>>libc.Int32FromInt32(8))))*libc.Int32FromUint16(a) + libc.Int32FromInt32(0x80))
	t = libc.Uint16FromInt32(libc.Int32FromUint16(libc.Uint16FromInt32((libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)+libc.Int32FromUint16(t))>>libc.Int32FromInt32(8))) + libc.Int32FromUint16(uint16(uint8(x>>libc.Int32FromInt32(8)))))
	n = uint32(libc.Uint8FromInt32(libc.Int32FromUint16(t)|(libc.Int32FromInt32(0)-libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)))) << libc.Int32FromInt32(8)
	t = libc.Uint16FromInt32(libc.Int32FromUint16(uint16(uint8(y>>libc.Int32FromInt32(16))))*libc.Int32FromUint16(a) + libc.Int32FromInt32(0x80))
	t = libc.Uint16FromInt32(libc.Int32FromUint16(libc.Uint16FromInt32((libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)+libc.Int32FromUint16(t))>>libc.Int32FromInt32(8))) + libc.Int32FromUint16(uint16(uint8(x>>libc.Int32FromInt32(16)))))
	o = uint32(libc.Uint8FromInt32(libc.Int32FromUint16(t)|(libc.Int32FromInt32(0)-libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)))) << libc.Int32FromInt32(16)
	return m | n | o
}
...
func _fbIn(tls *libc.TLS, x TCARD32, y TCARD8) (r TCARD32) {
	...
	a = uint16(y)
	t = libc.Uint16FromInt32(libc.Int32FromUint16(uint16(uint8(x>>libc.Int32FromInt32(0))))*libc.Int32FromUint16(a) + libc.Int32FromInt32(0x80))
	m = libc.Uint32FromInt32((libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)+libc.Int32FromUint16(t))>>libc.Int32FromInt32(8)) << 0
	t = libc.Uint16FromInt32(libc.Int32FromUint16(uint16(uint8(x>>libc.Int32FromInt32(8))))*libc.Int32FromUint16(a) + libc.Int32FromInt32(0x80))
	n = libc.Uint32FromInt32((libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)+libc.Int32FromUint16(t))>>libc.Int32FromInt32(8)) << int32(8)
	t = libc.Uint16FromInt32(libc.Int32FromUint16(uint16(uint8(x>>libc.Int32FromInt32(16))))*libc.Int32FromUint16(a) + libc.Int32FromInt32(0x80))
	o = libc.Uint32FromInt32((libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)+libc.Int32FromUint16(t))>>libc.Int32FromInt32(8)) << int32(16)
	t = libc.Uint16FromInt32(libc.Int32FromUint16(uint16(uint8(x>>libc.Int32FromInt32(24))))*libc.Int32FromUint16(a) + libc.Int32FromInt32(0x80))
	p = libc.Uint32FromInt32((libc.Int32FromUint16(t)>>libc.Int32FromInt32(8)+libc.Int32FromUint16(t))>>libc.Int32FromInt32(8)) << int32(24)
	return m | n | o | p
}
...
func __XftSmoothGlyphGray8888(tls *libc.TLS, image uintptr, xftg uintptr, x int32, y int32, color uintptr) {
	...
	srca = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) >> int32(8))
	/* This handles only RGB and BGR */
	g = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fgreen) & libc.Int32FromInt32(0xff00))
	if (*TXImage)(unsafe.Pointer(image)).Fred_mask == uint32(0xff0000) {
		r = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fred) & int32(0xff00) << int32(8))
		b = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fblue) >> int32(8))
	} else {
		r = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fred) >> int32(8))
		b = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fblue) & int32(0xff00) << int32(8))
	}
	...
	for {
		...
		for {
			...
			if libc.Int32FromUint8(m) == int32(0xff) {
				if srca == uint32(0xff) {
...
func __XftSmoothGlyphGray565(tls *libc.TLS, image uintptr, xftg uintptr, x int32, y int32, color uintptr) {
	...
	/* This handles only RGB and BGR */
	g = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fgreen) & libc.Int32FromInt32(0xff00))
	if (*TXImage)(unsafe.Pointer(image)).Fred_mask == uint32(0xf800) {
		r = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fred) & int32(0xff00) << int32(8))
		b = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fblue) >> int32(8))
	} else {
		r = libc.Uint32FromInt32(libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Fred) >> int32(8))
		...
		for {
			...
			if libc.Int32FromUint8(m) == int32(0xff) {
				if srca == uint32(0xff) {
					...
					pixel = (*(*func(*libc.TLS, uintptr, int32, int32) uint32)(unsafe.Pointer(&struct{ uintptr }{(*TXImage)(unsafe.Pointer(image)).Ff.Fget_pixel})))(tls, image, tx, y)
				...
				(*(*func(*libc.TLS, uintptr, int32, int32, uint32) int32)(unsafe.Pointer(&struct{ uintptr }{(*TXImage)(unsafe.Pointer(image)).Ff.Fput_pixel})))(tls, image, tx, y, pixel)
			} else {
				if m != 0 {
					pixel = (*(*func(*libc.TLS, uintptr, int32, int32) uint32)(unsafe.Pointer(&struct{ uintptr }{(*TXImage)(unsafe.Pointer(image)).Ff.Fget_pixel})))(tls, image, tx, y)
					d = __XftGetField(tls, pixel, *(*int32)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4)))<<libc.Int32FromInt32(16) | __XftGetField(tls, pixel, *(*int32)(unsafe.Pointer(bp + 8)), *(*int32)(unsafe.Pointer(bp + 12)))<<libc.Int32FromInt32(8) | __XftGetField(tls, pixel, *(*int32)(unsafe.Pointer(bp + 16)), *(*int32)(unsafe.Pointer(bp + 20)))
		...
		for {
			...
			if ma == uint32(0xffffffff) {
				...
				if ma != 0 {
					...
					__i = libc.Uint32FromInt32(libc.Int32FromUint16(uint16(uint8(src>>libc.Int32FromInt32(0))))*libc.Int32FromUint16(__a) + libc.Int32FromInt32(0x80))
					...
					__i1 = libc.Uint32FromInt32(libc.Int32FromUint16(uint16(uint8(src>>libc.Int32FromInt32(8))))*libc.Int32FromUint16(__a1) + libc.Int32FromInt32(0x80))
					...
					__i2 = libc.Uint32FromInt32(libc.Int32FromUint16(uint16(uint8(src>>libc.Int32FromInt32(16))))*libc.Int32FromUint16(__a2) + libc.Int32FromInt32(0x80))
...
func XXftGlyphCore(tls *libc.TLS, draw uintptr, color uintptr, public uintptr, x int32, y int32, glyphs uintptr, nglyphs int32) {
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	g = glyphs
	n = nglyphs
	if ((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 || libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) != int32(0xffff)) && __XftSmoothGlyphPossible(tls, draw) != 0 {
		...
		if (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fuse_pixmap == 0 {
			...
			image = libx11.XXGetImage(tls, dpy, (*TXftDraw)(unsafe.Pointer(draw)).Fdrawable, ox, oy, uint32((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fwidth), uint32((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fheight), libc.Uint32FromInt32(^libc.Int32FromInt32(0)), int32(m_ZPixmap))
		...
		if v4 && v3 != 0 {
			...
			gc = libx11.XXCreateGC(tls, dpy, pix, libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(16)), bp+1040)
			...
			image = libx11.XXGetImage(tls, dpy, pix, 0, 0, uint32((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fwidth), uint32((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fheight), libc.Uint32FromInt32(^libc.Int32FromInt32(0)), int32(m_ZPixmap))
		...
		for {
			...
			if v8 = glyph >= (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs; !v8 {
				v7 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph)*4))
				xftg = v7
			}
			if v8 || !(v7 != 0) {
		...
		for {
			...
			if v12 = glyph >= (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs; !v12 {
				v11 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph)*4))
				xftg = v11
			}
			if v12 || !(v11 != 0) {
				xftg = __XftGlyphDefault(tls, dpy, public)
...
func XXftGlyphSpecCore(tls *libc.TLS, draw uintptr, color uintptr, public uintptr, glyphs uintptr, nglyphs int32) {
	...
	for {
		...
		*(*int32)(unsafe.Pointer(bp + 1024)) = 0
		...
		g_x2 = g_x1 + libc.Int32FromUint16((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fwidth)
		g_y2 = g_y1 + libc.Int32FromUint16((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fheight)
		if i != 0 {
			if g_x1 < x1 {
				x1 = g_x1
			}
	...
	if ((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 || libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) != int32(0xffff)) && __XftSmoothGlyphPossible(tls, draw) != 0 {
		...
		if (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fuse_pixmap == 0 {
			prev_error = libx11.XXSetErrorHandler(tls, __ccgo_fp(_XftGetImageErrorHandler))
			image = libx11.XXGetImage(tls, dpy, (*TXftDraw)(unsafe.Pointer(draw)).Fdrawable, x1, y1, libc.Uint32FromInt32(width), libc.Uint32FromInt32(height), libc.Uint32FromInt32(^libc.Int32FromInt32(0)), int32(m_ZPixmap))
			libx11.XXSetErrorHandler(tls, prev_error)
			if !(image != 0) {
				(*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fuse_pixmap = int32(m_XFT_ASSUME_PIXMAP)
			}
		...
		if v6 && v5 != 0 {
			pix = libx11.XXCreatePixmap(tls, dpy, (*TXftDraw)(unsafe.Pointer(draw)).Fdrawable, libc.Uint32FromInt32(width), libc.Uint32FromInt32(height), depth)
			(*(*TXGCValues)(unsafe.Pointer(bp + 1040))).Fgraphics_exposures = m_False
			gc = libx11.XXCreateGC(tls, dpy, pix, libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(16)), bp+1040)
			libx11.XXCopyArea(tls, dpy, (*TXftDraw)(unsafe.Pointer(draw)).Fdrawable, pix, gc, x1, y1, libc.Uint32FromInt32(width), libc.Uint32FromInt32(height), 0, 0)
			libx11.XXFreeGC(tls, dpy, gc)
			image = libx11.XXGetImage(tls, dpy, pix, 0, 0, libc.Uint32FromInt32(width), libc.Uint32FromInt32(height), libc.Uint32FromInt32(^libc.Int32FromInt32(0)), int32(m_ZPixmap))
			libx11.XXFreePixmap(tls, dpy, pix)
		}
		if !(image != 0) {
			goto bail1
		...
		for {
			...
			if v9 = glyph >= (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs; !v9 {
				v8 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph)*4))
				xftg = v8
			}
			if v9 || !(v8 != 0) {
				xftg = __XftGlyphDefault(tls, dpy, public)
		...
		libx11.XXPutImage(tls, dpy, (*TXftDraw)(unsafe.Pointer(draw)).Fdrawable, (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc, image, 0, 0, x1, y1, libc.Uint32FromInt32(width), libc.Uint32FromInt32(height))
		(*(*func(*libc.TLS, uintptr) int32)(unsafe.Pointer(&struct{ uintptr }{(*TXImage)(unsafe.Pointer(image)).Ff.Fdestroy_image})))(tls, image)
	} else {
		sharp = __XftSharpGlyphFind(tls, draw, public)
		i = 0
		for {
			...
			if v12 = glyph1 >= (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs; !v12 {
				v11 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph1)*4))
				xftg = v11
			}
			if v12 || !(v11 != 0) {
				xftg = __XftGlyphDefault(tls, dpy, public)
...
func XXftGlyphFontSpecCore(tls *libc.TLS, draw uintptr, color uintptr, glyphs uintptr, nglyphs int32) {
	...
	for {
		...
		public = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont
		*(*int32)(unsafe.Pointer(bp + 1024)) = 0
		if XXftFontCheckGlyph(tls, dpy, public, int32(m_FcTrue), (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph, bp, bp+1024) != 0 {
			glyphs_loaded = int32(m_FcTrue)
		}
		if *(*int32)(unsafe.Pointer(bp + 1024)) != 0 {
			XXftFontLoadGlyphs(tls, dpy, public, int32(m_FcTrue), bp, *(*int32)(unsafe.Pointer(bp + 1024)))
		}
		XXftGlyphExtents(tls, dpy, public, glyphs+uintptr(i)*12+4, int32(1), bp+1028)
		g_x1 = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx) - int32((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fx)
		g_y1 = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy) - int32((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fy)
		g_x2 = g_x1 + libc.Int32FromUint16((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fwidth)
		g_y2 = g_y1 + libc.Int32FromUint16((*(*TXGlyphInfo)(unsafe.Pointer(bp + 1028))).Fheight)
		if i != 0 {
			if g_x1 < x1 {
				if g_x1 < 0 {
					...
					t = int16((*TXftFont)(unsafe.Pointer((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i-int32(1))*12))).Ffont)).Fmax_advance_width + int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i-int32(1))*12))).Fx))
					if int32(t) < 0 && int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i-int32(1))*12))).Fx) > 0 {
						goto bail1
					}
				}
				x1 = g_x1
	...
	for {
		...
		if (*TXftFontInt)(unsafe.Pointer((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont)).Finfo.Fantialias != 0 {
			break
		}
		goto _5
	_5:
	...
	if (i != nglyphs || libc.Int32FromUint16((*TXftColor)(unsafe.Pointer(color)).Fcolor.Falpha) != int32(0xffff)) && __XftSmoothGlyphPossible(tls, draw) != 0 {
		width = x2 - x1
		height = y2 - y1
		/*
		 * Try to get bits directly from the drawable; if that fails,
		...
		for {
			...
			public1 = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont
			font = public1
			smooth = __XftSmoothGlyphFind(tls, draw, public1)
			glyph = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph
			if v10 = glyph >= (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs; !v10 {
				v9 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph)*4))
				xftg = v9
			}
			if v10 || !(v9 != 0) {
			...
			if xftg != 0 {
				(*(*func(*libc.TLS, uintptr, uintptr, int32, int32, uintptr))(unsafe.Pointer(&struct{ uintptr }{smooth})))(tls, image, xftg, int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx)-x1, int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy)-y1, color)
			}
			goto _8
		_8:
			;
		...
		for {
			...
			public2 = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont
			font1 = public2
			sharp = __XftSharpGlyphFind(tls, draw, public2)
			glyph1 = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph
			if v13 = glyph1 >= (*TXftFontInt)(unsafe.Pointer(font1)).Fnum_glyphs; !v13 {
				v12 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font1)).Fglyphs + uintptr(glyph1)*4))
				xftg = v12
			}
			if v13 || !(v12 != 0) {
			...
			if xftg != 0 {
				(*(*func(*libc.TLS, uintptr, uintptr, int32, int32))(unsafe.Pointer(&struct{ uintptr }{sharp})))(tls, draw, xftg, int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx), int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy))
			}
			goto _11
		_11:
			;
...
bail1:
	...
	if glyphs_loaded != 0 {
		...
		for {
			...
			X_XftFontManageMemory(tls, dpy, (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont)
			goto _14
		_14:
			;
			i++
...
func X_XftDisplayInfoGet(tls *libc.TLS, dpy uintptr, createIfNecessary TFcBool) (r uintptr) {
	...
	var i int32
	var _ /* error_base at bp+36 */ int32
	var _ /* event_base at bp+32 */ int32
	var _ /* major at bp+40 */ int32
	var _ /* minor at bp+44 */ int32
	...
	info = libc.Xmalloc(tls, uint32(820))
	if !(info != 0) {
		goto bail0
	}
	...
	(*TXftDisplayInfo)(unsafe.Pointer(info)).FhasRender = libc.BoolInt32(libxrender.XXRenderQueryExtension(tls, dpy, bp+32, bp+36) != 0 && libxrender.XXRenderFindVisualFormat(tls, dpy, (*TScreen)(unsafe.Pointer((*struct {
		Fext_data            uintptr
		Fprivate1            uintptr
		Ffd                  int32
		Fprivate2            int32
		...
		Fprivate19           int32
		Fxdefaults           uintptr
	})(unsafe.Pointer(dpy)).Fdefault_screen)*80)).Froot_visual) != libc.UintptrFromInt32(0))
	(*TXftDisplayInfo)(unsafe.Pointer(info)).Fuse_free_glyphs = int32(m_FcTrue)
	if (*TXftDisplayInfo)(unsafe.Pointer(info)).FhasRender != 0 {
		libxrender.XXRenderQueryVersion(tls, dpy, bp+40, bp+44)
		if *(*int32)(unsafe.Pointer(bp + 40)) < 0 || *(*int32)(unsafe.Pointer(bp + 40)) == 0 && *(*int32)(unsafe.Pointer(bp + 44)) <= int32(2) {
			(*TXftDisplayInfo)(unsafe.Pointer(info)).Fuse_free_glyphs = m_FcFalse
		}
		(*TXftDisplayInfo)(unsafe.Pointer(info)).FhasSolid = m_FcFalse
		if *(*int32)(unsafe.Pointer(bp + 40)) > 0 || *(*int32)(unsafe.Pointer(bp + 40)) == 0 && *(*int32)(unsafe.Pointer(bp + 44)) >= int32(10) {
		...
		(*TXftDisplayInfo)(unsafe.Pointer(info)).FsolidFormat = libxrender.XXRenderFindFormat(tls, dpy, libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(1)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(2)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(4)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(6)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(8)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(10)), bp, 0)
	}
	if XXftDebug(tls)&int32(m_XFT_DBG_RENDER) != 0 {
		visual = (*TScreen)(unsafe.Pointer((*struct {
			...
			Fprivate19           int32
			Fxdefaults           uintptr
		})(unsafe.Pointer(dpy)).Fdefault_screen)*80)).Froot_visual
		format = libxrender.XXRenderFindVisualFormat(tls, dpy, visual)
		libc.Xprintf(tls, __ccgo_ts+24, libc.VaList(bp+56, libc.Int32FromUint32((*TVisual)(unsafe.Pointer(visual)).Fvisualid)))
		if format != 0 {
			if (*TXRenderPictFormat)(unsafe.Pointer(format)).Ftype1 == int32(m_PictTypeDirect) {
				libc.Xprintf(tls, __ccgo_ts+63, libc.VaList(bp+56, int32((*TXRenderPictFormat)(unsafe.Pointer(format)).Fdirect.Falpha), int32((*TXRenderPictFormat)(unsafe.Pointer(format)).Fdirect.Fred), int32((*TXRenderPictFormat)(unsafe.Pointer(format)).Fdirect.Fgreen), int32((*TXRenderPictFormat)(unsafe.Pointer(format)).Fdirect.Fblue)))
			} else {
		...
		libc.Xprintf(tls, __ccgo_ts+147, libc.VaList(bp+56, v3))
	}
	i = 0
	for {
		...
		(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fscreen = -int32(1)
		(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict = uint32(0)
		goto _4
	_4:
		;
		i++
	...
	(*TXftDisplayInfo)(unsafe.Pointer(info)).Fnext = X_XftDisplayInfo
	X_XftDisplayInfo = info
	(*TXftDisplayInfo)(unsafe.Pointer(info)).Fglyph_memory = uint32(0)
	(*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory = libc.Uint32FromInt32(XXftDefaultGetInteger(tls, dpy, __ccgo_ts+201, 0, libc.Int32FromInt32(4)*libc.Int32FromInt32(1024)*libc.Int32FromInt32(1024)))
	if XXftDebug(tls)&int32(m_XFT_DBG_CACHE) != 0 {
		libc.Xprintf(tls, __ccgo_ts+216, libc.VaList(bp+56, (*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory))
	}
	...
	if XXftDebug(tls)&int32(m_XFT_DBG_CACHE) != 0 {
		libc.Xprintf(tls, __ccgo_ts+259, libc.VaList(bp+56, (*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_unref_fonts))
	}
	...
	if XXftDebug(tls)&int32(m_XFT_DBG_CACHE) != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+312, libc.VaList(bp+56, v5))
	}
	libc.Xmemset(tls, info+312, int32('\000'), libc.Uint32FromInt64(4)*libc.Uint32FromInt32(m_XFT_NUM_FONT_HASH))
	return info
	goto bail1
bail1:
	;
...
func __XftDisplayValidateMemory(tls *libc.TLS, info uintptr) {
	...
	var glyph_memory uint32
	_, _, _ = font, glyph_memory, public
	glyph_memory = uint32(0)
...
func X_XftDisplayManageMemory(tls *libc.TLS, dpy uintptr) {
	...
	for (*TXftDisplayInfo)(unsafe.Pointer(info)).Fglyph_memory > (*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory {
		glyph_memory = libc.Uint32FromInt32(libc.Xrand(tls)) % (*TXftDisplayInfo)(unsafe.Pointer(info)).Fglyph_memory
		public = (*TXftDisplayInfo)(unsafe.Pointer(info)).Ffonts
		for public != 0 {
			font = public
...
func XXftDefaultSet(tls *libc.TLS, dpy uintptr, defaults uintptr) (r int32) {
	...
	if !((*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory != 0) {
		(*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory = libc.Uint32FromInt32(libc.Int32FromInt32(4) * libc.Int32FromInt32(1024) * libc.Int32FromInt32(1024))
	}
	(*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory = libc.Uint32FromInt32(XXftDefaultGetInteger(tls, dpy, __ccgo_ts+201, 0, libc.Int32FromUint32((*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory)))
	if XXftDebug(tls)&int32(m_XFT_DBG_CACHE) != 0 {
...
func XXftDefaultParseBool(tls *libc.TLS, v uintptr) (r int32) {
	var c0, c1 uint8
	_, _ = c0, c1
	c0 = *(*uint8)(unsafe.Pointer(v))
	if libc.BoolInt32(libc.Uint32FromInt32(libc.Int32FromUint8(c0))-uint32('A') < uint32(26)) != 0 {
		c0 = libc.Uint8FromInt32(libc.Xtolower(tls, libc.Int32FromUint8(c0)))
	}
	if libc.Int32FromUint8(c0) == int32('t') || libc.Int32FromUint8(c0) == int32('y') || libc.Int32FromUint8(c0) == int32('1') {
		return int32(1)
	}
	if libc.Int32FromUint8(c0) == int32('f') || libc.Int32FromUint8(c0) == int32('n') || libc.Int32FromUint8(c0) == int32('0') {
		return 0
	}
	if libc.Int32FromUint8(c0) == int32('o') {
		c1 = *(*uint8)(unsafe.Pointer(v + 1))
		if libc.BoolInt32(libc.Uint32FromInt32(libc.Int32FromUint8(c1))-uint32('A') < uint32(26)) != 0 {
			c1 = libc.Uint8FromInt32(libc.Xtolower(tls, libc.Int32FromUint8(c1)))
		}
		if libc.Int32FromUint8(c1) == int32('n') {
			return int32(1)
		}
		if libc.Int32FromUint8(c1) == int32('f') {
			return 0
		}
	}
	return -int32(1)
...
func __XftDefaultInitInteger(tls *libc.TLS, dpy uintptr, pat uintptr, option uintptr) (r int32) {
	...
	var v uintptr
	var _ /* e at bp+0 */ uintptr
	var _ /* i at bp+4 */ int32
	_ = v
	v = libx11.XXGetDefault(tls, dpy, __ccgo_ts+578, option)
	if v != 0 {
		if libfontconfig.XFcNameConstant(tls, v, bp+4) != 0 {
			return libfontconfig.XFcPatternAddInteger(tls, pat, option, *(*int32)(unsafe.Pointer(bp + 4)))
		}
		*(*int32)(unsafe.Pointer(bp + 4)) = int32(libc.Xstrtol(tls, v, bp, 0))
		if *(*uintptr)(unsafe.Pointer(bp)) != v {
			return libfontconfig.XFcPatternAddInteger(tls, pat, option, *(*int32)(unsafe.Pointer(bp + 4)))
		}
	}
...
func XXftDefaultSubstitute(tls *libc.TLS, dpy uintptr, screen int32, pattern uintptr) {
	...
	if libfontconfig.XFcPatternGet(tls, pattern, __ccgo_ts+588, 0, bp) == int32(_FcResultNoMatch) {
		dpi = float64(float64((*TScreen)(unsafe.Pointer((*struct {
			Fext_data            uintptr
			Fprivate1            uintptr
			Ffd                  int32
			Fprivate2            int32
			...
			Fprivate19           int32
			Fxdefaults           uintptr
		})(unsafe.Pointer(dpy)).Fscreens+uintptr(screen)*80)).Fheight)*float64(25.4)) / float64((*TScreen)(unsafe.Pointer((*struct {
			Fext_data            uintptr
			Fprivate1            uintptr
			Ffd                  int32
			Fprivate2            int32
			...
			Fprivate19           int32
			Fxdefaults           uintptr
		})(unsafe.Pointer(dpy)).Fscreens+uintptr(screen)*80)).Fmheight)
...
func __XftDrawScreen(tls *libc.TLS, dpy uintptr, drawable TDrawable, visual uintptr) (r int32) {
	...
	var ret uintptr
	var s int32
	var _ /* borderWidth at bp+20 */ uint32
	var _ /* depth at bp+24 */ uint32
	var _ /* height at bp+16 */ uint32
	var _ /* nret at bp+68 */ int32
	var _ /* root at bp+0 */ TWindow
	var _ /* template at bp+28 */ TXVisualInfo
	var _ /* width at bp+12 */ uint32
	...
	if visual != 0 {
		...
		for {
			...
			(*(*TXVisualInfo)(unsafe.Pointer(bp + 28))).Fvisualid = (*TVisual)(unsafe.Pointer(visual)).Fvisualid
			(*(*TXVisualInfo)(unsafe.Pointer(bp + 28))).Fscreen = s
			ret = libx11.XXGetVisualInfo(tls, dpy, int32(libc.Int32FromInt32(m_VisualIDMask1)|libc.Int32FromInt32(m_VisualScreenMask1)), bp+28, bp+68)
			if ret != 0 {
	 ...
	 */
	if libx11.XXGetGeometry(tls, dpy, drawable, bp, bp+4, bp+8, bp+12, bp+16, bp+20, bp+24) != 0 {
		s = 0
		for {
			if !(s < (*struct {
				Fext_data            uintptr
			...
			if (*TScreen)(unsafe.Pointer((*struct {
				...
				Fprivate19           int32
				Fxdefaults           uintptr
			})(unsafe.Pointer(dpy)).Fscreens+uintptr(s)*80)).Froot == *(*TWindow)(unsafe.Pointer(bp)) {
				return s
			}
			goto _2
		_2:
...
func XXftDrawDepth(tls *libc.TLS, draw uintptr) (r uint32) {
	...
	if !((*TXftDraw)(unsafe.Pointer(draw)).Fdepth != 0) {
		if libx11.XXGetGeometry(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Fdrawable, bp, bp+4, bp+8, bp+12, bp+16, bp+20, bp+24) != 0 {
			(*TXftDraw)(unsafe.Pointer(draw)).Fdepth = *(*uint32)(unsafe.Pointer(bp + 24))
		}
	}
	...
	if !((*TXftDraw)(unsafe.Pointer(draw)).Fbits_per_pixel != 0) {
		...
		if v3 && v2 != 0 {
			...
			for {
				...
				if libc.Uint32FromInt32((*(*TXPixmapFormatValues)(unsafe.Pointer(formats + uintptr(i)*12))).Fdepth) == depth {
					(*TXftDraw)(unsafe.Pointer(draw)).Fbits_per_pixel = libc.Uint32FromInt32((*(*TXPixmapFormatValues)(unsafe.Pointer(formats + uintptr(i)*12))).Fbits_per_pixel)
					break
				}
				goto _4
			_4:
...
func XXftDrawCreate(tls *libc.TLS, dpy uintptr, drawable TDrawable, visual uintptr, colormap TColormap) (r uintptr) {
	var draw uintptr
	_ = draw
	draw = libc.Xmalloc(tls, uint32(52))
	if !(draw != 0) {
		return libc.UintptrFromInt32(0)
	}
	...
	(*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict = uint32(0)
	...
	XXftMemAlloc(tls, int32(_XFT_MEM_DRAW), uint32(52))
	return draw
}
...
func XXftDrawCreateBitmap(tls *libc.TLS, dpy uintptr, bitmap TPixmap) (r uintptr) {
	...
	(*TXftDraw)(unsafe.Pointer(draw)).Fcolormap = uint32(0)
	(*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict = uint32(0)
	(*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc = libc.UintptrFromInt32(0)
	(*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fuse_pixmap = 0
	(*TXftDraw)(unsafe.Pointer(draw)).Fclip_type = int32(_XftClipTypeNone)
...
func XXftDrawCreateAlpha(tls *libc.TLS, dpy uintptr, pixmap TPixmap, depth int32) (r uintptr) {
	...
	(*TXftDraw)(unsafe.Pointer(draw)).Fdepth = libc.Uint32FromInt32(depth)
...
func __XftDrawFormat(tls *libc.TLS, draw uintptr) (r uintptr) {
	...
	if (*TXftDraw)(unsafe.Pointer(draw)).Fvisual == libc.UintptrFromInt32(0) {
		(*(*TXRenderPictFormat)(unsafe.Pointer(bp))).Ftype1 = int32(m_PictTypeDirect)
		(*(*TXRenderPictFormat)(unsafe.Pointer(bp))).Fdepth = libc.Int32FromUint32(XXftDrawDepth(tls, draw))
		...
		return libxrender.XXRenderFindFormat(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(1)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(2)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(9)|libc.Int32FromInt32(1)<<libc.Int32FromInt32(10)), bp, 0)
	} else {
...
func XXftDrawDestroy(tls *libc.TLS, draw uintptr) {
	...
	case int32(_XftClipTypeRegion):
		libx11.XXDestroyRegion(tls, *(*TRegion)(unsafe.Pointer(draw + 32)))
	case int32(_XftClipTypeRectangles):
		libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(draw + 32)))
	case int32(_XftClipTypeNone):
		break
	}
	XXftMemFree(tls, int32(_XFT_MEM_DRAW), uint32(52))
	libc.Xfree(tls, draw)
}
...
func XXftDrawSrcPicture(tls *libc.TLS, draw uintptr, color uintptr) (r TPicture) {
	...
	var _ /* pa at bp+12 */ TXRenderPictureAttributes
	...
	for {
		...
		if (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict != 0 && (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fscreen == (*TXftDraw)(unsafe.Pointer(draw)).Fscreen && !(libc.Xmemcmp(tls, color+4, info+56+uintptr(i)*16, uint32(8)) != 0) {
			return (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict
		}
		goto _1
	_1:
		;
	 ...
	 */
	i = libc.Int32FromUint32(libc.Uint32FromInt32(libc.Xrand(tls)) % uint32(m_XFT_NUM_SOLID_COLOR))
	if (*TXftDisplayInfo)(unsafe.Pointer(info)).FhasSolid != 0 {
		/*
		 * Free any existing entry
		 */
		if (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict != 0 {
			libxrender.XXRenderFreePicture(tls, dpy, (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict)
		}
		/*
		 * Create picture
		 */
		(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict = libxrender.XXRenderCreateSolidFill(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, color+4)
	} else {
		if (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fscreen != (*TXftDraw)(unsafe.Pointer(draw)).Fscreen && (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict != 0 {
			libxrender.XXRenderFreePicture(tls, dpy, (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict)
			(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict = uint32(0)
		}
		/*
		...
		if !((*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict != 0) {
			pix = libx11.XXCreatePixmap(tls, dpy, (*TScreen)(unsafe.Pointer((*struct {
				...
				Fprivate19           int32
				Fxdefaults           uintptr
			})(unsafe.Pointer(dpy)).Fscreens+uintptr((*TXftDraw)(unsafe.Pointer(draw)).Fscreen)*80)).Froot, uint32(1), uint32(1), libc.Uint32FromInt32((*TXRenderPictFormat)(unsafe.Pointer((*TXftDisplayInfo)(unsafe.Pointer(info)).FsolidFormat)).Fdepth))
			(*(*TXRenderPictureAttributes)(unsafe.Pointer(bp + 12))).Frepeat = int32(m_True)
			(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict = libxrender.XXRenderCreatePicture(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, pix, (*TXftDisplayInfo)(unsafe.Pointer(info)).FsolidFormat, libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(0)), bp+12)
			libx11.XXFreePixmap(tls, dpy, pix)
		}
		/*
		 * Set to the new color
		 */
		(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fcolor = (*TXftColor)(unsafe.Pointer(color)).Fcolor
		(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fscreen = (*TXftDraw)(unsafe.Pointer(draw)).Fscreen
		libxrender.XXRenderFillRectangle(tls, dpy, int32(m_PictOpSrc), (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict, color+4, 0, 0, uint32(1), uint32(1))
	}
	(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fcolor = (*TXftColor)(unsafe.Pointer(color)).Fcolor
	(*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fscreen = (*TXftDraw)(unsafe.Pointer(draw)).Fscreen
	return (*(*TXftSolidColor)(unsafe.Pointer(info + 56 + uintptr(i)*16))).Fpict
...
func __XftDrawRenderPrepare(tls *libc.TLS, draw uintptr) (r TFcBool) {
	...
	if !((*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict != 0) {
		...
		if (*TXftDraw)(unsafe.Pointer(draw)).Fsubwindow_mode == int32(m_IncludeInferiors) {
			...
			mask |= libc.Uint32FromInt32(libc.Int32FromInt32(1) << libc.Int32FromInt32(8))
		}
		...
		switch (*TXftDraw)(unsafe.Pointer(draw)).Fclip_type {
		case int32(_XftClipTypeRegion):
			libxrender.XXRenderSetPictureClipRegion(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict, *(*TRegion)(unsafe.Pointer(draw + 32)))
		case int32(_XftClipTypeRectangles):
			libxrender.XXRenderSetPictureClipRectangles(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict, (*TXftClipRect)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(draw + 32)))).FxOrigin, (*TXftClipRect)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(draw + 32)))).FyOrigin, *(*uintptr)(unsafe.Pointer(draw + 32))+libc.UintptrFromInt32(1)*12, (*TXftClipRect)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(draw + 32)))).Fn)
		case int32(_XftClipTypeNone):
			break
		}
	}
...
func __XftDrawCorePrepare(tls *libc.TLS, draw uintptr, color uintptr) (r TFcBool) {
	...
	if !((*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc != 0) {
		...
		if (*TXftDraw)(unsafe.Pointer(draw)).Fsubwindow_mode == int32(m_IncludeInferiors) {
			...
			mask |= libc.Uint32FromInt32(libc.Int32FromInt32(1) << libc.Int32FromInt32(15))
		}
		...
		switch (*TXftDraw)(unsafe.Pointer(draw)).Fclip_type {
		case int32(_XftClipTypeRegion):
			libx11.XXSetRegion(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc, *(*TRegion)(unsafe.Pointer(draw + 32)))
		case int32(_XftClipTypeRectangles):
...
func XXftDrawString8(tls *libc.TLS, draw uintptr, color uintptr, pub uintptr, x int32, y int32, string1 uintptr, len1 int32) {
	...
	if len1 <= int32(m_NUM_LOCAL) {
		...
		glyphs = libc.Xmalloc(tls, libc.Uint32FromInt32(len1)*uint32(4))
		if !(glyphs != 0) {
			return
		}
	}
...
func XXftDrawStringUtf8(tls *libc.TLS, draw uintptr, color uintptr, pub uintptr, x int32, y int32, string1 uintptr, len1 int32) {
	...
	for {
		...
		if i == size {
			glyphs_new = libc.Xmalloc(tls, libc.Uint32FromInt32(size*libc.Int32FromInt32(2))*uint32(4))
			if !(glyphs_new != 0) {
				if glyphs != bp {
					libc.Xfree(tls, glyphs)
				}
			...
			libc.Xmemcpy(tls, glyphs_new, glyphs, libc.Uint32FromInt32(size)*uint32(4))
			size *= int32(2)
			if glyphs != bp {
				libc.Xfree(tls, glyphs)
			}
...
func XXftDrawGlyphFontSpec(tls *libc.TLS, draw uintptr, color uintptr, glyphs uintptr, len1 int32) {
	...
	for i < len1 {
		start = i
		if (*TXftFontInt)(unsafe.Pointer((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont)).Fformat != 0 {
			for i < len1 && (*TXftFontInt)(unsafe.Pointer((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont)).Fformat != 0 {
				i++
			}
			if v2 = __XftDrawRenderPrepare(tls, draw) != 0; v2 {
				v1 = XXftDrawSrcPicture(tls, draw, color)
			...
			if v2 && v1 != 0 {
				XXftGlyphFontSpecRender(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, __XftDrawOp(tls, draw, color), src, (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict, 0, 0, glyphs+uintptr(start)*12, i-start)
			}
		} else {
			for i < len1 && !((*TXftFontInt)(unsafe.Pointer((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont)).Fformat != 0) {
				i++
			...
			if __XftDrawCorePrepare(tls, draw, color) != 0 {
				XXftGlyphFontSpecCore(tls, draw, color, glyphs+uintptr(start)*12, i-start)
			}
		}
	}
}
...
func XXftDrawCharSpec(tls *libc.TLS, draw uintptr, color uintptr, pub uintptr, chars uintptr, len1 int32) {
	...
	if len1 <= int32(m_NUM_LOCAL) {
		...
		glyphs = libc.Xmalloc(tls, libc.Uint32FromInt32(len1)*uint32(8))
		if !(glyphs != 0) {
			return
		}
	}
...
func XXftDrawCharFontSpec(tls *libc.TLS, draw uintptr, color uintptr, chars uintptr, len1 int32) {
	...
	if len1 <= int32(m_NUM_LOCAL) {
		...
		glyphs = libc.Xmalloc(tls, libc.Uint32FromInt32(len1)*uint32(12))
		if !(glyphs != 0) {
			return
		}
	}
	...
	for {
		...
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont = (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Ffont
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph = XXftCharIndex(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont, (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Fucs4)
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx = (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Fx
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy = (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Fy
		goto _1
	_1:
		;
		i++
...
func XXftDrawRect(tls *libc.TLS, draw uintptr, color uintptr, x int32, y int32, width uint32, height uint32) {
	if __XftDrawRenderPrepare(tls, draw) != 0 {
		libxrender.XXRenderFillRectangle(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, int32(m_PictOpSrc), (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict, color+4, x, y, width, height)
	} else {
		if __XftDrawCorePrepare(tls, draw, color) != 0 {
...
func XXftDrawSetClip(tls *libc.TLS, draw uintptr, r TRegion) (r1 int32) {
	...
	if r != 0 && (*TXftDraw)(unsafe.Pointer(draw)).Fclip_type == int32(_XftClipTypeRegion) && libx11.XXEqualRegion(tls, r, *(*TRegion)(unsafe.Pointer(draw + 32))) != 0 {
		return int32(m_True)
	}
	/*
	...
	if n != 0 {
		...
		*(*TRegion)(unsafe.Pointer(draw + 32)) = n
	} else {
		(*TXftDraw)(unsafe.Pointer(draw)).Fclip_type = int32(_XftClipTypeNone)
	}
	/*
	...
	if (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict != 0 {
		if n != 0 {
			...
			(*(*TXRenderPictureAttributes)(unsafe.Pointer(bp))).Fclip_mask = uint32(0)
			libxrender.XXRenderChangePicture(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict, libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(6)), bp)
		}
	}
	if (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc != 0 {
		if n != 0 {
			...
			libx11.XXSetClipMask(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc, uint32(0))
		}
	}
	return int32(m_True)
}
...
func XXftDrawSetClipRectangles(tls *libc.TLS, draw uintptr, xOrigin int32, yOrigin int32, rects uintptr, n int32) (r int32) {
	 ...
	 */
	if (*TXftDraw)(unsafe.Pointer(draw)).Fclip_type == int32(_XftClipTypeRectangles) && (*TXftClipRect)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(draw + 32)))).Fn == n && (n == 0 || (*TXftClipRect)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(draw + 32)))).FxOrigin == xOrigin && (*TXftClipRect)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(draw + 32)))).FyOrigin == yOrigin) && !(libc.Xmemcmp(tls, *(*uintptr)(unsafe.Pointer(draw + 32))+libc.UintptrFromInt32(1)*12, rects, libc.Uint32FromInt32(n)*uint32(8)) != 0) {
		return int32(m_True)
	}
	/*
	 * Duplicate the region so future changes can be short circuited
	 */
	new1 = libc.Xmalloc(tls, uint32(12)+libc.Uint32FromInt32(n)*uint32(8))
	if !(new1 != 0) {
		return m_False
	}
	...
	libc.Xmemcpy(tls, new1+libc.UintptrFromInt32(1)*12, rects, libc.Uint32FromInt32(n)*uint32(8))
	/*
	 * Destroy existing clip
	 */
	switch (*TXftDraw)(unsafe.Pointer(draw)).Fclip_type {
	...
	*(*uintptr)(unsafe.Pointer(draw + 32)) = new1
	/*
	 * Apply new clip to existing objects
	 */
	if (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict != 0 {
...
func XXftDrawSetSubwindowMode(tls *libc.TLS, draw uintptr, mode int32) {
	...
	if (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict != 0 {
		...
		libxrender.XXRenderChangePicture(tls, (*TXftDraw)(unsafe.Pointer(draw)).Fdpy, (*TXftDraw)(unsafe.Pointer(draw)).Frender.Fpict, libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(8)), bp)
	}
	if (*TXftDraw)(unsafe.Pointer(draw)).Fcore.Fgc != 0 {
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	for n != 0 {
		...
		if v5 = glyph < (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs; v5 {
			v4 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph)*4))
			xftg = v4
		}
		if v5 && v4 != 0 {
			break
	...
	if n == 0 {
		if xftg != 0 {
			*(*TXGlyphInfo)(unsafe.Pointer(extents)) = (*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics
			...
			libc.Xmemset(tls, extents, int32('\000'), uint32(12))
		}
	} else {
		x = 0
		y = 0
		...
		overall_right = overall_left + libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fwidth)
		overall_bottom = overall_top + libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fheight)
		x += int32((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FxOff)
		y += int32((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FyOff)
		for {
			v6 = n
			...
			if v9 && v8 != 0 {
				...
				right = left + libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fwidth)
				bottom = top + libc.Int32FromUint16((*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fheight)
		...
		(*TXGlyphInfo)(unsafe.Pointer(extents)).Fwidth = libc.Uint16FromInt32(overall_right - overall_left)
		(*TXGlyphInfo)(unsafe.Pointer(extents)).Fheight = libc.Uint16FromInt32(overall_bottom - overall_top)
...
func __XftGetFile(tls *libc.TLS, file uintptr, id int32) (r uintptr) {
	...
	f = libc.Xmalloc(tls, uint32(48)+libc.Xstrlen(tls, file)+uint32(1))
	if !(f != 0) {
		return libc.UintptrFromInt32(0)
	}
	XXftMemAlloc(tls, int32(_XFT_MEM_FILE), uint32(48)+libc.Xstrlen(tls, file)+uint32(1))
	if XXftDebug(tls)&int32(m_XFT_DBG_REF) != 0 {
	...
	(*TXftFtFile)(unsafe.Pointer(f)).Ffile = f + libc.UintptrFromInt32(1)*48
	libc.Xstrcpy(tls, (*TXftFtFile)(unsafe.Pointer(f)).Ffile, file)
...
func __XftGetFaceFile(tls *libc.TLS, face TFT_Face) (r uintptr) {
	...
	_, _, _, _ = f, v1, v2, v3
	f = libc.Xmalloc(tls, uint32(48))
	if !(f != 0) {
		return libc.UintptrFromInt32(0)
	}
	XXftMemAlloc(tls, int32(_XFT_MEM_FILE), uint32(48))
...
func __XftLockFile(tls *libc.TLS, f uintptr) (r TFT_Face) {
	...
	if !((*TXftFtFile)(unsafe.Pointer(f)).Fface != 0) {
		...
		if libfreetype.XFT_New_Face(tls, X_XftFTlibrary, (*TXftFtFile)(unsafe.Pointer(f)).Ffile, (*TXftFtFile)(unsafe.Pointer(f)).Fid, f+44) != 0 {
			(*TXftFtFile)(unsafe.Pointer(f)).Flock--
		}
		(*TXftFtFile)(unsafe.Pointer(f)).Fxsize = 0
		(*TXftFtFile)(unsafe.Pointer(f)).Fysize = 0
...
func __XftLockError(tls *libc.TLS, reason uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1085, libc.VaList(bp+8, reason))
}
...
func X_XftSetFace(tls *libc.TLS, f uintptr, xsize TFT_F26Dot6, ysize TFT_F26Dot6, matrix uintptr) (r TFcBool) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	var best, i, v2, v3, v4, v5, v6, v7 int32
	var face TFT_Face
	var v8, v9 bool
	...
	if (*TXftFtFile)(unsafe.Pointer(f)).Fxsize != xsize || (*TXftFtFile)(unsafe.Pointer(f)).Fysize != ysize {
		if XXftDebug(tls)&int32(m_XFT_DBG_GLYPH) != 0 {
			libc.Xprintf(tls, __ccgo_ts+1130, libc.VaList(bp+8, int32(xsize>>libc.Int32FromInt32(6)), int32(ysize>>libc.Int32FromInt32(6)), xsize, ysize))
		}
		/*
		 * Bitmap only faces must match exactly, so find the closest
		 * one (height dominant search)
		 */
		if !((*TFT_FaceRec_)(unsafe.Pointer(face)).Fface_flags&(libc.Int32FromInt32(1)<<libc.Int32FromInt32(0)) != 0) {
			best = 0
			i = int32(1)
			for {
				...
				if ysize-(*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fy_ppem < 0 {
					v2 = -(ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fy_ppem)
				} else {
					v2 = ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fy_ppem
				}
				if ysize-(*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fy_ppem < 0 {
					v3 = -(ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fy_ppem)
				} else {
					v3 = ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fy_ppem
				}
				if v9 = v2 < v3; !v9 {
					if ysize-(*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fy_ppem < 0 {
						v4 = -(ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fy_ppem)
					} else {
						v4 = ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fy_ppem
					}
					if ysize-(*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fy_ppem < 0 {
						v5 = -(ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fy_ppem)
					} else {
						v5 = ysize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fy_ppem
					}
					if v8 = v4 == v5; v8 {
						if xsize-(*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fx_ppem < 0 {
							v6 = -(xsize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fx_ppem)
						} else {
							v6 = xsize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(i)*16))).Fx_ppem
						}
						if xsize-(*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fx_ppem < 0 {
							v7 = -(xsize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fx_ppem)
						} else {
							v7 = xsize - (*(*TFT_Bitmap_Size)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Favailable_sizes + uintptr(best)*16))).Fx_ppem
						}
					}
	...
	if !((*TFT_Matrix)(unsafe.Pointer(f+24)).Fxx == (*TFT_Matrix)(unsafe.Pointer(matrix)).Fxx && (*TFT_Matrix)(unsafe.Pointer(f+24)).Fyy == (*TFT_Matrix)(unsafe.Pointer(matrix)).Fyy && (*TFT_Matrix)(unsafe.Pointer(f+24)).Fxy == (*TFT_Matrix)(unsafe.Pointer(matrix)).Fxy && (*TFT_Matrix)(unsafe.Pointer(f+24)).Fyx == (*TFT_Matrix)(unsafe.Pointer(matrix)).Fyx) {
		if XXftDebug(tls)&int32(m_XFT_DBG_GLYPH) != 0 {
...
func __XftReleaseFile(tls *libc.TLS, f uintptr) {
	...
	*(*int32)(unsafe.Pointer(v2))--
	...
	if (*TXftFtFile)(unsafe.Pointer(f)).Ffile != 0 {
		v4 = libc.Xstrlen(tls, (*TXftFtFile)(unsafe.Pointer(f)).Ffile) + uint32(1)
	} else {
		v4 = uint32(0)
	}
	XXftMemFree(tls, int32(_XFT_MEM_FILE), libc.Uint32FromInt64(48)+v4)
	libc.Xfree(tls, f)
}
...
func XXftLockFace(tls *libc.TLS, public uintptr) (r TFT_Face) {
	 ...
	 */
	if face != 0 && !(X_XftSetFace(tls, (*TXftFontInfo)(unsafe.Pointer(fi)).Ffile, (*TXftFontInfo)(unsafe.Pointer(fi)).Fxsize, (*TXftFontInfo)(unsafe.Pointer(fi)).Fysize, fi+36) != 0) {
...
func _XftFontInfoFill(tls *libc.TLS, dpy uintptr, pattern uintptr, fi uintptr) (r TFcBool) {
	...
	var _ /* autohint at bp+72 */ TFcBool
	var _ /* bitmap at bp+88 */ TFcBool
	var _ /* dsize at bp+8 */ float64
	var _ /* face at bp+84 */ TFT_Face
	var _ /* filename at bp+0 */ uintptr
	var _ /* fm1 at bp+32 */ TFcMatrix
	var _ /* font_matrix at bp+24 */ uintptr
	var _ /* global_advance at bp+76 */ TFcBool
	var _ /* hint_style at bp+80 */ int32
	var _ /* hinting at bp+64 */ TFcBool
	var _ /* id at bp+4 */ int32
	var _ /* vertical_layout at bp+68 */ TFcBool
	 ...
	 */
	libc.Xmemset(tls, fi, int32('\000'), uint32(76))
	/*
	...
	switch libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+1230, 0, bp+4) {
	case int32(_FcResultNoMatch):
	...
	if *(*uintptr)(unsafe.Pointer(bp)) != 0 {
		(*TXftFontInfo)(unsafe.Pointer(fi)).Ffile = __XftGetFile(tls, *(*uintptr)(unsafe.Pointer(bp)), *(*int32)(unsafe.Pointer(bp + 4)))
	} else {
		if libfontconfig.XFcPatternGetFTFace(tls, pattern, __ccgo_ts+1236, 0, bp+84) == int32(_FcResultMatch) && *(*TFT_Face)(unsafe.Pointer(bp + 84)) != 0 {
			(*TXftFontInfo)(unsafe.Pointer(fi)).Ffile = __XftGetFaceFile(tls, *(*TFT_Face)(unsafe.Pointer(bp + 84)))
		}
	}
	 ...
	 * Compute pixel size
	 */
	if libfontconfig.XFcPatternGetDouble(tls, pattern, __ccgo_ts+1243, 0, bp+8) != int32(_FcResultMatch) {
		goto bail1
	}
	if libfontconfig.XFcPatternGetDouble(tls, pattern, __ccgo_ts+1253, 0, bp+16) != int32(_FcResultMatch) {
		*(*float64)(unsafe.Pointer(bp + 16)) = float64(1)
	}
	(*TXftFontInfo)(unsafe.Pointer(fi)).Fysize = int32(float64(*(*float64)(unsafe.Pointer(bp + 8)) * libc.Float64FromFloat64(64)))
	(*TXftFontInfo)(unsafe.Pointer(fi)).Fxsize = int32(float64(float64(*(*float64)(unsafe.Pointer(bp + 8))**(*float64)(unsafe.Pointer(bp + 16))) * libc.Float64FromFloat64(64)))
	if XXftDebug(tls)&int32(m_XFT_DBG_OPEN) != 0 {
		if *(*uintptr)(unsafe.Pointer(bp)) != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+1267, libc.VaList(bp+104, v1, *(*int32)(unsafe.Pointer(bp + 4)), *(*float64)(unsafe.Pointer(bp + 8))))
	}
	/*
	 * Get antialias value
	 */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+614, 0, fi+16) {
	case int32(_FcResultNoMatch):
	 ...
	 * Get rgba value
	 */
	switch libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+599, 0, fi+28) {
	case int32(_FcResultNoMatch):
	 ...
	 */
	switch libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+604, 0, fi+32) {
	case int32(_FcResultNoMatch):
	 ...
	 */
	switch libfontconfig.XFcPatternGetMatrix(tls, pattern, __ccgo_ts+1304, 0, bp+24) {
	case int32(_FcResultNoMatch):
		v2 = libc.Int32FromInt32(0x10000)
	...
	case int32(_FcResultMatch):
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx = int32(float64(libc.Float64FromInt32(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))).Fxx))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy = int32(float64(libc.Float64FromInt32(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))).Fyy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy = int32(float64(libc.Float64FromInt32(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))).Fxy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx = int32(float64(libc.Float64FromInt32(0x10000) * (*TFcMatrix)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 24)))).Fyx))
	default:
		goto bail1
	}
	mid = int32(1)
	for libfontconfig.XFcPatternGetMatrix(tls, pattern, __ccgo_ts+1304, mid, bp+24) == int32(_FcResultMatch) {
		v4 = libc.Float64FromInt32(1)
		(*TFcMatrix)(unsafe.Pointer(bp + 32)).Fyy = v4
		(*TFcMatrix)(unsafe.Pointer(bp + 32)).Fxx = v4
		v5 = libc.Float64FromInt32(0)
		(*TFcMatrix)(unsafe.Pointer(bp + 32)).Fyx = v5
		(*TFcMatrix)(unsafe.Pointer(bp + 32)).Fxy = v5
		(*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fxx = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx) / libc.Float64FromInt32(0x10000)
		(*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fyy = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy) / libc.Float64FromInt32(0x10000)
		(*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fxy = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy) / libc.Float64FromInt32(0x10000)
		(*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fyx = float64((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx) / libc.Float64FromInt32(0x10000)
		libfontconfig.XFcMatrixMultiply(tls, bp+32, *(*uintptr)(unsafe.Pointer(bp + 24)), bp+32)
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fxx))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fyy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fxy))
		(*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx = int32(float64(libc.Float64FromInt32(0x10000) * (*(*TFcMatrix)(unsafe.Pointer(bp + 32))).Fyx))
		mid++
	}
	(*TXftFontInfo)(unsafe.Pointer(fi)).Ftransform = libc.BoolInt32((*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxx != int32(0x10000) || (*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fxy != 0 || (*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyx != 0 || (*TXftFontInfo)(unsafe.Pointer(fi)).Fmatrix.Fyy != int32(0x10000))
	/*
	 * Get render value, set to false if no Render extension present
	 */
	if (*TXftDisplayInfo)(unsafe.Pointer(info)).FhasRender != 0 {
		switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+592, 0, fi+60) {
	 ...
	 */
	(*TXftFontInfo)(unsafe.Pointer(fi)).Fload_flags = int32(libc.Int32FromInt32(m_FT_LOAD_DEFAULT1) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(20))
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+1311, 0, bp+88) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 88)) = m_FcFalse
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	/* disable bitmaps when anti-aliasing or transforming glyphs */
	if !(*(*TFcBool)(unsafe.Pointer(bp + 88)) != 0) && (*TXftFontInfo)(unsafe.Pointer(fi)).Fantialias != 0 || (*TXftFontInfo)(unsafe.Pointer(fi)).Ftransform != 0 {
		p6 = fi + 56
		*(*TFT_Int)(unsafe.Pointer(p6)) = TFT_Int(*(*TFT_Int)(unsafe.Pointer(p6)) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(3))
	}
	/* disable hinting if requested */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+652, 0, bp+64) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 64)) = int32(m_FcTrue)
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+624, 0, fi+20) {
	case int32(_FcResultNoMatch):
	...
	switch libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+642, 0, bp+80) {
	case int32(_FcResultNoMatch):
		*(*int32)(unsafe.Pointer(bp + 80)) = int32(m_FC_HINT_FULL)
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	if !(*(*TFcBool)(unsafe.Pointer(bp + 64)) != 0) || *(*int32)(unsafe.Pointer(bp + 80)) == m_FC_HINT_NONE {
		p7 = fi + 56
		*(*TFT_Int)(unsafe.Pointer(p7)) = TFT_Int(*(*TFT_Int)(unsafe.Pointer(p7)) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(1))
	}
	...
	if (*TXftFontInfo)(unsafe.Pointer(fi)).Fantialias != 0 {
		if m_FC_HINT_NONE < *(*int32)(unsafe.Pointer(bp + 80)) && *(*int32)(unsafe.Pointer(bp + 80)) < int32(m_FC_HINT_FULL) {
			*(*TFT_Int)(unsafe.Pointer(fi + 56)) |= int32(_FT_RENDER_MODE_LIGHT) & libc.Int32FromInt32(15) << libc.Int32FromInt32(16)
		} else {
			...
			case int32(m_FC_RGBA_RGB):
				fallthrough
			case int32(m_FC_RGBA_BGR):
				*(*TFT_Int)(unsafe.Pointer(fi + 56)) |= int32(_FT_RENDER_MODE_LCD) & libc.Int32FromInt32(15) << libc.Int32FromInt32(16)
			case int32(m_FC_RGBA_VRGB):
				fallthrough
			case int32(m_FC_RGBA_VBGR):
				*(*TFT_Int)(unsafe.Pointer(fi + 56)) |= int32(_FT_RENDER_MODE_LCD_V) & libc.Int32FromInt32(15) << libc.Int32FromInt32(16)
				break
			}
		}
	} else {
		*(*TFT_Int)(unsafe.Pointer(fi + 56)) |= int32(_FT_RENDER_MODE_MONO) & libc.Int32FromInt32(15) << libc.Int32FromInt32(16)
	}
	/* set vertical layout if requested */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+1326, 0, bp+68) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 68)) = m_FcFalse
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	if *(*TFcBool)(unsafe.Pointer(bp + 68)) != 0 {
		p8 = fi + 56
		*(*TFT_Int)(unsafe.Pointer(p8)) = TFT_Int(*(*TFT_Int)(unsafe.Pointer(p8)) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(4))
	}
	/* force autohinting if requested */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+633, 0, bp+72) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 72)) = m_FcFalse
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	if *(*TFcBool)(unsafe.Pointer(bp + 72)) != 0 {
		p9 = fi + 56
		*(*TFT_Int)(unsafe.Pointer(p9)) = TFT_Int(*(*TFT_Int)(unsafe.Pointer(p9)) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(5))
	}
	/* disable global advance width (for broken DynaLab TT CJK fonts) */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+1341, 0, bp+76) {
	case int32(_FcResultNoMatch):
		*(*TFcBool)(unsafe.Pointer(bp + 76)) = int32(m_FcTrue)
	case int32(_FcResultMatch):
	default:
		goto bail1
	}
	if !(*(*TFcBool)(unsafe.Pointer(bp + 76)) != 0) {
		p10 = fi + 56
		*(*TFT_Int)(unsafe.Pointer(p10)) = TFT_Int(*(*TFT_Int)(unsafe.Pointer(p10)) | libc.Int32FromInt32(1)<<libc.Int32FromInt32(9))
	}
	/*
	 * Get requested spacing value
	 */
	switch libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+1355, 0, fi+64) {
	case int32(_FcResultNoMatch):
	 ...
	 * Check for minspace
	 */
	switch libfontconfig.XFcPatternGetBool(tls, pattern, __ccgo_ts+660, 0, fi+68) {
	case int32(_FcResultNoMatch):
	 ...
	 */
	switch libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+1363, 0, fi+72) {
	case int32(_FcResultNoMatch):
	...
	nhash = libc.Int32FromUint32(libc.Uint32FromInt64(76)/libc.Uint32FromInt64(4) - libc.Uint32FromInt32(1))
	for {
		v11 = nhash
		nhash--
		if !(v11 != 0) {
...
func XXftFontInfoCreate(tls *libc.TLS, dpy uintptr, pattern uintptr) (r uintptr) {
	...
	XXftMemAlloc(tls, int32(_XFT_MEM_FONT), uint32(76))
	return fi
}

func XXftFontInfoDestroy(tls *libc.TLS, dpy uintptr, fi uintptr) {
	_XftFontInfoEmpty(tls, dpy, fi)
	XXftMemFree(tls, int32(_XFT_MEM_FONT), uint32(76))
	libc.Xfree(tls, fi)
}
...
func XXftFontInfoEqual(tls *libc.TLS, a uintptr, b uintptr) (r TFcBool) {
	return libc.BoolInt32(libc.Xmemcmp(tls, a, b, uint32(76)) == 0)
}
...
func XXftFontOpenInfo(tls *libc.TLS, dpy uintptr, pattern uintptr, fi uintptr) (r uintptr) {
	...
	var _ /* max_glyph_memory at bp+4 */ int32
	var _ /* vector at bp+16 */ TFT_Vector
	var _ /* vector at bp+8 */ TFT_Vector
	 ...
	 */
	bucket = info + 312 + uintptr((*TXftFontInfo)(unsafe.Pointer(fi)).Fhash%uint32(m_XFT_NUM_FONT_HASH))*4
	font = *(*uintptr)(unsafe.Pointer(bucket))
	for {
		if !(font != 0) {
			break
		}
		if XXftFontInfoEqual(tls, font+32, fi) != 0 {
			v3 = font + 108
	 ...
	 */
	if XXftDebug(tls)&int32(m_XFT_DBG_CACHE) != 0 {
		libc.Xprintf(tls, __ccgo_ts+1373, libc.VaList(bp+32, (*TXftFtFile)(unsafe.Pointer((*TXftFontInfo)(unsafe.Pointer(fi)).Ffile)).Ffile, (*TXftFtFile)(unsafe.Pointer((*TXftFontInfo)(unsafe.Pointer(fi)).Ffile)).Fid, (*TXftFontInfo)(unsafe.Pointer(fi)).Fxsize>>int32(6), (*TXftFontInfo)(unsafe.Pointer(fi)).Fysize>>int32(6)))
	}
	if libfontconfig.XFcPatternGetInteger(tls, pattern, __ccgo_ts+201, 0, bp+4) != int32(_FcResultMatch) {
		*(*int32)(unsafe.Pointer(bp + 4)) = libc.Int32FromInt32(1024) * libc.Int32FromInt32(1024)
	}
	face = __XftLockFile(tls, (*TXftFontInfo)(unsafe.Pointer(fi)).Ffile)
	if !(face != 0) {
		goto bail0
	}
	if !(X_XftSetFace(tls, (*TXftFontInfo)(unsafe.Pointer(fi)).Ffile, (*TXftFontInfo)(unsafe.Pointer(fi)).Fxsize, (*TXftFontInfo)(unsafe.Pointer(fi)).Fysize, fi+36) != 0) {
		goto bail1
	}
	/*
	...
	if !!((*TFT_FaceRec_)(unsafe.Pointer(face)).Fface_flags&(libc.Int32FromInt32(1)<<libc.Int32FromInt32(14)) != 0) {
		v4 = int32(m_FcTrue)
	} else {
		v4 = m_FcFalse
	}
	 ...
	 */
	num_glyphs = libc.Uint32FromInt32((*TFT_FaceRec_)(unsafe.Pointer(face)).Fnum_glyphs) + uint32(1)
	alloc_size = libc.Uint32FromInt64(168) + num_glyphs*libc.Uint32FromInt64(4) + hash_value*libc.Uint32FromInt64(8)
	...
	if (*TXftFontInfo)(unsafe.Pointer(fi)).Ftransform != 0 {
		(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fx = 0
		(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy = (*TFT_SizeRec_)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Fsize)).Fmetrics.Fdescender
		libfreetype.XFT_Vector_Transform(tls, bp+8, fi+36)
		descent = int32(-((*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy >> libc.Int32FromInt32(6)))
		(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fx = 0
		(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy = (*TFT_SizeRec_)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Fsize)).Fmetrics.Fascender
		libfreetype.XFT_Vector_Transform(tls, bp+8, fi+36)
		ascent = int32((*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy >> libc.Int32FromInt32(6))
		if (*TXftFontInfo)(unsafe.Pointer(fi)).Fminspace != 0 {
			height = ascent + descent
		} else {
			(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fx = 0
			(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy = (*TFT_SizeRec_)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Fsize)).Fmetrics.Fheight
			libfreetype.XFT_Vector_Transform(tls, bp+8, fi+36)
			height = int32((*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy >> libc.Int32FromInt32(6))
		}
	} else {
	...
	if (*TXftFontInfo)(unsafe.Pointer(fi)).Fchar_width != 0 {
		...
		if (*TXftFontInfo)(unsafe.Pointer(fi)).Ftransform != 0 {
			(*(*TFT_Vector)(unsafe.Pointer(bp + 16))).Fx = (*TFT_SizeRec_)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Fsize)).Fmetrics.Fmax_advance
			(*(*TFT_Vector)(unsafe.Pointer(bp + 16))).Fy = 0
			libfreetype.XFT_Vector_Transform(tls, bp+16, fi+36)
			(*TXftFontInt)(unsafe.Pointer(font)).Fpublic.Fmax_advance_width = int32((*(*TFT_Vector)(unsafe.Pointer(bp + 16))).Fx >> libc.Int32FromInt32(6))
		} else {
	...
	*(*uintptr)(unsafe.Pointer(bucket)) = font
	 ...
	 */
	(*TXftFontInt)(unsafe.Pointer(font)).Fglyphs = font + libc.UintptrFromInt32(1)*168
	libc.Xmemset(tls, (*TXftFontInt)(unsafe.Pointer(font)).Fglyphs, int32('\000'), num_glyphs*uint32(4))
	(*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs = num_glyphs
	/*
	 * Memory-usage tracking
	 */
	(*TXftFontInt)(unsafe.Pointer(font)).Fnewest = uint32(0xffffffff)
	(*TXftFontInt)(unsafe.Pointer(font)).Ftotal_inuse = uint32(0)
	/*
	 * Unicode hash table information
	 */
	(*TXftFontInt)(unsafe.Pointer(font)).Fhash_table = (*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs)*4
	i = 0
	for {
		if !(libc.Uint32FromInt32(i) < hash_value) {
			break
		}
		(*(*TXftUcsHash)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fhash_table + uintptr(i)*8))).Fucs4 = libc.Uint32FromInt32(^libc.Int32FromInt32(0))
	...
	(*TXftFontInt)(unsafe.Pointer(font)).Fhash_value = libc.Int32FromUint32(hash_value)
	(*TXftFontInt)(unsafe.Pointer(font)).Frehash_value = libc.Int32FromUint32(rehash_value)
	/*
	 * X specific fields
	 */
	(*TXftFontInt)(unsafe.Pointer(font)).Fglyphset = uint32(0)
	(*TXftFontInt)(unsafe.Pointer(font)).Fformat = format
	/*
	 * Glyph memory management fields
	 */
	(*TXftFontInt)(unsafe.Pointer(font)).Fglyph_memory = uint32(0)
	(*TXftFontInt)(unsafe.Pointer(font)).Fmax_glyph_memory = libc.Uint32FromInt32(*(*int32)(unsafe.Pointer(bp + 4)))
	...
	(*TXftFontInt)(unsafe.Pointer(font)).Fsizeof_glyph = v6
	__XftUnlockFile(tls, (*TXftFontInfo)(unsafe.Pointer(fi)).Ffile)
	return font
	goto bail2
bail2:
...
func _XftFontDestroy(tls *libc.TLS, dpy uintptr, public uintptr) {
	...
	if info != 0 {
		*(*uint32)(unsafe.Pointer(info + 32)) -= (*TXftFontInt)(unsafe.Pointer(font)).Fglyph_memory
	}
	/* Clean up the info */
	_XftFontInfoEmpty(tls, dpy, font+32)
	/* Free the glyphset */
	...
	for {
		...
		xftg = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(i)*4))
		if xftg != 0 {
	...
	XXftMemFree(tls, int32(_XFT_MEM_FONT), libc.Uint32FromInt64(168)+(*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs*libc.Uint32FromInt64(4)+libc.Uint32FromInt32((*TXftFontInt)(unsafe.Pointer(font)).Fhash_value)*libc.Uint32FromInt64(8))
	libc.Xfree(tls, font)
}
...
func XXftFontManageMemory(tls *libc.TLS, dpy uintptr) {
	...
	for (*TXftDisplayInfo)(unsafe.Pointer(info)).Fnum_unref_fonts > (*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_unref_fonts {
		...
		_1:
			;
			prev = *(*uintptr)(unsafe.Pointer(prev)) + 24
		}
		/* Unhook from hash list */
		prev = info + 312 + uintptr((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fhash%uint32(m_XFT_NUM_FONT_HASH))*4
		for {
			if !(*(*uintptr)(unsafe.Pointer(prev)) != 0) {
				break
			}
		...
		_2:
			;
			prev = *(*uintptr)(unsafe.Pointer(prev)) + 28
		}
		/* Destroy the font */
...
func _m3x3_transform(tls *libc.TLS, v uintptr, m uintptr) {
	...
	(*TFT_Vector)(unsafe.Pointer(v)).Fx = int32(float64(x**(*float64)(unsafe.Pointer(m))) + float64(y**(*float64)(unsafe.Pointer(m + 1*8))) + *(*float64)(unsafe.Pointer(m + 2*8)) + libc.Float64FromFloat64(0.5))
	(*TFT_Vector)(unsafe.Pointer(v)).Fy = int32(float64(x**(*float64)(unsafe.Pointer(m + 1*24))) + float64(y**(*float64)(unsafe.Pointer(m + 1*24 + 1*8))) + *(*float64)(unsafe.Pointer(m + 1*24 + 2*8)) + libc.Float64FromFloat64(0.5))
}

func _m3x3_invert(tls *libc.TLS, m uintptr, mi uintptr) {
	var det float64
	_ = det
	det = float64(*(*float64)(unsafe.Pointer(m)) * (float64(*(*float64)(unsafe.Pointer(m + 1*24 + 1*8))**(*float64)(unsafe.Pointer(m + 2*24 + 2*8))) - float64(*(*float64)(unsafe.Pointer(m + 1*24 + 2*8))**(*float64)(unsafe.Pointer(m + 2*24 + 1*8)))))
	det -= float64(*(*float64)(unsafe.Pointer(m + 1*8)) * (float64(*(*float64)(unsafe.Pointer(m + 1*24))**(*float64)(unsafe.Pointer(m + 2*24 + 2*8))) - float64(*(*float64)(unsafe.Pointer(m + 1*24 + 2*8))**(*float64)(unsafe.Pointer(m + 2*24)))))
	det += float64(*(*float64)(unsafe.Pointer(m + 2*8)) * (float64(*(*float64)(unsafe.Pointer(m + 1*24))**(*float64)(unsafe.Pointer(m + 2*24 + 1*8))) - float64(*(*float64)(unsafe.Pointer(m + 1*24 + 1*8))**(*float64)(unsafe.Pointer(m + 2*24)))))
	det = float64(1) / det
	*(*float64)(unsafe.Pointer(mi)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m + 1*24 + 1*8))**(*float64)(unsafe.Pointer(m + 2*24 + 2*8))) - float64(*(*float64)(unsafe.Pointer(m + 1*24 + 2*8))**(*float64)(unsafe.Pointer(m + 2*24 + 1*8)))))
	*(*float64)(unsafe.Pointer(mi + 1*24)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m + 1*24 + 2*8))**(*float64)(unsafe.Pointer(m + 2*24))) - float64(*(*float64)(unsafe.Pointer(m + 1*24))**(*float64)(unsafe.Pointer(m + 2*24 + 2*8)))))
	*(*float64)(unsafe.Pointer(mi + 2*24)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m + 1*24))**(*float64)(unsafe.Pointer(m + 2*24 + 1*8))) - float64(*(*float64)(unsafe.Pointer(m + 1*24 + 1*8))**(*float64)(unsafe.Pointer(m + 2*24)))))
	*(*float64)(unsafe.Pointer(mi + 1*8)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m + 2*8))**(*float64)(unsafe.Pointer(m + 2*24 + 1*8))) - float64(*(*float64)(unsafe.Pointer(m + 1*8))**(*float64)(unsafe.Pointer(m + 2*24 + 2*8)))))
	*(*float64)(unsafe.Pointer(mi + 1*24 + 1*8)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m))**(*float64)(unsafe.Pointer(m + 2*24 + 2*8))) - float64(*(*float64)(unsafe.Pointer(m + 2*8))**(*float64)(unsafe.Pointer(m + 2*24)))))
	*(*float64)(unsafe.Pointer(mi + 2*24 + 1*8)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m + 1*8))**(*float64)(unsafe.Pointer(m + 2*24))) - float64(*(*float64)(unsafe.Pointer(m))**(*float64)(unsafe.Pointer(m + 2*24 + 1*8)))))
	*(*float64)(unsafe.Pointer(mi + 2*8)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m + 1*8))**(*float64)(unsafe.Pointer(m + 1*24 + 2*8))) - float64(*(*float64)(unsafe.Pointer(m + 2*8))**(*float64)(unsafe.Pointer(m + 1*24 + 1*8)))))
	*(*float64)(unsafe.Pointer(mi + 1*24 + 2*8)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m + 2*8))**(*float64)(unsafe.Pointer(m + 1*24))) - float64(*(*float64)(unsafe.Pointer(m))**(*float64)(unsafe.Pointer(m + 1*24 + 2*8)))))
	*(*float64)(unsafe.Pointer(mi + 2*24 + 2*8)) = float64(det * (float64(*(*float64)(unsafe.Pointer(m))**(*float64)(unsafe.Pointer(m + 1*24 + 1*8))) - float64(*(*float64)(unsafe.Pointer(m + 1*8))**(*float64)(unsafe.Pointer(m + 1*24)))))
}
...
func __XftFontValidateMemory(tls *libc.TLS, dpy uintptr, public uintptr) {
	...
	for {
		...
		xftg = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyphindex)*4))
		if xftg != 0 {
...
func __XftValidateGlyphUsage(tls *libc.TLS, font uintptr) {
	...
	if (*TXftFontInt)(unsafe.Pointer(font)).Fnewest != uint32(0xffffffff) {
		x1st = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftFontInt)(unsafe.Pointer(font)).Fnewest)*4))
		xuse = x1st
		forward = uint32(1)
		...
		for {
			...
			xuse = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(next)*4))
			goto _1
		_1:
			;
...
func __compute_xrender_bitmap_size(tls *libc.TLS, target uintptr, slot TFT_GlyphSlot, mode TFT_Render_Mode, matrix uintptr, m uintptr) (r int32) {
	...
	var v8 TFT_Fixed
	var v9 TFT_Pos
	var _ /* inverse at bp+16 */ TFT_Matrix
	...
	ftbit = slot + 76
	width = libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Fwidth)
	height = libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Frows)
	if matrix != 0 && mode == int32(_FT_RENDER_MODE_NORMAL) {
		...
		for {
			...
			for {
				...
				(*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx = xc * width
				(*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy = yc * height
				libfreetype.XFT_Vector_Transform(tls, bp+32, matrix)
				if xc == 0 && yc == 0 {
					v6 = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx
					right = v6
					left = v6
					v7 = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy
					bottom = v7
					top = v7
				} else {
					if left > (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx {
						left = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx
					}
					if right < (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx {
						right = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx
					}
					if bottom > (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy {
						bottom = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy
					}
					if top < (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy {
						top = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy
					}
				}
				goto _5
			_5:
		...
		width = right - left
		height = top - bottom
		(*(*TFT_Matrix)(unsafe.Pointer(bp))).Fxx = int32(+libc.Int32FromInt32(0x10000))
		(*(*TFT_Matrix)(unsafe.Pointer(bp))).Fyy = -int32(0x10000)
		v8 = libc.Int32FromInt32(0)
		(*(*TFT_Matrix)(unsafe.Pointer(bp))).Fyx = v8
		(*(*TFT_Matrix)(unsafe.Pointer(bp))).Fxy = v8
		*(*TFT_Matrix)(unsafe.Pointer(bp + 16)) = *(*TFT_Matrix)(unsafe.Pointer(matrix))
		libfreetype.XFT_Matrix_Multiply(tls, bp, bp+16)
		libfreetype.XFT_Matrix_Invert(tls, bp+16)
		libfreetype.XFT_Matrix_Multiply(tls, bp, bp+16)
		v9 = libc.Int32FromInt32(0)
		(*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy = v9
		(*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx = v9
		libfreetype.XFT_Vector_Transform(tls, bp+32, bp+16)
		left = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx
		bottom = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy
		(*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx = width
		(*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy = height
		libfreetype.XFT_Vector_Transform(tls, bp+32, bp+16)
		right = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fx
		top = (*(*TFT_Vector)(unsafe.Pointer(bp + 32))).Fy
		left = right - left - libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Fwidth)
		bottom = top - bottom - libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Frows)
		*(*float64)(unsafe.Pointer(m)) = float64((*(*TFT_Matrix)(unsafe.Pointer(bp + 16))).Fxx) / libc.Float64FromInt32(0x10000)
		*(*float64)(unsafe.Pointer(m + 1*8)) = float64((*(*TFT_Matrix)(unsafe.Pointer(bp + 16))).Fxy) / libc.Float64FromInt32(0x10000)
		*(*float64)(unsafe.Pointer(m + 1*24)) = float64((*(*TFT_Matrix)(unsafe.Pointer(bp + 16))).Fyx) / libc.Float64FromInt32(0x10000)
		*(*float64)(unsafe.Pointer(m + 1*24 + 1*8)) = float64((*(*TFT_Matrix)(unsafe.Pointer(bp + 16))).Fyy) / libc.Float64FromInt32(0x10000)
	...
	switch libc.Int32FromUint8((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Fpixel_mode) {
	...
	(*TFT_Bitmap)(unsafe.Pointer(target)).Fwidth = libc.Uint32FromInt32(width)
	(*TFT_Bitmap)(unsafe.Pointer(target)).Frows = libc.Uint32FromInt32(height)
...
func __scaled_fill_xrender_bitmap(tls *libc.TLS, target uintptr, source uintptr, m uintptr) {
	...
	var _ /* bgra at bp+16 */ [4]int32
	var _ /* vector at bp+0 */ TFT_Vector
	var _ /* vector0 at bp+8 */ TFT_Vector
	...
	width = libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(target)).Fwidth)
	height = libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(target)).Frows)
	pitch = (*TFT_Bitmap)(unsafe.Pointer(target)).Fpitch
	if src_pitch < 0 {
		src_buf -= uintptr(libc.Uint32FromInt32(src_pitch) * ((*TFT_Bitmap)(unsafe.Pointer(source)).Frows - libc.Uint32FromInt32(1)))
	}
	/* compute how many source pixels a target pixel spans */
	(*(*TFT_Vector)(unsafe.Pointer(bp))).Fx = int32(1)
	(*(*TFT_Vector)(unsafe.Pointer(bp))).Fy = int32(1)
	_m3x3_transform(tls, bp, m)
	(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fx = 0
	(*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy = 0
	_m3x3_transform(tls, bp+8, m)
	sampling_width = int32(((*(*TFT_Vector)(unsafe.Pointer(bp))).Fx - (*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fx) / libc.Int32FromInt32(2))
	sampling_height = int32(((*(*TFT_Vector)(unsafe.Pointer(bp))).Fy - (*(*TFT_Vector)(unsafe.Pointer(bp + 8))).Fy) / libc.Int32FromInt32(2))
	if sampling_width < 0 {
	...
	for {
		...
		for {
			...
			(*(*TFT_Vector)(unsafe.Pointer(bp))).Fx = x
			(*(*TFT_Vector)(unsafe.Pointer(bp))).Fy = height - y
			_m3x3_transform(tls, bp, m)
			if libc.Int32FromUint8((*TFT_Bitmap)(unsafe.Pointer(source)).Fpixel_mode) == int32(_FT_PIXEL_MODE_BGRA) {
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fx < -sampling_width || libc.Uint32FromInt32((*(*TFT_Vector)(unsafe.Pointer(bp))).Fx) > uint32((*TFT_Bitmap)(unsafe.Pointer(source)).Fwidth+libc.Uint32FromInt32(sampling_width)) {
					goto _2
				}
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fy < -sampling_height || libc.Uint32FromInt32((*(*TFT_Vector)(unsafe.Pointer(bp))).Fy) > uint32((*TFT_Bitmap)(unsafe.Pointer(source)).Frows+libc.Uint32FromInt32(sampling_height)) {
					goto _2
				}
			} else {
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fx < 0 || libc.Uint32FromInt32((*(*TFT_Vector)(unsafe.Pointer(bp))).Fx) >= (*TFT_Bitmap)(unsafe.Pointer(source)).Fwidth {
					goto _2
				}
				if (*(*TFT_Vector)(unsafe.Pointer(bp))).Fy < 0 || libc.Uint32FromInt32((*(*TFT_Vector)(unsafe.Pointer(bp))).Fy) >= (*TFT_Bitmap)(unsafe.Pointer(source)).Frows {
					goto _2
				}
			}
			switch libc.Int32FromUint8((*TFT_Bitmap)(unsafe.Pointer(source)).Fpixel_mode) {
			case int32(_FT_PIXEL_MODE_MONO): /* convert mono to 8-bit gray, scale using nearest pixel */
				src = src_buf + uintptr((*(*TFT_Vector)(unsafe.Pointer(bp))).Fy*src_pitch)
				if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(src + uintptr((*(*TFT_Vector)(unsafe.Pointer(bp))).Fx>>libc.Int32FromInt32(3)))))&(int32(0x80)>>((*(*TFT_Vector)(unsafe.Pointer(bp))).Fx&int32(7))) != 0 {
			...
			case int32(_FT_PIXEL_MODE_BGRA): /* scale by averaging all relevant source pixels, keep BGRA format */
				*(*[4]int32)(unsafe.Pointer(bp + 16)) = [4]int32{}
				sample_y = -sampling_height
				for {
					if !(sample_y < sampling_height+int32(1)) {
						break
					}
					src_y = (*(*TFT_Vector)(unsafe.Pointer(bp))).Fy + sample_y
					if src_y < 0 || libc.Uint32FromInt32(src_y) >= (*TFT_Bitmap)(unsafe.Pointer(source)).Frows {
						goto _3
					}
					...
					for {
						...
						src_x = (*(*TFT_Vector)(unsafe.Pointer(bp))).Fx + sample_x
						if src_x < 0 || libc.Uint32FromInt32(src_x) >= (*TFT_Bitmap)(unsafe.Pointer(source)).Fwidth {
							goto _4
						}
						i = 0
						for {
							...
							*(*int32)(unsafe.Pointer(bp + 16 + uintptr(i)*4)) += libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(src + uintptr(src_x*int32(4)+i))))
							goto _5
						_5:
							;
							i++
				...
				for {
					...
					*(*uint8)(unsafe.Pointer(dst_line + uintptr(int32(4)*x+i))) = libc.Uint8FromInt32((*(*[4]int32)(unsafe.Pointer(bp + 16)))[i] / sample_count)
					goto _6
				_6:
					;
					i++
...
func __fill_xrender_bitmap(tls *libc.TLS, target uintptr, slot TFT_GlyphSlot, mode TFT_Render_Mode, bgr int32) {
	...
	if src_pitch < 0 {
		srcLine -= uintptr(libc.Uint32FromInt32(src_pitch) * ((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Frows - libc.Uint32FromInt32(1)))
	}
	switch libc.Int32FromUint8((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Fpixel_mode) {
	case int32(_FT_PIXEL_MODE_MONO):
		goto _1
	...
	if subpixel != 0 { /* convert mono to ARGB32 values */
		...
		for {
			...
			for {
				...
				if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(srcLine + uintptr(x>>libc.Int32FromInt32(3)))))&(int32(0x80)>>(x&int32(7))) != 0 {
		...
		if mode == int32(_FT_RENDER_MODE_NORMAL) { /* convert mono to 8-bit gray */
			...
			for {
				...
				for {
					...
					if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(srcLine + uintptr(x1>>libc.Int32FromInt32(3)))))&(int32(0x80)>>(x1&int32(7))) != 0 {
			...
			for {
				...
				libc.Xmemcpy(tls, dstLine, srcLine, libc.Uint32FromInt32(bytes))
				goto _11
			_11:
				;
				h--
...
_2:
	...
	if subpixel != 0 { /* convert gray to ARGB32 values */
		...
		for {
			...
			libc.Xmemcpy(tls, dstLine, srcLine, libc.Uint32FromInt32(width))
			goto _14
		_14:
			;
			h--
...
_17:
	...
	libc.Xmemcpy(tls, dstLine, srcLine, libc.Uint32FromInt32(width)*uint32(4))
	goto _16
_16:
	;
	h--
...
func XXftFontLoadGlyphs(tls *libc.TLS, dpy uintptr, pub uintptr, need_bitmaps TFcBool, glyphs uintptr, nglyph int32) {
	bp := tls.Alloc(4464)
	defer tls.Free(4464)
	var adjust, adjust1, bottom, bufSize, c, height, i, left, right, size, top, width, x, xc, y, yc, v1, v13, v15, v3, v4, v5, v8, v9 int32
	var bufBitmap, font, ftbit, info, line, line1, xftg, xnew, xold, xuse, v14, v16, v2 uintptr
	...
	var pixmap TPixmap
	var _ /* bufLocal at bp+4 */ [4096]uint8
	var _ /* glyph at bp+0 */ TGlyph
	var _ /* image at bp+4280 */ TXImage
	var _ /* local at bp+4100 */ TFT_Bitmap
	var _ /* m at bp+4136 */ Tm3x3
	var _ /* mi at bp+4208 */ Tm3x3
	var _ /* vector at bp+4128 */ TFT_Vector
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = adjust, adjust1, bottom, bufBitmap, bufSize, c, error1, face, font, ftbit, gc, glyph_transform, glyphindex, glyphslot, height, i, info, left, line, line1, mode, pixmap, right, size, top, transform, width, x, xc, xftg, xnew, xold, xuse, y, yc, v1, v13, v14, v15, v16, v2, v3, v4, v5, v8, v9
	info = X_XftDisplayInfoGet(tls, dpy, int32(m_True))
	font = pub
	bufBitmap = bp + 4
	bufSize = int32(4096)
	...
	for {
		...
		if error1 != 0 {
			 ...
			 * missing the glyph
			 */
			if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fload_flags&(libc.Int32FromInt32(1)<<libc.Int32FromInt32(3)) != 0 {
				error1 = libfreetype.XFT_Load_Glyph(tls, face, glyphindex, int32((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fload_flags & ^(libc.Int32FromInt32(1)<<libc.Int32FromInt32(3))))
			}
			if error1 != 0 {
				continue
			}
		...
		if transform != 0 {
			...
			for {
				...
				for {
					...
					(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx = (*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.FhoriBearingX + xc*(*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.Fwidth
					(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy = (*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.FhoriBearingY - yc*(*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.Fheight
					libfreetype.XFT_Vector_Transform(tls, bp+4128, font+32+36)
					if XXftDebug(tls)&int32(m_XFT_DBG_GLYPH) != 0 {
						libc.Xprintf(tls, __ccgo_ts+1666, libc.VaList(bp+4376, xc, yc, (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx, (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy))
					}
					if xc == 0 && yc == 0 {
						v8 = (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx
						right = v8
						left = v8
						v9 = (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy
						bottom = v9
						top = v9
					} else {
						if left > (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx {
							left = (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx
						}
						if right < (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx {
							right = (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx
						}
						if bottom > (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy {
							bottom = (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy
						}
						if top < (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy {
							top = (*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy
						}
					}
					goto _7
				_7:
			...
			left = (*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.FhoriBearingX & int32(-libc.Int32FromInt32(64))
			right = int32(((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.FhoriBearingX + (*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.Fwidth + libc.Int32FromInt32(63)) & int32(-libc.Int32FromInt32(64)))
			top = int32(((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.FhoriBearingY + libc.Int32FromInt32(63)) & int32(-libc.Int32FromInt32(64)))
			bottom = ((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.FhoriBearingY - (*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fmetrics.Fheight) & int32(-libc.Int32FromInt32(64))
		}
		/*
		...
		if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fspacing >= int32(m_FC_CHARCELL) && !(transform != 0) {
			if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fload_flags&(libc.Int32FromInt32(1)<<libc.Int32FromInt32(4)) != 0 {
		...
		if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fspacing >= int32(m_FC_MONO) {
			if transform != 0 {
				if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fload_flags&(libc.Int32FromInt32(1)<<libc.Int32FromInt32(4)) != 0 {
					(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx = 0
					(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy = -(*TFT_SizeRec_)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Fsize)).Fmetrics.Fmax_advance
				} else {
					(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx = (*TFT_SizeRec_)(unsafe.Pointer((*TFT_FaceRec_)(unsafe.Pointer(face)).Fsize)).Fmetrics.Fmax_advance
					(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy = 0
				}
				libfreetype.XFT_Vector_Transform(tls, bp+4128, font+32+36)
				(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FxOff = int16(((*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx + libc.Int32FromInt32(32)) & int32(-libc.Int32FromInt32(64)) >> libc.Int32FromInt32(6))
				(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FyOff = int16(((*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy + libc.Int32FromInt32(32)) & int32(-libc.Int32FromInt32(64)) >> libc.Int32FromInt32(6))
			} else {
				if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fload_flags&(libc.Int32FromInt32(1)<<libc.Int32FromInt32(4)) != 0 {
					(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FxOff = 0
					(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FyOff = int16(-(*TXftFontInt)(unsafe.Pointer(font)).Fpublic.Fmax_advance_width)
				} else {
					(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FxOff = int16((*TXftFontInt)(unsafe.Pointer(font)).Fpublic.Fmax_advance_width)
					(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FyOff = 0
				}
			}
		} else {
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FxOff = int16(((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fadvance.Fx + libc.Int32FromInt32(32)) & int32(-libc.Int32FromInt32(64)) >> libc.Int32FromInt32(6))
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.FyOff = int16(-(((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fadvance.Fy + libc.Int32FromInt32(32)) & int32(-libc.Int32FromInt32(64)) >> libc.Int32FromInt32(6)))
		}
		/* compute the size of the final bitmap */
		ftbit = glyphslot + 76
		width = libc.Int32FromUint32((*TFT_Bitmap)(unsafe.Pointer(ftbit)).Fwidth)
				...
				for {
					...
					if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fantialias != 0 {
						...
						for {
							...
							libc.Xprintf(tls, __ccgo_ts+1750, libc.VaList(bp+4376, libc.Int32FromUint8(_den[libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(line + uintptr(x))))>>int32(5)])))
							goto _11
						_11:
							;
							x++
						...
						for {
							...
							if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(line + uintptr(x>>int32(3)))))&(int32(1)<<(x&int32(7))) != 0 {
								v13 = int32('#')
							} else {
								v13 = int32(' ')
							}
							libc.Xprintf(tls, __ccgo_ts+1750, libc.VaList(bp+4376, v13))
							goto _12
						_12:
							;
							x++
		...
		_m3x3_uniform(tls, bp+4136)
		if glyph_transform != 0 {
			v14 = font + 32 + 36
		} else {
			v14 = libc.UintptrFromInt32(0)
		}
		size = __compute_xrender_bitmap_size(tls, bp+4100, glyphslot, mode, v14, bp+4136)
		if size < 0 {
			continue
		}
		(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fwidth = uint16((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Fwidth)
		(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fheight = uint16((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Frows)
		if glyph_transform != 0 {
			_m3x3_invert(tls, bp+4136, bp+4208)
			(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx = -(*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fbitmap_left
			(*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy = (*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fbitmap_top
			_m3x3_transform(tls, bp+4128, bp+4208)
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fx = int16((*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fx)
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fmetrics.Fy = int16((*(*TFT_Vector)(unsafe.Pointer(bp + 4128))).Fy)
		} else {
		 ...
		 */
		if !(need_bitmaps != 0) && libc.Uint32FromInt32(size) > (*TXftDisplayInfo)(unsafe.Pointer(info)).Fmax_glyph_memory/uint32(100) {
			continue
		}
		/*
		...
		if size > bufSize {
			...
			bufBitmap = libc.Xmalloc(tls, libc.Uint32FromInt32(size))
			if !(bufBitmap != 0) {
				continue
			}
			bufSize = size
		}
		libc.Xmemset(tls, bufBitmap, 0, libc.Uint32FromInt32(size))
		(*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Fbuffer = bufBitmap
		if mode == int32(_FT_RENDER_MODE_NORMAL) && glyph_transform != 0 {
			__scaled_fill_xrender_bitmap(tls, bp+4100, glyphslot+76, bp+4136)
		} else {
			__fill_xrender_bitmap(tls, bp+4100, glyphslot, mode, libc.BoolInt32((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Frgba == int32(m_FC_RGBA_BGR) || (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Frgba == int32(m_FC_RGBA_VBGR)))
		}
		/*
		 ...
		 * glyphs were freed.
		 */
		*(*TGlyph)(unsafe.Pointer(bp)) = glyphindex
		if (*TXftGlyph)(unsafe.Pointer(xftg)).Fpicture != 0 {
			libxrender.XXRenderFreePicture(tls, dpy, (*TXftGlyph)(unsafe.Pointer(xftg)).Fpicture)
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fpicture = uint32(0)
		}
		(*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory = uint32(libc.Uint32FromInt32(size) + (*TXftFontInt)(unsafe.Pointer(font)).Fsizeof_glyph)
		if (*TXftFontInt)(unsafe.Pointer(font)).Fformat != 0 {
			if !((*TXftFontInt)(unsafe.Pointer(font)).Fglyphset != 0) {
			...
			if mode == int32(_FT_RENDER_MODE_MONO) {
				...
				if (*struct {
					...
					for {
						...
						c = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(line1)))
						...
						v16 = line1
						line1++
						*(*uint8)(unsafe.Pointer(v16)) = libc.Uint8FromInt32(c)
					}
				}
			} else {
				if libc.Int32FromUint8((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fbitmap.Fpixel_mode) == int32(_FT_PIXEL_MODE_BGRA) || mode != int32(_FT_RENDER_MODE_NORMAL) {
					/* invert ARGB <=> BGRA */
					if (*struct {
						Fext_data            uintptr
						Fprivate1            uintptr
			...
			if libc.Int32FromUint8((*TFT_GlyphSlotRec_)(unsafe.Pointer(glyphslot)).Fbitmap.Fpixel_mode) == int32(_FT_PIXEL_MODE_BGRA) {
				pixmap = libx11.XXCreatePixmap(tls, dpy, (*TScreen)(unsafe.Pointer((*struct {
					...
					Fprivate19           int32
					Fxdefaults           uintptr
				})(unsafe.Pointer(dpy)).Fdefault_screen)*80)).Froot, (*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Fwidth, (*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Frows, uint32(32))
				gc = libx11.XXCreateGC(tls, dpy, pixmap, uint32(0), libc.UintptrFromInt32(0))
				*(*TXImage)(unsafe.Pointer(bp + 4280)) = TXImage{
					Fwidth:            libc.Int32FromUint32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Fwidth),
					Fheight:           libc.Int32FromUint32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Frows),
					...
					Fdepth:            int32(32),
					Fbytes_per_line:   libc.Int32FromUint32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Fwidth*libc.Uint32FromInt32(4) - libc.Uint32FromInt32((*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Fpitch)),
					Fbits_per_pixel:   int32(32),
				}
				libx11.XXInitImage(tls, bp+4280)
				libx11.XXPutImage(tls, dpy, pixmap, gc, bp+4280, 0, 0, 0, 0, (*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Fwidth, (*(*TFT_Bitmap)(unsafe.Pointer(bp + 4100))).Frows)
				(*TXftGlyph)(unsafe.Pointer(xftg)).Fpicture = libxrender.XXRenderCreatePicture(tls, dpy, pixmap, (*TXftFontInt)(unsafe.Pointer(font)).Fformat, uint32(0), libc.UintptrFromInt32(0))
				libx11.XXFreeGC(tls, dpy, gc)
				...
				if (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fmatrix.Fxy != 0 || (*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fmatrix.Fyx != 0 {
					*(*uint32)(unsafe.Pointer(xftg + 16)) += (*TXftFontInt)(unsafe.Pointer(font)).Fmax_glyph_memory - libc.Uint32FromInt32(size)
				} else {
					*(*uint32)(unsafe.Pointer(xftg + 16)) += uint32(libc.Uint32FromInt32(size) * uint32(255))
				}
			} else {
			...
			if size != 0 {
				(*TXftGlyph)(unsafe.Pointer(xftg)).Fbitmap = libc.Xmalloc(tls, libc.Uint32FromInt32(size))
				if (*TXftGlyph)(unsafe.Pointer(xftg)).Fbitmap != 0 {
					libc.Xmemcpy(tls, (*TXftGlyph)(unsafe.Pointer(xftg)).Fbitmap, bufBitmap, libc.Uint32FromInt32(size))
				}
			} else {
				(*TXftGlyph)(unsafe.Pointer(xftg)).Fbitmap = libc.UintptrFromInt32(0)
			}
		}
		*(*uint32)(unsafe.Pointer(font + 140)) += (*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory
		*(*uint32)(unsafe.Pointer(info + 32)) += (*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory
		if XXftDebug(tls)&int32(m_XFT_DBG_CACHE) != 0 {
			__XftFontValidateMemory(tls, dpy, pub)
		}
		if XXftDebug(tls)&int32(m_XFT_DBG_CACHEV) != 0 {
			libc.Xprintf(tls, __ccgo_ts+1758, libc.VaList(bp+4376, glyphindex, (*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory))
		}
		if (*TXftFontInt)(unsafe.Pointer(font)).Ftrack_mem_usage != 0 {
			xuse = xftg
			if (*TXftFontInt)(unsafe.Pointer(font)).Fnewest == uint32(0xffffffff) {
				...
				if XXftDebug(tls)&int32(m_XFT_DBG_USAGE) != 0 {
					libc.Xprintf(tls, __ccgo_ts+1787, libc.VaList(bp+4376, font, glyphindex, xuse, (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Folder, (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Fnewer))
				}
			} else {
				xnew = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftFontInt)(unsafe.Pointer(font)).Fnewest)*4))
				xold = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftGlyphUsage)(unsafe.Pointer(xnew)).Fnewer)*4))
				...
				if XXftDebug(tls)&int32(m_XFT_DBG_USAGE) != 0 {
					libc.Xprintf(tls, __ccgo_ts+1817, libc.VaList(bp+4376, font, glyphindex, xuse, (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Folder, (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Fnewer, xnew, (*TXftGlyphUsage)(unsafe.Pointer(xnew)).Folder, (*TXftGlyphUsage)(unsafe.Pointer(xnew)).Fnewer, xold, (*TXftGlyphUsage)(unsafe.Pointer(xold)).Folder, (*TXftGlyphUsage)(unsafe.Pointer(xold)).Fnewer))
				}
			}
...
func XXftFontUnloadGlyphs(tls *libc.TLS, dpy uintptr, pub uintptr, glyphs uintptr, nglyph int32) {
	...
	for {
		...
		if (*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory != 0 {
			if XXftDebug(tls)&int32(m_XFT_DBG_CACHEV) != 0 {
				libc.Xprintf(tls, __ccgo_ts+1874, libc.VaList(bp+4104, glyphindex, (*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory))
			}
			if (*TXftFontInt)(unsafe.Pointer(font)).Fformat != 0 {
				if (*TXftGlyph)(unsafe.Pointer(xftg)).Fpicture != 0 {
					libxrender.XXRenderFreePicture(tls, dpy, (*TXftGlyph)(unsafe.Pointer(xftg)).Fpicture)
					...
					if (*TXftFontInt)(unsafe.Pointer(font)).Fglyphset != 0 {
						v3 = nused
						nused++
						(*(*[1024]TGlyph)(unsafe.Pointer(bp)))[v3] = glyphindex
						if libc.Uint32FromInt32(nused) == libc.Uint32FromInt64(4096)/libc.Uint32FromInt64(4) {
		...
		if (*TXftFontInt)(unsafe.Pointer(font)).Ftrack_mem_usage != 0 {
			xuse = xftg
			if XXftDebug(tls)&int32(m_XFT_DBG_USAGE) != 0 {
				libc.Xprintf(tls, __ccgo_ts+1905, libc.VaList(bp+4104, font, xuse, (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Folder, (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Fnewer))
			}
			if (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Folder != uint32(0xffffffff) {
				xtmp = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftGlyphUsage)(unsafe.Pointer(xuse)).Folder)*4))
			...
			if (*TXftGlyphUsage)(unsafe.Pointer(xuse)).Fnewer != uint32(0xffffffff) {
				xtmp = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftGlyphUsage)(unsafe.Pointer(xuse)).Fnewer)*4))
				if xtmp != libc.UintptrFromInt32(0) {
			...
			if (*TXftFontInt)(unsafe.Pointer(font)).Ftotal_inuse != 0 {
				...
				libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+1930, 0)
			}
			if XXftDebug(tls)&int32(m_XFT_DBG_USAGE) != 0 {
				__XftValidateGlyphUsage(tls, font)
			}
		...
		libc.Xfree(tls, xftg)
		XXftMemFree(tls, int32(_XFT_MEM_GLYPH), (*TXftFontInt)(unsafe.Pointer(font)).Fsizeof_glyph)
		*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyphindex)*4)) = libc.UintptrFromInt32(0)
	}
...
func XXftFontCheckGlyph(tls *libc.TLS, dpy uintptr, pub uintptr, need_bitmaps TFcBool, glyph TFT_UInt, missing uintptr, nmissing uintptr) (r TFcBool) {
	...
	xftg = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph)*4))
	if !(xftg != 0) || need_bitmaps != 0 && !((*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory != 0) {
		if !(xftg != 0) {
			xftg = libc.Xmalloc(tls, (*TXftFontInt)(unsafe.Pointer(font)).Fsizeof_glyph)
			if !(xftg != 0) {
				return m_FcFalse
			}
			XXftMemAlloc(tls, int32(_XFT_MEM_GLYPH), (*TXftFontInt)(unsafe.Pointer(font)).Fsizeof_glyph)
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fbitmap = libc.UintptrFromInt32(0)
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory = uint32(0)
			(*TXftGlyph)(unsafe.Pointer(xftg)).Fpicture = uint32(0)
			*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(glyph)*4)) = xftg
			if (*TXftFontInt)(unsafe.Pointer(font)).Ftrack_mem_usage != 0 {
				xuse = xftg
				(*TXftGlyphUsage)(unsafe.Pointer(xuse)).Folder = uint32(0xffffffff)
				(*TXftGlyphUsage)(unsafe.Pointer(xuse)).Fnewer = uint32(0xffffffff)
			}
		}
	 ...
	 */
	if (*TXftFontInt)(unsafe.Pointer(font)).Ftrack_mem_usage != 0 && (*TXftFontInt)(unsafe.Pointer(font)).Ftotal_inuse > uint32(10) && (*TXftFontInt)(unsafe.Pointer(font)).Fnewest != uint32(0xffffffff) && (*TXftFontInt)(unsafe.Pointer(font)).Fnewest != glyph {
		xuse1 = xftg
		xtmp = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftFontInt)(unsafe.Pointer(font)).Fnewest)*4))
		/* delink */
		xold = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftGlyphUsage)(unsafe.Pointer(xuse1)).Folder)*4))
		xnew = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftGlyphUsage)(unsafe.Pointer(xuse1)).Fnewer)*4))
		...
		/* relink */
		xnew = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftGlyphUsage)(unsafe.Pointer(xtmp)).Fnewer)*4))
...
func XXftCharIndex(tls *libc.TLS, dpy uintptr, pub uintptr, ucs4 TFcChar32) (r TFT_UInt) {
	...
	ent = ucs4 % libc.Uint32FromInt32((*TXftFontInt)(unsafe.Pointer(font)).Fhash_value)
	offset = uint32(0)
	for (*(*TXftUcsHash)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fhash_table + uintptr(ent)*8))).Fucs4 != ucs4 {
		if (*(*TXftUcsHash)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fhash_table + uintptr(ent)*8))).Fucs4 == libc.Uint32FromInt32(^libc.Int32FromInt32(0)) {
		...
		if !(offset != 0) {
			offset = ucs4 % libc.Uint32FromInt32((*TXftFontInt)(unsafe.Pointer(font)).Frehash_value)
			if !(offset != 0) {
				offset = uint32(1)
			}
		}
		ent = ent + offset
		if ent >= libc.Uint32FromInt32((*TXftFontInt)(unsafe.Pointer(font)).Fhash_value) {
			ent -= libc.Uint32FromInt32((*TXftFontInt)(unsafe.Pointer(font)).Fhash_value)
		}
	}
...
func X_XftFontUncacheGlyph(tls *libc.TLS, dpy uintptr, pub uintptr) {
	...
	if (*TXftFontInt)(unsafe.Pointer(font)).Ftrack_mem_usage != 0 {
		 ...
		 */
		if (*TXftFontInt)(unsafe.Pointer(font)).Fnewest != uint32(0xffffffff) {
			xuse = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr((*TXftFontInt)(unsafe.Pointer(font)).Fnewest)*4))
		...
		if (*TXftFontInt)(unsafe.Pointer(font)).Fuse_free_glyphs != 0 {
			 ...
			 */
			glyph_memory = libc.Uint32FromInt32(libc.Xrand(tls)) % (*TXftFontInt)(unsafe.Pointer(font)).Fglyph_memory
			*(*TFT_UInt)(unsafe.Pointer(bp)) = uint32(0)
			for {
				if !(*(*TFT_UInt)(unsafe.Pointer(bp)) < (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs) {
					break
				}
				xftg = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(*(*TFT_UInt)(unsafe.Pointer(bp)))*4))
				if xftg != 0 {
			...
			*(*TFT_UInt)(unsafe.Pointer(bp)) = uint32(0)
			for {
				...
				xftg = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(*(*TFT_UInt)(unsafe.Pointer(bp)))*4))
				if xftg != 0 {
					if (*TXftGlyph)(unsafe.Pointer(xftg)).Fglyph_memory > uint32(0) {
						XXftFontUnloadGlyphs(tls, dpy, pub, bp, int32(1))
					}
				}
				goto _3
...
var _XftMemNotice = libc.Uint32FromInt32(libc.Int32FromInt32(1) * libc.Int32FromInt32(1024) * libc.Int32FromInt32(1024))
...
func XXftMemReport(tls *libc.TLS) {
	...
	_XftAllocNotify = uint32(0)
	_XftFreeNotify = uint32(0)
}
...
func XXftNameUnparse(tls *libc.TLS, pat uintptr, dest uintptr, len1 int32) (r TFcBool) {
	...
	if libc.Xstrlen(tls, name)+uint32(1) > libc.Uint32FromInt32(len1) {
		...
		if libc.Xstrlen(tls, name)+uint32(1) > libc.Uint32FromInt32(len1) {
			libc.Xstrncpy(tls, dest, name, libc.Uint32FromInt32(len1)-uint32(1))
			*(*uint8)(unsafe.Pointer(dest + uintptr(len1-int32(1)))) = uint8('\000')
			libc.Xfree(tls, name)
			return m_FcFalse
		}
	}
	libc.Xstrcpy(tls, dest, name)
	libc.Xfree(tls, name)
	return int32(m_FcTrue)
}
...
func XXftGlyphRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, pub uintptr, dst TPicture, srcx int32, srcy int32, x int32, y int32, glyphs uintptr, nglyphs int32) {
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	chars = bp + 1028
	if libc.Uint32FromInt32(nglyphs) > uint32(0xffffffff)/size {
		goto bail1
	}
	needed = libc.Uint32FromInt32(nglyphs) * size
	if needed > uint32(4096) {
	...
	for {
		...
		wire = *(*TFT_UInt)(unsafe.Pointer(glyphs + uintptr(i)*4))
		if wire >= (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(wire)*4)) != 0) {
			wire = uint32(0)
		}
		glyph = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(wire)*4))
		...
		if (*TXftGlyph)(unsafe.Pointer(glyph)).Fpicture != 0 {
			...
			libxrender.XXRenderComposite(tls, dpy, int32(m_PictOpOver), (*TXftGlyph)(unsafe.Pointer(glyph)).Fpicture, uint32(0), dst, 0, 0, 0, 0, dstx-int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fx), dsty-int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fy), uint32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fwidth), uint32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fheight))
			...
			switch width {
			case int32(1):
				*(*uint8)(unsafe.Pointer(char8 + uintptr(j))) = uint8(wire)
			case int32(2):
				*(*uint16)(unsafe.Pointer(char16 + uintptr(j)*2)) = uint16(wire)
			case int32(4):
				*(*uint32)(unsafe.Pointer(char32 + uintptr(j)*4)) = wire
				break
			}
			dstx += int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.FxOff)
			dsty += int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.FyOff)
...
func XXftGlyphSpecRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, pub uintptr, dst TPicture, srcx int32, srcy int32, glyphs uintptr, nglyphs int32) {
	...
	var _ /* char_local at bp+1028 */ [1024]uint32
	var _ /* elts_local at bp+5124 */ [128]TXGlyphElt8
	var _ /* missing at bp+0 */ [256]TFT_UInt
	var _ /* nmissing at bp+1024 */ int32
	...
	*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	if nglyphs*size > int32(m_NUM_LOCAL) {
		chars = libc.Xmalloc(tls, libc.Uint32FromInt32(nglyphs*size))
		if !(chars != 0) {
			goto bail1
		}
	}
	...
	for {
		...
		if g >= (*TXftFontInt)(unsafe.Pointer(font)).Fnum_glyphs || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(g)*4)) != 0) {
			g = uint32(0)
		}
		if *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(g)*4)) != 0 {
			break
		}
		goto _2
	_2:
	...
	glyph = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(g)*4))
	...
	for {
		 ...
		 * as a XRender glyph
		 */
		v4 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font)).Fglyphs + uintptr(g)*4))
		glyph = v4
	...
	elts = bp + 5124
	if !((*TXftFontInt)(unsafe.Pointer(font)).Finfo.Fcolor != 0) && nelt > int32(m_NUM_ELT_LOCAL) {
		elts = libc.Xmalloc(tls, libc.Uint32FromInt32(nelt)*uint32(20))
		if !(elts != 0) {
			goto bail2
		}
	}
	...
	for {
		...
		if v7 != 0 {
			...
			if !(i != 0) || x != int32((*(*TXftGlyphSpec)(unsafe.Pointer(glyphs + uintptr(i)*8))).Fx) || y != int32((*(*TXftGlyphSpec)(unsafe.Pointer(glyphs + uintptr(i)*8))).Fy) {
				if n != 0 {
					(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).Fnchars = n
					nelt++
				}
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).Fglyphset = (*TXftFontInt)(unsafe.Pointer(font)).Fglyphset
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).Fchars = char8 + uintptr(size*j)
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).FxOff = int32((*(*TXftGlyphSpec)(unsafe.Pointer(glyphs + uintptr(i)*8))).Fx) - x
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).FyOff = int32((*(*TXftGlyphSpec)(unsafe.Pointer(glyphs + uintptr(i)*8))).Fy) - y
				x = int32((*(*TXftGlyphSpec)(unsafe.Pointer(glyphs + uintptr(i)*8))).Fx)
				y = int32((*(*TXftGlyphSpec)(unsafe.Pointer(glyphs + uintptr(i)*8))).Fy)
				n = 0
			}
			switch width {
			case int32(1):
				*(*uint8)(unsafe.Pointer(char8 + uintptr(j))) = uint8(g)
			case int32(2):
...
func XXftGlyphFontSpecRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, srcx int32, srcy int32, glyphs uintptr, nglyphs int32) {
	...
	for {
		...
		pub = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont
		font = pub
		g = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph
		if g > max {
			max = g
		}
		*(*int32)(unsafe.Pointer(bp + 1024)) = 0
	...
	for {
		...
		pub1 = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont
		font1 = pub1
		g = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph
		/* Substitute default for non-existent glyphs */
		if g >= (*TXftFontInt)(unsafe.Pointer(font1)).Fnum_glyphs || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font1)).Fglyphs + uintptr(g)*4)) != 0) {
			g = uint32(0)
		}
		if *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font1)).Fglyphs + uintptr(g)*4)) != 0 {
			firstFont = font1
			break
		}
		goto _2
	...
	glyph = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(firstFont)).Fglyphs + uintptr(g)*4))
	format = (*TXftFontInt)(unsafe.Pointer(firstFont)).Fformat
	x = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx) + int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.FxOff)
	y = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy) + int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.FyOff)
	...
	for {
		...
		pub2 = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont
		font2 = pub2
		g = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph
		/* Substitute default for non-existent glyphs */
		if g >= (*TXftFontInt)(unsafe.Pointer(font2)).Fnum_glyphs || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font2)).Fglyphs + uintptr(g)*4)) != 0) {
			g = uint32(0)
		}
		/*
		 * check to see if the glyph is placed where it would
		 ...
		 */
		v4 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font2)).Fglyphs + uintptr(g)*4))
		glyph = v4
		if v4 != 0 && !((*TXftGlyph)(unsafe.Pointer(glyph)).Fpicture != 0) {
			if pub2 != prevPublic || x != int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx) || y != int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy) {
				prevPublic = pub2
				...
				x = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx)
				y = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy)
				nelt++
			}
			x += int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.FxOff)
			y += int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.FyOff)
	...
	for {
		...
		pub3 = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont
		font3 = pub3
		g = (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph
		/* Substitute default for non-existent glyphs */
		if g >= (*TXftFontInt)(unsafe.Pointer(font3)).Fnum_glyphs || !(*(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font3)).Fglyphs + uintptr(g)*4)) != 0) {
			g = uint32(0)
		}
		v7 = *(*uintptr)(unsafe.Pointer((*TXftFontInt)(unsafe.Pointer(font3)).Fglyphs + uintptr(g)*4))
		glyph = v7
		if v7 != 0 {
			if (*TXftGlyph)(unsafe.Pointer(glyph)).Fpicture != 0 {
				libxrender.XXRenderComposite(tls, dpy, int32(m_PictOpOver), (*TXftGlyph)(unsafe.Pointer(glyph)).Fpicture, uint32(0), dst, 0, 0, 0, 0, int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx)-int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fx), int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy)-int32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fy), uint32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fwidth), uint32((*TXftGlyph)(unsafe.Pointer(glyph)).Fmetrics.Fheight))
				goto _6
			}
			if !(i != 0) || pub3 != prevPublic || x != int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx) || y != int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy) {
				if n != 0 {
					(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).Fnchars = n
					nelt++
				}
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).Fglyphset = (*TXftFontInt)(unsafe.Pointer(font3)).Fglyphset
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).Fchars = char8 + uintptr(size*j)
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).FxOff = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx) - x
				(*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(nelt)*20))).FyOff = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy) - y
				prevPublic = pub3
				x = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx)
				y = int32((*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy)
				n = 0
...
func XXftCharFontSpecRender(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, srcx int32, srcy int32, chars uintptr, len1 int32) {
	...
	for {
		...
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont = (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Ffont
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fglyph = XXftCharIndex(tls, dpy, (*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Ffont, (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Fucs4)
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fx = (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Fx
		(*(*TXftGlyphFontSpec)(unsafe.Pointer(glyphs + uintptr(i)*12))).Fy = (*(*TXftCharFontSpec)(unsafe.Pointer(chars + uintptr(i)*12))).Fy
		goto _1
	_1:
...
func XXftTextRender16BE(tls *libc.TLS, dpy uintptr, op int32, src TPicture, pub uintptr, dst TPicture, srcx int32, srcy int32, x int32, y int32, string1 uintptr, len1 int32) {
	...
	for {
		...
		*(*TFT_UInt)(unsafe.Pointer(glyphs + uintptr(i)*4)) = XXftCharIndex(tls, dpy, pub, libc.Uint32FromInt32(libc.Int32FromUint8(*(*TFcChar8)(unsafe.Pointer(string1 + uintptr(i*int32(2)))))<<libc.Int32FromInt32(8)|libc.Int32FromUint8(*(*TFcChar8)(unsafe.Pointer(string1 + uintptr(i*int32(2)+int32(1)))))))
		goto _1
	_1:
		;
		i++
...
func XXftTextRender16LE(tls *libc.TLS, dpy uintptr, op int32, src TPicture, pub uintptr, dst TPicture, srcx int32, srcy int32, x int32, y int32, string1 uintptr, len1 int32) {
	...
	for {
		...
		*(*TFT_UInt)(unsafe.Pointer(glyphs + uintptr(i)*4)) = XXftCharIndex(tls, dpy, pub, libc.Uint32FromInt32(libc.Int32FromUint8(*(*TFcChar8)(unsafe.Pointer(string1 + uintptr(i*int32(2)))))|libc.Int32FromUint8(*(*TFcChar8)(unsafe.Pointer(string1 + uintptr(i*int32(2)+int32(1)))))<<libc.Int32FromInt32(8)))
		goto _1
	_1:
		;
		i++
...
func XXftSwapCARD32(tls *libc.TLS, data uintptr, u int32) {
	...
	for {
		...
		n = *(*uint8)(unsafe.Pointer(data))
		*(*uint8)(unsafe.Pointer(data)) = *(*uint8)(unsafe.Pointer(data + 3))
		*(*uint8)(unsafe.Pointer(data + 3)) = n
		n = *(*uint8)(unsafe.Pointer(data + 1))
		*(*uint8)(unsafe.Pointer(data + 1)) = *(*uint8)(unsafe.Pointer(data + 2))
		*(*uint8)(unsafe.Pointer(data + 2)) = n
		data += 4
	}
}
...
func XXftSwapCARD24(tls *libc.TLS, data uintptr, width int32, height int32) {
	...
	for {
		...
		for {
			...
			n = *(*uint8)(unsafe.Pointer(d))
			*(*uint8)(unsafe.Pointer(d)) = *(*uint8)(unsafe.Pointer(d + 2))
			*(*uint8)(unsafe.Pointer(d + 2)) = n
			d += uintptr(3)
		}
	}
}
...
func XXftSwapCARD16(tls *libc.TLS, data uintptr, u int32) {
	...
	for {
		...
		n = *(*uint8)(unsafe.Pointer(data))
		*(*uint8)(unsafe.Pointer(data)) = *(*uint8)(unsafe.Pointer(data + 1))
		*(*uint8)(unsafe.Pointer(data + 1)) = n
		data += 2
	}
}
...
func _XftSplitStr(tls *libc.TLS, field uintptr, save uintptr) (r uintptr) {
	...
	_, _, _, _ = c, s, v1, v2
	s = save
	for *(*uint8)(unsafe.Pointer(field)) != 0 {
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(field))) == int32('-') {
			break
		}
		v1 = field
		field++
		...
		v2 = save
		save++
		*(*uint8)(unsafe.Pointer(v2)) = c
	}
	*(*uint8)(unsafe.Pointer(save)) = uint8(0)
	return s
}
...
func _XftGetInt(tls *libc.TLS, ptr uintptr, val uintptr) (r uintptr) {
	...
	if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(ptr))) == int32('*') {
		...
		*(*int32)(unsafe.Pointer(val)) = 0
		for {
			if !(libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(ptr))) >= int32('0') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(ptr))) <= int32('9')) {
				break
			}
			v2 = ptr
			ptr++
			*(*int32)(unsafe.Pointer(val)) = *(*int32)(unsafe.Pointer(val))*int32(10) + libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(v2))) - int32('0')
			goto _1
		_1:
		}
	}
...
func XXftXlfdParse(tls *libc.TLS, xlfd_orig uintptr, ignore_scalable TFcBool, complete TFcBool) (r uintptr) {
	...
	xlfd = xlfd_orig
	if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(xlfd))) != int32('-') {
		return libc.UintptrFromInt32(0)
	}
	xlfd++
	v3 = xlfd
	...
	save = libc.Xmalloc(tls, libc.Xstrlen(tls, foundry)+uint32(1))
	if !(save != 0) {
		libfontconfig.XFcPatternDestroy(tls, pat)
		return libc.UintptrFromInt32(0)
	}
	...
	if *(*uint8)(unsafe.Pointer(save)) != 0 && libc.Xstrcmp(tls, save, __ccgo_ts+2222) != 0 {
	...
	weight_value = X_XftMatchSymbolic(tls, uintptr(unsafe.Pointer(&_XftXlfdWeights)), libc.Int32FromUint32(libc.Uint32FromInt64(48)/libc.Uint32FromInt64(8)), _XftSplitStr(tls, weight_name, save), int32(m_FC_WEIGHT_MEDIUM))
	if !(libfontconfig.XFcPatternAddInteger(tls, pat, __ccgo_ts+2239, weight_value) != 0) {
		goto bail
	}
	slant_value = X_XftMatchSymbolic(tls, uintptr(unsafe.Pointer(&_XftXlfdSlants)), libc.Int32FromUint32(libc.Uint32FromInt64(24)/libc.Uint32FromInt64(8)), _XftSplitStr(tls, slant, save), m_FC_SLANT_ROMAN)
	...
	if *(*int32)(unsafe.Pointer(bp + 4)) > 0 {
		...
		if *(*int32)(unsafe.Pointer(bp)) <= 0 && *(*int32)(unsafe.Pointer(bp + 12)) > 0 {
			dpixel = float64(float64(*(*int32)(unsafe.Pointer(bp + 4)))*float64(*(*int32)(unsafe.Pointer(bp + 12)))) / float64(720)
		}
	}
