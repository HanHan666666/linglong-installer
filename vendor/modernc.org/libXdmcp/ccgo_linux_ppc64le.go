// Code generated for linux/ppc64le by 'generator -no-main-minimize -DHAVE_LIBBSD --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment -ignore-link-errors -I /home/debian/src/modernc.org/builder/.exclude/modernc.org/libbsd/include/linux/ppc64le -lbsd -o libxdmcp.go --package-name libxdmcp .libs/libXdmcp.a', DO NOT EDIT.
...
func _getbits(tls *libc.TLS, data int64, dst uintptr) {
	*(*uint8)(unsafe.Pointer(dst)) = libc.Uint8FromInt64(data & int64(0xff))
	*(*uint8)(unsafe.Pointer(dst + 1)) = libc.Uint8FromInt64(data >> int32(8) & int64(0xff))
	*(*uint8)(unsafe.Pointer(dst + 2)) = libc.Uint8FromInt64(data >> int32(16) & int64(0xff))
	*(*uint8)(unsafe.Pointer(dst + 3)) = libc.Uint8FromInt64(data >> int32(24) & int64(0xff))
}

/* Solaris 11.3.0 - 11.4.15 only define getentropy() in <sys/random.h> */

func _insecure_getrandom_buf(tls *libc.TLS, auth uintptr, len1 int32) {
	var highbits, lowbits int64
	_, _ = highbits, lowbits
	libc.Xsrand48(tls, int64(libc.Xgetpid(tls))^libc.Xtime(tls, libc.UintptrFromInt32(0)))
	lowbits = libc.Xlrand48(tls)
	highbits = libc.Xlrand48(tls)
	_getbits(tls, lowbits, auth)
	_getbits(tls, highbits, auth+uintptr(4))
}

func _arc4random_buf(tls *libc.TLS, auth uintptr, len1 int32) {
	_insecure_getrandom_buf(tls, auth, len1)
}

func XXdmcpGenerateKey(tls *libc.TLS, key TXdmAuthKeyPtr) {
	_arc4random_buf(tls, key, libc.Int32FromUint64(libc.Uint64FromInt32(8)))
}
