...
func XXdmcpAllocARRAY32(tls *libc.TLS, array TARRAY32Ptr, length int32) (r int32) {
	...
	if uint32(length) > uint32(255) || length < 0 {
		...
		(*T_ARRAY32)(unsafe.Pointer(array)).Fdata = _xmalloc(tls, uint64(length)*uint64(4))
	}
	if (*T_ARRAY32)(unsafe.Pointer(array)).Fdata == libc.UintptrFromInt32(0) {
		(*T_ARRAY32)(unsafe.Pointer(array)).Flength = uint8(0)
		return m_FALSE
	}
	(*T_ARRAY32)(unsafe.Pointer(array)).Flength = uint8(length)
	return int32(m_TRUE)
}
...
func XXdmcpAllocARRAYofARRAY8(tls *libc.TLS, array TARRAYofARRAY8Ptr, length int32) (r int32) {
	...
	if uint32(length) > uint32(255) || length < 0 {
		 ...
		 */
		(*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Fdata = _xcalloc(tls, uint64(length), uint64(16))
	}
	...
	(*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength = uint8(length)
	return int32(m_TRUE)
}

func XXdmcpARRAY8Equal(tls *libc.TLS, array1 TARRAY8Ptr, array2 TARRAY8Ptr) (r int32) {
	if int32((*T_ARRAY8)(unsafe.Pointer(array1)).Flength) != int32((*T_ARRAY8)(unsafe.Pointer(array2)).Flength) {
		return m_FALSE
	}
...
func XXdmcpCopyARRAY8(tls *libc.TLS, src TARRAY8Ptr, dst TARRAY8Ptr) (r int32) {
	if !(XXdmcpAllocARRAY8(tls, dst, int32((*T_ARRAY8)(unsafe.Pointer(src)).Flength)) != 0) {
		return m_FALSE
	}
	libc.X__builtin___memcpy_chk(tls, (*T_ARRAY8)(unsafe.Pointer(dst)).Fdata, (*T_ARRAY8)(unsafe.Pointer(src)).Fdata, uint64((*T_ARRAY8)(unsafe.Pointer(src)).Flength)*uint64(1), libc.X__builtin_object_size(tls, (*T_ARRAY8)(unsafe.Pointer(dst)).Fdata, 0))
	return int32(m_TRUE)
}
...
func XXdmcpReallocARRAY8(tls *libc.TLS, array TARRAY8Ptr, length int32) (r int32) {
	...
	newData = _xrealloc(tls, (*T_ARRAY8)(unsafe.Pointer(array)).Fdata, uint64(length)*uint64(1))
	if !(newData != 0) {
		return m_FALSE
	}
	(*T_ARRAY8)(unsafe.Pointer(array)).Flength = uint16(length)
...
func XXdmcpReallocARRAYofARRAY8(tls *libc.TLS, array TARRAYofARRAY8Ptr, length int32) (r int32) {
	...
	newData = _xrealloc(tls, (*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Fdata, uint64(length)*uint64(16))
	if !(newData != 0) {
		return m_FALSE
	}
	if length > int32((*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength) {
		libc.X__builtin___memset_chk(tls, newData+uintptr((*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength)*16, 0, uint64(length-int32((*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength))*uint64(16), libc.X__builtin_object_size(tls, newData+uintptr((*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength)*16, 0))
	}
	(*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength = uint8(length)
...
func XXdmcpReallocARRAY16(tls *libc.TLS, array TARRAY16Ptr, length int32) (r int32) {
	...
	newData = _xrealloc(tls, (*T_ARRAY16)(unsafe.Pointer(array)).Fdata, uint64(length)*uint64(2))
	if !(newData != 0) {
		return m_FALSE
	}
	(*T_ARRAY16)(unsafe.Pointer(array)).Flength = uint8(length)
...
func XXdmcpReallocARRAY32(tls *libc.TLS, array TARRAY32Ptr, length int32) (r int32) {
	...
	newData = _xrealloc(tls, (*T_ARRAY32)(unsafe.Pointer(array)).Fdata, uint64(length)*uint64(4))
	if !(newData != 0) {
		return m_FALSE
	}
	(*T_ARRAY32)(unsafe.Pointer(array)).Flength = uint8(length)
...
func XXdmcpFill(tls *libc.TLS, fd int32, buffer TXdmcpBufferPtr, from TXdmcpNetaddr, fromlen uintptr) (r int32) {
	...
	(*T_XdmcpBuffer)(unsafe.Pointer(buffer)).Fcount = int32(libc.Xrecvfrom(tls, fd, (*T_XdmcpBuffer)(unsafe.Pointer(buffer)).Fdata, uint64((*T_XdmcpBuffer)(unsafe.Pointer(buffer)).Fsize), 0, from, fromlen))
...
func XXdmcpFlush(tls *libc.TLS, fd int32, buffer TXdmcpBufferPtr, to TXdmcpNetaddr, tolen int32) (r int32) {
	var result int32
	_ = result
	result = int32(libc.Xsendto(tls, fd, (*T_XdmcpBuffer)(unsafe.Pointer(buffer)).Fdata, uint64((*T_XdmcpBuffer)(unsafe.Pointer(buffer)).Fpointer), 0, to, uint32(tolen)))
...
func XXdmcpCompareKeys(tls *libc.TLS, a TXdmAuthKeyPtr, b TXdmAuthKeyPtr) (r int32) {
	...
	for {
		...
		if int32(*(*TBYTE)(unsafe.Pointer(a + uintptr(i)))) != int32(*(*TBYTE)(unsafe.Pointer(b + uintptr(i)))) {
			return m_FALSE
		}
		goto _1
	_1:
...
func XXdmcpReadARRAY8(tls *libc.TLS, buffer TXdmcpBufferPtr, array TARRAY8Ptr) (r int32) {
	...
	i = 0
	for {
		if !(i < int32((*T_ARRAY8)(unsafe.Pointer(array)).Flength)) {
			break
		}
...
func XXdmcpReadARRAY16(tls *libc.TLS, buffer TXdmcpBufferPtr, array TARRAY16Ptr) (r int32) {
	...
	i = 0
	for {
		if !(i < int32((*T_ARRAY16)(unsafe.Pointer(array)).Flength)) {
			break
		}
...
func XXdmcpReadARRAY32(tls *libc.TLS, buffer TXdmcpBufferPtr, array TARRAY32Ptr) (r int32) {
	...
	i = 0
	for {
		if !(i < int32((*T_ARRAY32)(unsafe.Pointer(array)).Flength)) {
			break
		}
...
func XXdmcpReadARRAYofARRAY8(tls *libc.TLS, buffer TXdmcpBufferPtr, array TARRAYofARRAY8Ptr) (r int32) {
	...
	i = uint8(0)
	for {
		if !(int32(i) < int32((*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength)) {
			break
		}
...
func XXdmcpReadCARD16(tls *libc.TLS, buffer TXdmcpBufferPtr, valuep TCARD16Ptr) (r int32) {
	...
	if XXdmcpReadCARD8(tls, buffer, bp) != 0 && XXdmcpReadCARD8(tls, buffer, bp+1) != 0 {
		*(*TCARD16)(unsafe.Pointer(valuep)) = uint16(int32(uint16(*(*TCARD8)(unsafe.Pointer(bp))))<<int32(8) | int32(uint16(*(*TCARD8)(unsafe.Pointer(bp + 1)))))
		return int32(m_TRUE)
	}
	return m_FALSE
}
	...
	for {
		...
		for {
			...
			if j == 0 {
				...
				*(*uint8)(unsafe.Pointer(output + uintptr(j+i))) = uint8(int32((*(*[8]uint8)(unsafe.Pointer(bp)))[i]) ^ int32(*(*uint8)(unsafe.Pointer(bp + 8 + uintptr(k)*8 + uintptr(i)))))
			}
			goto _4
		_4:
			;
	...
	for {
		...
		for {
			...
			if j == 0 {
				...
				(*(*[8]uint8)(unsafe.Pointer(bp)))[i] = uint8(int32(*(*uint8)(unsafe.Pointer(input + uintptr(j+i)))) ^ int32(*(*uint8)(unsafe.Pointer(output + uintptr(j-int32(8)+i)))))
			}
			goto _2
		_2:
			;
		...
		for {
			...
			if j == 0 {
				...
				(*(*[8]uint8)(unsafe.Pointer(bp)))[i] = uint8(0 ^ int32(*(*uint8)(unsafe.Pointer(output + uintptr(j-int32(8)+i)))))
			}
			goto _3
		_3:
			;
...
func _OddParity(tls *libc.TLS, c uint8) (r int32) {
	c = uint8(int32(c) ^ int32(c)>>int32(4))
	c = uint8(int32(c) ^ int32(c)>>int32(2))
	c = uint8(int32(c) ^ int32(c)>>int32(1))
	return ^int32(c) & int32(0x1)
}
...
func X_XdmcpWrapperToOddParity(tls *libc.TLS, in uintptr, out uintptr) {
	...
	for {
		...
		c = uint8((int32(*(*uint8)(unsafe.Pointer(in + uintptr(i))))<<ashift | int32(*(*uint8)(unsafe.Pointer(in + uintptr(i+int32(1)))))>>bshift) & int32(0x7f))
		*(*uint8)(unsafe.Pointer(out + uintptr(i))) = uint8(int32(c)<<int32(1) | _OddParity(tls, c))
		ashift--
		bshift++
		goto _1
	_1:
...
func XXdmcpWriteHeader(tls *libc.TLS, buffer TXdmcpBufferPtr, header TXdmcpHeaderPtr) (r int32) {
	var newData uintptr
	_ = newData
	if (*T_XdmcpBuffer)(unsafe.Pointer(buffer)).Fsize < int32(6)+int32((*T_XdmcpHeader)(unsafe.Pointer(header)).Flength) {
...
func XXdmcpWriteARRAYofARRAY8(tls *libc.TLS, buffer TXdmcpBufferPtr, array TARRAYofARRAY8Ptr) (r int32) {
	...
	i = 0
	for {
		if !(i < int32((*T_ARRAYofARRAY8)(unsafe.Pointer(array)).Flength)) {
			break
		}
...
func X_XdmcpAuthSetup(tls *libc.TLS, key uintptr, schedule uintptr) {
	...
	t = (d>>libc.Int32FromInt32(4) ^ c) & uint32(libc.Int32FromInt32(0x0f0f0f0f))
	c ^= t
	...
	t = (c<<(libc.Int32FromInt32(16)-libc.Int32FromInt32(8)) ^ c) & uint32(libc.Int32FromInt32(0x00ff0000))
	...
	t = (d<<(libc.Int32FromInt32(16)-libc.Int32FromInt32(8)) ^ d) & uint32(libc.Int32FromInt32(0x00ff0000))
	d = d ^ t ^ t>>(libc.Int32FromInt32(16)-libc.Int32FromInt32(8))
	t = (d<<(libc.Int32FromInt32(16)-libc.Int32FromInt32(2)) ^ d) & uint32(libc.Int32FromInt32(0x33330000))
...
func X_XdmcpAuthDoIt(tls *libc.TLS, input uintptr, output uintptr, ks uintptr, encrypt int32) {
	...
	/* do IP */
	t = (r>>libc.Int32FromInt32(4) ^ l) & uint32(libc.Int32FromInt32(0x0f0f0f0f))
	l ^= t
	r ^= t << libc.Int32FromInt32(4)
	t = (l>>libc.Int32FromInt32(16) ^ r) & uint32(libc.Int32FromInt32(0x0000ffff))
	r ^= t
	l ^= t << libc.Int32FromInt32(16)
	t = (r>>libc.Int32FromInt32(2) ^ l) & uint32(libc.Int32FromInt32(0x33333333))
	l ^= t
	r ^= t << libc.Int32FromInt32(2)
	t = (l>>libc.Int32FromInt32(8) ^ r) & uint32(libc.Int32FromInt32(0x00ff00ff))
	r ^= t
	l ^= t << libc.Int32FromInt32(8)
	t = (r>>libc.Int32FromInt32(1) ^ l) & uint32(libc.Int32FromInt32(0x55555555))
	l ^= t
