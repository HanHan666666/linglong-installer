// Code generated for linux/arm by 'generator --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libX11/include/linux/arm -lX11 -o libxrender.go --package-name libxrender src/.libs/libXrender.a', DO NOT EDIT.
...
const m_MALLOC_0_RETURNS_NULL = 1
const m_MSBFirst = 1
...
func XXRenderAddTraps(tls *libc.TLS, dpy uintptr, picture TPicture, xOff int32, yOff int32, traps uintptr, ntrap int32) {
	...
	var len1, n int32
	var max_req, v1 uint32
	var _ /* _BRdat at bp+0 */ TCARD32
	...
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
		...
		v1 = (*TDisplay)(unsafe.Pointer(dpy)).Fmax_request_size
	}
	max_req = v1
	...
	for ntrap != 0 {
		req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderAddTraps), uint32(m_sz_xRenderAddTrapsReq))
		...
		(*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Fpicture = picture
		(*TxRenderAddTrapsReq)(unsafe.Pointer(req)).FxOff = int16(xOff)
		(*TxRenderAddTrapsReq)(unsafe.Pointer(req)).FyOff = int16(yOff)
		n = ntrap
		len1 = n * int32(libc.Int32FromInt32(m_sz_xTrap)>>libc.Int32FromInt32(2))
		if libc.Uint32FromInt32(len1) > max_req-uint32((*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength) {
			n = libc.Int32FromUint32((max_req - uint32((*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength)) / libc.Uint32FromInt32(libc.Int32FromInt32(m_sz_xTrap)>>libc.Int32FromInt32(2)))
			len1 = n * int32(libc.Int32FromInt32(m_sz_xTrap)>>libc.Int32FromInt32(2))
		}
		if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
				_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength) - int32(1))
				(*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength = uint16(0)
				*(*TCARD32)(unsafe.Pointer(bp)) = *(*TCARD32)(unsafe.Pointer(req + uintptr(_BRlen)*4))
				libc.Xmemmove(tls, req+uintptr(8), req+uintptr(4), (_BRlen-uint32(1))<<int32(2))
				*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
				if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(int32(libc.Int32FromInt32(4))) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
					libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, bp, libc.Uint32FromInt32(int32(libc.Int32FromInt32(4))))
					*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(int32(libc.Int32FromInt32(4))+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
				} else {
					libx11.X_XSend(tls, dpy, bp, int32(libc.Int32FromInt32(4)))
				}
			} else {
				len1 = len1
				(*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength) + len1)
			}
		} else {
			(*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderAddTrapsReq)(unsafe.Pointer(req)).Flength) + len1)
		}
		...
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(len1) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
			libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, traps, libc.Uint32FromInt32(len1))
			*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(len1+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
		} else {
...
func XXRenderParseColor(tls *libc.TLS, dpy uintptr, spec uintptr, def uintptr) (r int32) {
	...
	if !(libc.Xstrncmp(tls, spec, __ccgo_ts, uint32(5)) != 0) {
		spec += uintptr(5)
		/*
		...
		for {
			...
			*(*uint16)(unsafe.Pointer(pShort)) = uint16(0)
			for libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(spec))) != int32('/') && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(spec))) != int32('\000') {
				n++
				v2 = n
				if v2 > int32(4) {
					return 0
				...
				*(*uint16)(unsafe.Pointer(p4)) = uint16(int32(*(*uint16)(unsafe.Pointer(p4))) << libc.Int32FromInt32(4))
				if libc.Int32FromUint8(c) >= int32('0') && libc.Int32FromUint8(c) <= int32('9') {
					p5 = pShort
					*(*uint16)(unsafe.Pointer(p5)) = uint16(int32(*(*uint16)(unsafe.Pointer(p5))) | (libc.Int32FromUint8(c) - libc.Int32FromUint8('0')))
				} else {
					if libc.Int32FromUint8(c) >= int32('a') && libc.Int32FromUint8(c) <= int32('f') {
						p6 = pShort
						*(*uint16)(unsafe.Pointer(p6)) = uint16(int32(*(*uint16)(unsafe.Pointer(p6))) | (libc.Int32FromUint8(c) - (libc.Int32FromUint8('a') - libc.Int32FromInt32(10))))
					} else {
						return 0
					}
				}
			...
			if n < int32(4) {
				*(*uint16)(unsafe.Pointer(pShort)) = uint16(uint32(*(*uint16)(unsafe.Pointer(pShort))) * uint32(0xFFFF) / libc.Uint32FromInt32(libc.Int32FromInt32(1)<<(n*libc.Int32FromInt32(4))-libc.Int32FromInt32(1)))
			}
			goto _1
		_1:
			;
		...
		colormap = (*TScreen)(unsafe.Pointer((*struct {
			...
			Fprivate19           int32
			Fxdefaults           uintptr
		})(unsafe.Pointer(dpy)).Fdefault_screen)*80)).Fcmap
...
func XXRenderComposite(tls *libc.TLS, dpy uintptr, op int32, src TPicture, mask TPicture, dst TPicture, src_x int32, src_y int32, mask_x int32, mask_y int32, dst_x int32, dst_y int32, width uint32, height uint32) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderComposite), uint32(m_sz_xRenderCompositeReq))
	...
	(*TxRenderCompositeReq)(unsafe.Pointer(req)).Fsrc = src
	(*TxRenderCompositeReq)(unsafe.Pointer(req)).Fmask = mask
	(*TxRenderCompositeReq)(unsafe.Pointer(req)).Fdst = dst
...
func XXRenderCreateCursor(tls *libc.TLS, dpy uintptr, source TPicture, x uint32, y uint32) (r TCursor) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreateCursor), uint32(m_sz_xRenderCreateCursorReq))
	...
	cid = v1
	(*TxRenderCreateCursorReq)(unsafe.Pointer(req)).Fcid = v1
	(*TxRenderCreateCursorReq)(unsafe.Pointer(req)).Fsrc = source
...
func XXRenderCreateAnimCursor(tls *libc.TLS, dpy uintptr, ncursor int32, cursors uintptr) (r TCursor) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreateAnimCursor), uint32(m_sz_xRenderCreateAnimCursorReq))
	...
	cid = v1
	(*TxRenderCreateAnimCursorReq)(unsafe.Pointer(req)).Fcid = v1
	len1 = ncursor * int32(m_sz_xAnimCursorElt) >> int32(2)
	if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateAnimCursorReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
			_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateAnimCursorReq)(unsafe.Pointer(req)).Flength) - int32(1))
			...
			*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
			...
			len1 = len1
			(*TxRenderCreateAnimCursorReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateAnimCursorReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	} else {
		(*TxRenderCreateAnimCursorReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateAnimCursorReq)(unsafe.Pointer(req)).Flength) + len1)
	}
	len1 <<= int32(2)
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(len1) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, cursors, libc.Uint32FromInt32(len1))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(len1+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, cursors, len1)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderFillRectangle(tls *libc.TLS, dpy uintptr, op int32, dst TPicture, color uintptr, x int32, y int32, width uint32, height uint32) {
	...
	if libc.Int32FromUint8((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).FreqType) == (*TXExtCodes)(unsafe.Pointer((*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes)).Fmajor_opcode && libc.Int32FromUint8((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).FrenderReqType) == int32(m_X_RenderFillRectangles) && libc.Int32FromUint8((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fop) == op && (*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fdst == dst && libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fcolor.Fred) == libc.Int32FromUint16((*TXRenderColor)(unsafe.Pointer(color)).Fred) && libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fcolor.Fgreen) == libc.Int32FromUint16((*TXRenderColor)(unsafe.Pointer(color)).Fgreen) && libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fcolor.Fblue) == libc.Int32FromUint16((*TXRenderColor)(unsafe.Pointer(color)).Fblue) && libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fcolor.Falpha) == libc.Int32FromUint16((*TXRenderColor)(unsafe.Pointer(color)).Falpha) && (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(m_sz_xRectangle) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax && int32((*TDisplay)(unsafe.Pointer(dpy)).Fbufptr)-int32(req) < libc.Int32FromInt32(m_sz_xRenderFillRectanglesReq)+libc.Int32FromInt32(m_FRCTSPERBATCH)*libc.Int32FromInt32(m_sz_xRectangle) {
		...
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(m_sz_xRectangle)
	} else {
		req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderFillRectangles), libc.Uint32FromInt32(libc.Int32FromInt32(m_sz_xRenderFillRectanglesReq)+libc.Int32FromInt32(m_sz_xRectangle)))
		...
		(*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fdst = dst
...
func XXRenderFillRectangles(tls *libc.TLS, dpy uintptr, op int32, dst TPicture, color uintptr, rectangles uintptr, n_rects int32) {
	...
	for n_rects != 0 {
		req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderFillRectangles), uint32(m_sz_xRenderFillRectanglesReq))
		(*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).FreqType = libc.Uint8FromInt32((*TXExtCodes)(unsafe.Pointer((*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes)).Fmajor_opcode)
		(*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).FrenderReqType = uint8(m_X_RenderFillRectangles)
		(*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fop = libc.Uint8FromInt32(op)
		(*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Fdst = dst
		...
		n = n_rects
		len1 = n << int32(1)
		if !((*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0) && libc.Uint32FromInt32(len1) > (*TDisplay)(unsafe.Pointer(dpy)).Fmax_request_size-uint32((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Flength) {
		...
		if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
				_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Flength) - int32(1))
				...
				*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
				...
				len1 = len1
				(*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Flength) + len1)
			}
		} else {
			(*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderFillRectanglesReq)(unsafe.Pointer(req)).Flength) + len1)
		}
		len1 <<= int32(2) /* watch out for macros... */
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(len1) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
			libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, rectangles, libc.Uint32FromInt32(len1))
			*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(len1+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
		} else {
...
func XXRenderQueryFilters(tls *libc.TLS, dpy uintptr, drawable TDrawable) (r uintptr) {
	...
	var i, l int32
	var nbytes, nbytesAlias, nbytesName, reply_left, v1 uint32
	var _ /* len at bp+32 */ uint8
	var _ /* rep at bp+0 */ TxRenderQueryFiltersReply
	_, _, _, _, _, _, _, _, _, _, _, _ = filters, i, info, l, name, nbytes, nbytesAlias, nbytesName, reply_left, req, xri, v1
	info = XXRenderFindDisplay(tls, dpy)
	if !(info != 0 && (*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes != 0) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderQueryFilters), uint32(m_sz_xRenderQueryFiltersReq))
	...
	(*TxRenderQueryFiltersReq)(unsafe.Pointer(req)).Fdrawable = drawable
	...
	if (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).Flength < libc.Uint32FromInt32(libc.Int32FromInt32(m_INT_MAX)>>libc.Int32FromInt32(2)) && (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumFilters < uint32(libc.Uint32FromInt32(libc.Int32FromInt32(m_INT_MAX)/libc.Int32FromInt32(4))/libc.Uint32FromInt64(4)) && (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases < uint32(libc.Uint32FromInt32(libc.Int32FromInt32(m_INT_MAX)/libc.Int32FromInt32(4))/libc.Uint32FromInt64(2)) {
		 ...
		 */
		nbytes = (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).Flength << int32(2)
		nbytesAlias = (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases * uint32(2)
		if (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases&uint32(1) != 0 {
			nbytesAlias += uint32(2)
		}
		nbytesName = nbytes - nbytesAlias
		/*
		 * Allocate one giant block for the whole data structure
		 */
		if uint32(16)+(*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumFilters*uint32(4)+(*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases*uint32(2)+nbytesName == uint32(0) {
			v1 = uint32(1)
		} else {
			v1 = uint32(16) + (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumFilters*uint32(4) + (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases*uint32(2) + nbytesName
		}
		filters = libc.Xmalloc(tls, v1)
	} else {
		filters = libc.UintptrFromInt32(0)
	}
	if !(filters != 0) {
		libx11.X_XEatDataWords(tls, dpy, (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).Flength)
		if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
			(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
		}
		if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
	...
	(*TXFilters)(unsafe.Pointer(filters)).Ffilter = filters + libc.UintptrFromInt32(1)*16
	(*TXFilters)(unsafe.Pointer(filters)).Falias = (*TXFilters)(unsafe.Pointer(filters)).Ffilter + uintptr((*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumFilters)*4
	 ...
	 */
	libx11.X_XReadPad(tls, dpy, (*TXFilters)(unsafe.Pointer(filters)).Falias, libc.Int32FromUint32(libc.Uint32FromInt32(2)*(*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases))
	reply_left = uint32(8) + (*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).Flength - uint32(2)*(*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases
	/*
	...
	for {
		...
		libx11.X_XRead(tls, dpy, bp+32, int32(1))
		reply_left--
		l = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(bp + 32))) & int32(0xff)
		if libc.Uint32FromInt32(l)+uint32(1) > nbytesName {
		...
		nbytesName -= libc.Uint32FromInt32(l + int32(1))
		*(*uintptr)(unsafe.Pointer((*TXFilters)(unsafe.Pointer(filters)).Ffilter + uintptr(i)*4)) = name
		libx11.X_XRead(tls, dpy, name, l)
		reply_left -= libc.Uint32FromInt32(l)
		*(*uint8)(unsafe.Pointer(name + uintptr(l))) = uint8('\000')
	...
	i = int32(name) - int32((*TXFilters)(unsafe.Pointer(filters)).Falias+uintptr((*(*TxRenderQueryFiltersReply)(unsafe.Pointer(bp))).FnumAliases)*2)
	if i&int32(3) != 0 {
		libx11.X_XEatData(tls, dpy, libc.Uint32FromInt32(int32(4)-i&int32(3)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderSetPictureFilter(tls *libc.TLS, dpy uintptr, picture TPicture, filter uintptr, params uintptr, nparams int32) {
	...
	info = XXRenderFindDisplay(tls, dpy)
	nbytes = libc.Int32FromUint32(libc.Xstrlen(tls, filter))
	if !(info != 0 && (*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes != 0) {
		return
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderSetPictureFilter), uint32(m_sz_xRenderSetPictureFilterReq))
	...
	(*TxRenderSetPictureFilterReq)(unsafe.Pointer(req)).Fpicture = picture
	...
	*(*TCARD16)(unsafe.Pointer(p1)) = TCARD16(int32(*(*TCARD16)(unsafe.Pointer(p1))) + ((nbytes+libc.Int32FromInt32(3))>>libc.Int32FromInt32(2) + nparams))
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(nbytes) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, filter, libc.Uint32FromInt32(nbytes))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(nbytes+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, filter, nbytes)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(nparams<<libc.Int32FromInt32(2)) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, params, libc.Uint32FromInt32(nparams<<libc.Int32FromInt32(2)))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(nparams<<libc.Int32FromInt32(2)+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, params, int32(nparams<<libc.Int32FromInt32(2)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderCreateGlyphSet(tls *libc.TLS, dpy uintptr, format uintptr) (r TGlyphSet) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreateGlyphSet), uint32(m_sz_xRenderCreateGlyphSetReq))
	...
	gsid = v1
	(*TxRenderCreateGlyphSetReq)(unsafe.Pointer(req)).Fgsid = v1
	(*TxRenderCreateGlyphSetReq)(unsafe.Pointer(req)).Fformat = (*TXRenderPictFormat)(unsafe.Pointer(format)).Fid
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
...
func XXRenderReferenceGlyphSet(tls *libc.TLS, dpy uintptr, existing TGlyphSet) (r TGlyphSet) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderReferenceGlyphSet), uint32(m_sz_xRenderReferenceGlyphSetReq))
	...
	gsid = v1
	(*TxRenderReferenceGlyphSetReq)(unsafe.Pointer(req)).Fgsid = v1
	(*TxRenderReferenceGlyphSetReq)(unsafe.Pointer(req)).Fexisting = existing
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
...
func XXRenderFreeGlyphSet(tls *libc.TLS, dpy uintptr, glyphset TGlyphSet) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderFreeGlyphSet), uint32(m_sz_xRenderFreeGlyphSetReq))
	...
	(*TxRenderFreeGlyphSetReq)(unsafe.Pointer(req)).Fglyphset = glyphset
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
...
func XXRenderAddGlyphs(tls *libc.TLS, dpy uintptr, glyphset TGlyphSet, gids uintptr, glyphs uintptr, nglyphs int32, images uintptr, nbyte_images int32) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderAddGlyphs), uint32(m_sz_xRenderAddGlyphsReq))
	...
	(*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Fglyphset = glyphset
	(*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Fnglyphs = libc.Uint32FromInt32(nglyphs)
	len1 = int32((nglyphs*(libc.Int32FromInt32(m_sz_xGlyphInfo)+libc.Int32FromInt32(4)) + nbyte_images) >> int32(2))
	if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
			_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Flength) - int32(1))
			...
			*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
			...
			len1 = len1
			(*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	} else {
		(*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderAddGlyphsReq)(unsafe.Pointer(req)).Flength) + len1)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(int32(nglyphs*libc.Int32FromInt32(4))) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, gids, libc.Uint32FromInt32(int32(nglyphs*libc.Int32FromInt32(4))))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(int32(nglyphs*libc.Int32FromInt32(4))+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, gids, int32(nglyphs*libc.Int32FromInt32(4)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(nglyphs*libc.Int32FromInt32(m_sz_xGlyphInfo)) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, glyphs, libc.Uint32FromInt32(nglyphs*libc.Int32FromInt32(m_sz_xGlyphInfo)))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(nglyphs*libc.Int32FromInt32(m_sz_xGlyphInfo)+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, glyphs, int32(nglyphs*libc.Int32FromInt32(m_sz_xGlyphInfo)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(nbyte_images) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, images, libc.Uint32FromInt32(nbyte_images))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(nbyte_images+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, images, nbyte_images)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderFreeGlyphs(tls *libc.TLS, dpy uintptr, glyphset TGlyphSet, gids uintptr, nglyphs int32) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderFreeGlyphs), uint32(m_sz_xRenderFreeGlyphsReq))
	...
	(*TxRenderFreeGlyphsReq)(unsafe.Pointer(req)).Fglyphset = glyphset
	len1 = nglyphs
	if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderFreeGlyphsReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
			_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderFreeGlyphsReq)(unsafe.Pointer(req)).Flength) - int32(1))
			...
			*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
			...
			len1 = len1
			(*TxRenderFreeGlyphsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderFreeGlyphsReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	} else {
		(*TxRenderFreeGlyphsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderFreeGlyphsReq)(unsafe.Pointer(req)).Flength) + len1)
	}
	len1 <<= int32(2)
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(len1) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, gids, libc.Uint32FromInt32(len1))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(len1+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, gids, len1)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderCompositeString8(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, glyphset TGlyphSet, xSrc int32, ySrc int32, xDst int32, yDst int32, string1 uintptr, nchar int32) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCompositeGlyphs8), uint32(m_sz_xRenderCompositeGlyphs8Req))
	...
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).Fsrc = src
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).Fdst = dst
	if maskFormat != 0 {
		v1 = (*TXRenderPictFormat)(unsafe.Pointer(maskFormat)).Fid
	} else {
		v1 = uint32(0)
	}
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FmaskFormat = v1
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).Fglyphset = glyphset
	 ...
	 * bucket
	 */
	len1 = int32(m_sz_xGlyphElt)*((nchar+int32(252)-int32(1))/int32(252)) + nchar
	p2 = req + 2
	*(*TCARD16)(unsafe.Pointer(p2)) = TCARD16(int32(*(*TCARD16)(unsafe.Pointer(p2))) + (len1+libc.Int32FromInt32(3))>>libc.Int32FromInt32(2)) /* convert to number of 32-bit words */
	/*
	...
	for nchar > int32(252) {
		...
		libc.Xmemset(tls, elt, int32('\000'), libc.Uint32FromInt32(nbytes))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(nbytes)
		...
		xDst = 0
		yDst = 0
		libc.Xmemcpy(tls, elt+libc.UintptrFromInt32(1)*8, string1, uint32(252))
	...
	if nchar != 0 {
		...
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(nbytes)
		...
		(*TxGlyphElt)(unsafe.Pointer(elt)).Fdeltax = int16(xDst)
		(*TxGlyphElt)(unsafe.Pointer(elt)).Fdeltay = int16(yDst)
		libc.Xmemcpy(tls, elt+libc.UintptrFromInt32(1)*8, string1, libc.Uint32FromInt32(nchar))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderCompositeString16(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, glyphset TGlyphSet, xSrc int32, ySrc int32, xDst int32, yDst int32, string1 uintptr, nchar int32) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCompositeGlyphs16), uint32(m_sz_xRenderCompositeGlyphs16Req))
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FreqType = libc.Uint8FromInt32((*TXExtCodes)(unsafe.Pointer((*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes)).Fmajor_opcode)
	...
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FxSrc = int16(xSrc)
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FySrc = int16(ySrc)
	len1 = int32(m_sz_xGlyphElt)*((nchar+int32(254)-int32(1))/int32(254)) + nchar*int32(2)
	p2 = req + 2
	*(*TCARD16)(unsafe.Pointer(p2)) = TCARD16(int32(*(*TCARD16)(unsafe.Pointer(p2))) + (len1+libc.Int32FromInt32(3))>>libc.Int32FromInt32(2)) /* convert to number of 32-bit words */
	/*
	 * If the entire request does not fit into the remaining space in the
	...
	for nchar > int32(254) {
		...
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(nbytes)
		...
		xDst = 0
		yDst = 0
		libc.Xmemcpy(tls, elt+libc.UintptrFromInt32(1)*8, string1, libc.Uint32FromInt32(libc.Int32FromInt32(254)*libc.Int32FromInt32(2)))
	...
	if nchar != 0 {
		...
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(nbytes)
		...
		(*TxGlyphElt)(unsafe.Pointer(elt)).Fdeltax = int16(xDst)
		(*TxGlyphElt)(unsafe.Pointer(elt)).Fdeltay = int16(yDst)
		libc.Xmemcpy(tls, elt+libc.UintptrFromInt32(1)*8, string1, libc.Uint32FromInt32(nchar*int32(2)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderCompositeString32(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, glyphset TGlyphSet, xSrc int32, ySrc int32, xDst int32, yDst int32, string1 uintptr, nchar int32) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCompositeGlyphs32), uint32(m_sz_xRenderCompositeGlyphs32Req))
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FreqType = libc.Uint8FromInt32((*TXExtCodes)(unsafe.Pointer((*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes)).Fmajor_opcode)
	...
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FxSrc = int16(xSrc)
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FySrc = int16(ySrc)
	len1 = int32(m_sz_xGlyphElt)*((nchar+int32(254)-int32(1))/int32(254)) + nchar*int32(4)
	p2 = req + 2
	*(*TCARD16)(unsafe.Pointer(p2)) = TCARD16(int32(*(*TCARD16)(unsafe.Pointer(p2))) + (len1+libc.Int32FromInt32(3))>>libc.Int32FromInt32(2)) /* convert to number of 32-bit words */
	/*
	 * If the entire request does not fit into the remaining space in the
	...
	for nchar > int32(254) {
		...
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(nbytes)
		...
		xDst = 0
		yDst = 0
		libc.Xmemcpy(tls, elt+libc.UintptrFromInt32(1)*8, string1, libc.Uint32FromInt32(libc.Int32FromInt32(254)*libc.Int32FromInt32(4)))
		nchar = nchar - int32(254)
	...
	if nchar != 0 {
		...
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(nbytes)
		...
		(*TxGlyphElt)(unsafe.Pointer(elt)).Fdeltax = int16(xDst)
		(*TxGlyphElt)(unsafe.Pointer(elt)).Fdeltay = int16(yDst)
		libc.Xmemcpy(tls, elt+libc.UintptrFromInt32(1)*8, string1, libc.Uint32FromInt32(nchar*int32(4)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderCompositeText8(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, xDst int32, yDst int32, elts uintptr, nelt int32) {
	...
	var elen, i, len1, nchars, this_chars, v5 int32
	var v1 uint32
	...
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FmaskFormat = v1
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).Fglyphset = (*(*TXGlyphElt8)(unsafe.Pointer(elts))).Fglyphset
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FxSrc = int16(xSrc)
	(*TxRenderCompositeGlyphs8Req)(unsafe.Pointer(req)).FySrc = int16(ySrc)
	/*
	...
	*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt8)(unsafe.Pointer(elts))).Fglyphset
	...
	for {
		 ...
		 */
		if (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset != *(*TGlyphSet)(unsafe.Pointer(bp)) {
			*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset
			len1 += int32((libc.Int32FromInt32(m_sz_xGlyphElt) + libc.Int32FromInt32(4)) >> libc.Int32FromInt32(2))
		}
		nchars = (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).Fnchars
		/*
		 * xGlyphElt must be aligned on a 32-bit boundary; this is
		 * easily done by filling no more than 252 glyphs in each
		 * bucket
		 */
		elen = int32(m_sz_xGlyphElt)*((nchars+int32(252)-int32(1))/int32(252)) + nchars
		len1 += (elen + int32(3)) >> int32(2)
		goto _2
	_2:
		;
		i++
	...
	p3 = req + 2
	*(*TCARD16)(unsafe.Pointer(p3)) = TCARD16(int32(*(*TCARD16)(unsafe.Pointer(p3))) + len1)
	/*
	 * Send the glyphs
	 */
	*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt8)(unsafe.Pointer(elts))).Fglyphset
	...
	for {
		...
		if (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset != *(*TGlyphSet)(unsafe.Pointer(bp)) {
			*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset
			...
			elt = (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr
			libc.Xmemset(tls, elt, int32('\000'), libc.Uint32FromInt32(libc.Int32FromInt32(m_sz_xGlyphElt)))
			*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Int32FromInt32(m_sz_xGlyphElt))
		...
		nchars = (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).Fnchars
		xDst = (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).FxOff
		yDst = (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).FyOff
		chars = (*(*TXGlyphElt8)(unsafe.Pointer(elts + uintptr(i)*20))).Fchars
		for nchars != 0 {
			if nchars > int32(252) {
				v5 = int32(252)
			} else {
			...
			*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Int32FromInt32(m_sz_xGlyphElt))
			...
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(this_chars) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
				libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, chars, libc.Uint32FromInt32(this_chars))
				*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(this_chars+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
			} else {
				libx11.X_XSend(tls, dpy, chars, this_chars)
			}
			nchars -= this_chars
...
func XXRenderCompositeText16(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, xDst int32, yDst int32, elts uintptr, nelt int32) {
	...
	defer tls.Free(16)
	var chars, elt, info, req, p3 uintptr
	var elen, i, len1, nchars, this_bytes, this_chars, v5 int32
	var v1 uint32
	var _ /* glyphset at bp+0 */ TGlyphSet
	...
	(*TxRenderCompositeGlyphs16Req)(unsafe.Pointer(req)).Fsrc = src
	(*TxRenderCompositeGlyphs16Req)(unsafe.Pointer(req)).Fdst = dst
	if maskFormat != 0 {
		v1 = (*TXRenderPictFormat)(unsafe.Pointer(maskFormat)).Fid
	} else {
		v1 = uint32(0)
	}
	(*TxRenderCompositeGlyphs16Req)(unsafe.Pointer(req)).FmaskFormat = v1
	(*TxRenderCompositeGlyphs16Req)(unsafe.Pointer(req)).Fglyphset = (*(*TXGlyphElt16)(unsafe.Pointer(elts))).Fglyphset
	...
	*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt16)(unsafe.Pointer(elts))).Fglyphset
	...
	for {
		 ...
		 * Check for glyphset change
		 */
		if (*(*TXGlyphElt16)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset != *(*TGlyphSet)(unsafe.Pointer(bp)) {
			*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt16)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset
			len1 += int32((libc.Int32FromInt32(m_sz_xGlyphElt) + libc.Int32FromInt32(4)) >> libc.Int32FromInt32(2))
		}
		nchars = (*(*TXGlyphElt16)(unsafe.Pointer(elts + uintptr(i)*20))).Fnchars
		/*
		 * xGlyphElt must be aligned on a 32-bit boundary; this is
		 * easily done by filling no more than 254 glyphs in each
		 * bucket
		 */
		elen = int32(m_sz_xGlyphElt)*((nchars+int32(254)-int32(1))/int32(254)) + nchars*int32(2)
		len1 += (elen + int32(3)) >> int32(2)
		goto _2
	_2:
		;
	...
	*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt16)(unsafe.Pointer(elts))).Fglyphset
	...
	for {
		...
		nchars = (*(*TXGlyphElt16)(unsafe.Pointer(elts + uintptr(i)*20))).Fnchars
		xDst = (*(*TXGlyphElt16)(unsafe.Pointer(elts + uintptr(i)*20))).FxOff
		yDst = (*(*TXGlyphElt16)(unsafe.Pointer(elts + uintptr(i)*20))).FyOff
		chars = (*(*TXGlyphElt16)(unsafe.Pointer(elts + uintptr(i)*20))).Fchars
		for nchars != 0 {
			if nchars > int32(254) {
				v5 = int32(254)
			} else {
			...
			*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Int32FromInt32(m_sz_xGlyphElt))
			...
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(this_bytes) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
				libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, chars, libc.Uint32FromInt32(this_bytes))
				*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(this_bytes+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
			} else {
				libx11.X_XSend(tls, dpy, chars, this_bytes)
			}
			nchars -= this_chars
...
func XXRenderCompositeText32(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, xDst int32, yDst int32, elts uintptr, nelt int32) {
	...
	(*TxRenderCompositeGlyphs32Req)(unsafe.Pointer(req)).Fsrc = src
	(*TxRenderCompositeGlyphs32Req)(unsafe.Pointer(req)).Fdst = dst
	if maskFormat != 0 {
		v1 = (*TXRenderPictFormat)(unsafe.Pointer(maskFormat)).Fid
	} else {
		v1 = uint32(0)
	}
	(*TxRenderCompositeGlyphs32Req)(unsafe.Pointer(req)).FmaskFormat = v1
	(*TxRenderCompositeGlyphs32Req)(unsafe.Pointer(req)).Fglyphset = (*(*TXGlyphElt32)(unsafe.Pointer(elts))).Fglyphset
	...
	*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt32)(unsafe.Pointer(elts))).Fglyphset
	...
	for {
		 ...
		 * Check for glyphset change
		 */
		if (*(*TXGlyphElt32)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset != *(*TGlyphSet)(unsafe.Pointer(bp)) {
			*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt32)(unsafe.Pointer(elts + uintptr(i)*20))).Fglyphset
			len1 += int32((libc.Int32FromInt32(m_sz_xGlyphElt) + libc.Int32FromInt32(4)) >> libc.Int32FromInt32(2))
		}
		nchars = (*(*TXGlyphElt32)(unsafe.Pointer(elts + uintptr(i)*20))).Fnchars
		elen = int32(m_sz_xGlyphElt)*((nchars+int32(254)-int32(1))/int32(254)) + nchars*int32(4)
		len1 += (elen + int32(3)) >> int32(2)
		goto _2
	_2:
		;
	...
	*(*TGlyphSet)(unsafe.Pointer(bp)) = (*(*TXGlyphElt32)(unsafe.Pointer(elts))).Fglyphset
	...
	for {
		...
		nchars = (*(*TXGlyphElt32)(unsafe.Pointer(elts + uintptr(i)*20))).Fnchars
		xDst = (*(*TXGlyphElt32)(unsafe.Pointer(elts + uintptr(i)*20))).FxOff
		yDst = (*(*TXGlyphElt32)(unsafe.Pointer(elts + uintptr(i)*20))).FyOff
		chars = (*(*TXGlyphElt32)(unsafe.Pointer(elts + uintptr(i)*20))).Fchars
		for nchars != 0 {
			if nchars > int32(254) {
				v5 = int32(254)
			} else {
...
func __XRenderProcessPictureAttributes(tls *libc.TLS, dpy uintptr, req uintptr, valuemask uint32, attributes uintptr) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	var nvalues, v15 uint32
	var value, v1, v10, v11, v12, v13, v2, v3, v4, v5, v6, v7, v8, v9, p14 uintptr
	var _ /* values at bp+0 */ [32]uint32
	...
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(0)) != 0 {
		v1 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v1)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Frepeat)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(1)) != 0 {
		v2 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v2)) = (*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Falpha_map
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(2)) != 0 {
		v3 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v3)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Falpha_x_origin)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(3)) != 0 {
		v4 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v4)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Falpha_y_origin)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(4)) != 0 {
		v5 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v5)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fclip_x_origin)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(5)) != 0 {
		v6 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v6)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fclip_y_origin)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(6)) != 0 {
		v7 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v7)) = (*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fclip_mask
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(7)) != 0 {
		v8 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v8)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fgraphics_exposures)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(8)) != 0 {
		v9 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v9)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fsubwindow_mode)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(9)) != 0 {
		v10 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v10)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fpoly_edge)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(10)) != 0 {
		v11 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v11)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fpoly_mode)
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(11)) != 0 {
		v12 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v12)) = (*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fdither
	}
	if valuemask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(12)) != 0 {
		v13 = value
		value += 4
		*(*uint32)(unsafe.Pointer(v13)) = libc.Uint32FromInt32((*TXRenderPictureAttributes)(unsafe.Pointer(attributes)).Fcomponent_alpha)
	}
	p14 = req + 2
	v15 = libc.Uint32FromInt32((int32(value) - t__predefined_ptrdiff_t(bp)) / 4)
	nvalues = v15
	*(*TCARD16)(unsafe.Pointer(p14)) = TCARD16(uint32(*(*TCARD16)(unsafe.Pointer(p14))) + v15)
	nvalues <<= uint32(2) /* watch out for macros... */
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(libc.Int32FromUint32(nvalues)) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, bp, libc.Uint32FromInt32(libc.Int32FromUint32(nvalues)))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(libc.Int32FromUint32(nvalues)+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, bp, libc.Int32FromUint32(nvalues))
	}
}

func XXRenderCreatePicture(tls *libc.TLS, dpy uintptr, drawable TDrawable, format uintptr, valuemask uint32, attributes uintptr) (r TPicture) {
	var info, req uintptr
	var pid, v1 TPicture
	var v2 TCARD32
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreatePicture), uint32(m_sz_xRenderCreatePictureReq))
	...
	pid = v1
	(*TxRenderCreatePictureReq)(unsafe.Pointer(req)).Fpid = v1
	(*TxRenderCreatePictureReq)(unsafe.Pointer(req)).Fdrawable = drawable
	(*TxRenderCreatePictureReq)(unsafe.Pointer(req)).Fformat = (*TXRenderPictFormat)(unsafe.Pointer(format)).Fid
	v2 = valuemask
...
func XXRenderChangePicture(tls *libc.TLS, dpy uintptr, picture TPicture, valuemask uint32, attributes uintptr) {
	var info, req uintptr
	_, _ = info, req
	info = XXRenderFindDisplay(tls, dpy)
	if !(info != 0 && (*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes != 0) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderChangePicture), uint32(m_sz_xRenderChangePictureReq))
	...
	(*TxRenderChangePictureReq)(unsafe.Pointer(req)).Fpicture = picture
	(*TxRenderChangePictureReq)(unsafe.Pointer(req)).Fmask = valuemask
	__XRenderProcessPictureAttributes(tls, dpy, req, valuemask, attributes)
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func __XRenderSetPictureClipRectangles(tls *libc.TLS, dpy uintptr, info uintptr, picture TPicture, xOrigin int32, yOrigin int32, rects uintptr, n int32) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderSetPictureClipRectangles), uint32(m_sz_xRenderSetPictureClipRectanglesReq))
	...
	(*TxRenderSetPictureClipRectanglesReq)(unsafe.Pointer(req)).Fpicture = picture
	...
	len1 = n << int32(1)
	if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderSetPictureClipRectanglesReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
			_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderSetPictureClipRectanglesReq)(unsafe.Pointer(req)).Flength) - int32(1))
			...
			*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
			...
			len1 = int32(1)
			(*TxRenderSetPictureClipRectanglesReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderSetPictureClipRectanglesReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	} else {
		(*TxRenderSetPictureClipRectanglesReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderSetPictureClipRectanglesReq)(unsafe.Pointer(req)).Flength) + len1)
	}
	len1 <<= int32(2)
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(len1) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, rects, libc.Uint32FromInt32(len1))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(len1+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
...
func XXRenderSetPictureClipRegion(tls *libc.TLS, dpy uintptr, picture TPicture, r TRegion) {
	...
	total = libc.Uint32FromInt32((*T_XRegion)(unsafe.Pointer(r)).FnumRects) * uint32(8)
	v1 = libx11.X_XAllocTemp(tls, dpy, total)
	xr = v1
	if v1 != 0 {
		pr = xr
		pb = (*T_XRegion)(unsafe.Pointer(r)).Frects
		i = (*T_XRegion)(unsafe.Pointer(r)).FnumRects
		for {
			i--
			v3 = i
			if !(v3 >= 0) {
	...
	if xr != 0 || !((*T_XRegion)(unsafe.Pointer(r)).FnumRects != 0) {
		__XRenderSetPictureClipRectangles(tls, dpy, info, picture, 0, 0, xr, (*T_XRegion)(unsafe.Pointer(r)).FnumRects)
	}
	if xr != 0 {
...
func XXRenderSetPictureTransform(tls *libc.TLS, dpy uintptr, picture TPicture, transform uintptr) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderSetPictureTransform), uint32(m_sz_xRenderSetPictureTransformReq))
	...
	(*TxRenderSetPictureTransformReq)(unsafe.Pointer(req)).Fpicture = picture
...
func XXRenderFreePicture(tls *libc.TLS, dpy uintptr, picture TPicture) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderFreePicture), uint32(m_sz_xRenderFreePictureReq))
	...
	(*TxRenderFreePictureReq)(unsafe.Pointer(req)).Fpicture = picture
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
...
func XXRenderCreateSolidFill(tls *libc.TLS, dpy uintptr, color uintptr) (r TPicture) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreateSolidFill), uint32(m_sz_xRenderCreateSolidFillReq))
	...
	pid = v1
	(*TxRenderCreateSolidFillReq)(unsafe.Pointer(req)).Fpid = v1
...
func XXRenderCreateLinearGradient(tls *libc.TLS, dpy uintptr, gradient uintptr, stops uintptr, colors uintptr, nStops int32) (r TPicture) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreateLinearGradient), uint32(m_sz_xRenderCreateLinearGradientReq))
	...
	pid = v1
	(*TxRenderCreateLinearGradientReq)(unsafe.Pointer(req)).Fpid = v1
	...
	len1 = nStops * int32(3)
	if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateLinearGradientReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
			_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateLinearGradientReq)(unsafe.Pointer(req)).Flength) - int32(1))
			...
			*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
			...
			len1 = int32(6)
			(*TxRenderCreateLinearGradientReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateLinearGradientReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	} else {
		(*TxRenderCreateLinearGradientReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateLinearGradientReq)(unsafe.Pointer(req)).Flength) + len1)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(nStops*libc.Int32FromInt32(4)) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, stops, libc.Uint32FromInt32(nStops*libc.Int32FromInt32(4)))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(nStops*libc.Int32FromInt32(4)+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, stops, int32(nStops*libc.Int32FromInt32(4)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(nStops*libc.Int32FromInt32(8)) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
		libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, colors, libc.Uint32FromInt32(nStops*libc.Int32FromInt32(8)))
		*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(nStops*libc.Int32FromInt32(8)+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
	} else {
		libx11.X_XSend(tls, dpy, colors, int32(nStops*libc.Int32FromInt32(8)))
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
func XXRenderCreateRadialGradient(tls *libc.TLS, dpy uintptr, gradient uintptr, stops uintptr, colors uintptr, nStops int32) (r TPicture) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreateRadialGradient), uint32(m_sz_xRenderCreateRadialGradientReq))
	...
	pid = v1
	(*TxRenderCreateRadialGradientReq)(unsafe.Pointer(req)).Fpid = v1
	...
	len1 = nStops * int32(3)
	if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateRadialGradientReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
			_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateRadialGradientReq)(unsafe.Pointer(req)).Flength) - int32(1))
			...
			*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
			...
			len1 = int32(6)
			(*TxRenderCreateRadialGradientReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateRadialGradientReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	} else {
		(*TxRenderCreateRadialGradientReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateRadialGradientReq)(unsafe.Pointer(req)).Flength) + len1)
	}
...
func XXRenderCreateConicalGradient(tls *libc.TLS, dpy uintptr, gradient uintptr, stops uintptr, colors uintptr, nStops int32) (r TPicture) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderCreateConicalGradient), uint32(m_sz_xRenderCreateConicalGradientReq))
	...
	pid = v1
	(*TxRenderCreateConicalGradientReq)(unsafe.Pointer(req)).Fpid = v1
	...
	len1 = nStops * int32(3)
	if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateConicalGradientReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
			_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderCreateConicalGradientReq)(unsafe.Pointer(req)).Flength) - int32(1))
			...
			*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
			...
			len1 = int32(6)
			(*TxRenderCreateConicalGradientReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateConicalGradientReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	} else {
		(*TxRenderCreateConicalGradientReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderCreateConicalGradientReq)(unsafe.Pointer(req)).Flength) + len1)
	}
...
func _XRenderComputeTrapezoids(tls *libc.TLS, edges uintptr, nedges int32, winding int32, traps uintptr) (r int32) {
	...
	ntraps = 0
	libc.Xqsort(tls, edges, libc.Uint32FromInt32(nedges), uint32(32), __ccgo_fp(_CompareEdge))
	...
	for active != 0 || inactive < nedges {
		...
		if inactive < nedges && (*(*TEdge)(unsafe.Pointer(edges + uintptr(inactive)*32))).Fedge.Fp1.Fy < next_y {
			next_y = (*(*TEdge)(unsafe.Pointer(edges + uintptr(inactive)*32))).Fedge.Fp1.Fy
		}
...
func XXRenderCompositeDoublePoly(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, xDst int32, yDst int32, fpoints uintptr, npoints int32, winding int32) {
	...
	var v1 uint32
	_, _, _, _, _, _, _, _, _, _, _, _, _, _ = bottom, edges, firstx, firsty, i, nedges, ntraps, prevx, prevy, top, traps, x, y, v1
	prevx = 0
	prevy = 0
	firstx = 0
	firsty = 0
	top = 0
	bottom = 0 /* GCCism */
	if libc.Uint32FromInt32(npoints)*uint32(32)+libc.Uint32FromInt32(npoints*npoints)*uint32(40) == uint32(0) {
		v1 = uint32(1)
	} else {
		v1 = libc.Uint32FromInt32(npoints)*uint32(32) + libc.Uint32FromInt32(npoints*npoints)*uint32(40)
	}
	edges = libc.Xmalloc(tls, v1)
	if !(edges != 0) {
		return
	}
	traps = edges + uintptr(npoints)*32
	nedges = 0
	i = 0
	for {
		if !(i <= npoints) {
		...
		if i != 0 {
			...
			if prevy < y {
				(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp1.Fx = prevx
				(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp1.Fy = prevy
				(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp2.Fx = x
				(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp2.Fy = y
				(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).FclockWise = int32(m_True)
				nedges++
			} else {
				if prevy > y {
					(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp1.Fx = x
					(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp1.Fy = y
					(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp2.Fx = prevx
					(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).Fedge.Fp2.Fy = prevy
					(*(*TEdge)(unsafe.Pointer(edges + uintptr(nedges)*32))).FclockWise = m_False
					nedges++
				}
			}
...
func XXRenderCompositeTrapezoids(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, traps uintptr, ntrap int32) {
	...
	for ntrap != 0 {
		req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderTrapezoids), uint32(m_sz_xRenderTrapezoidsReq))
		...
		(*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Fsrc = src
		(*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Fdst = dst
		if maskFormat != 0 {
			v2 = (*TXRenderPictFormat)(unsafe.Pointer(maskFormat)).Fid
		} else {
			v2 = uint32(0)
		}
		(*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).FmaskFormat = v2
		(*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).FxSrc = int16(xSrc)
		(*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).FySrc = int16(ySrc)
		n = ntrap
		len1 = n * int32(libc.Int32FromInt32(m_sz_xTrapezoid)>>libc.Int32FromInt32(2))
		if libc.Uint32FromInt32(len1) > max_req-uint32((*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength) {
			n = libc.Int32FromUint32((max_req - uint32((*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength)) / libc.Uint32FromInt32(libc.Int32FromInt32(m_sz_xTrapezoid)>>libc.Int32FromInt32(2)))
			len1 = n * int32(libc.Int32FromInt32(m_sz_xTrapezoid)>>libc.Int32FromInt32(2))
		}
		if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
				_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength) - int32(1))
				...
				*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
				...
				len1 = len1
				(*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength) + len1)
			}
		} else {
			(*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTrapezoidsReq)(unsafe.Pointer(req)).Flength) + len1)
		}
...
func XXRenderCompositeTriangles(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, triangles uintptr, ntriangle int32) {
	...
	for ntriangle != 0 {
		req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderTriangles), uint32(m_sz_xRenderTrianglesReq))
		...
		(*TxRenderTrianglesReq)(unsafe.Pointer(req)).Fsrc = src
		(*TxRenderTrianglesReq)(unsafe.Pointer(req)).Fdst = dst
		if maskFormat != 0 {
			v1 = (*TXRenderPictFormat)(unsafe.Pointer(maskFormat)).Fid
		} else {
			v1 = uint32(0)
		}
		(*TxRenderTrianglesReq)(unsafe.Pointer(req)).FmaskFormat = v1
		(*TxRenderTrianglesReq)(unsafe.Pointer(req)).FxSrc = int16(xSrc)
		(*TxRenderTrianglesReq)(unsafe.Pointer(req)).FySrc = int16(ySrc)
		n = ntriangle
		len1 = n * int32(libc.Int32FromInt32(m_sz_xTriangle)>>libc.Int32FromInt32(2))
		if !((*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0) && libc.Uint32FromInt32(len1) > (*TDisplay)(unsafe.Pointer(dpy)).Fmax_request_size-uint32((*TxRenderTrianglesReq)(unsafe.Pointer(req)).Flength) {
		...
		if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTrianglesReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
				_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTrianglesReq)(unsafe.Pointer(req)).Flength) - int32(1))
				...
				*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
				...
				len1 = len1
				(*TxRenderTrianglesReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTrianglesReq)(unsafe.Pointer(req)).Flength) + len1)
			}
		} else {
			(*TxRenderTrianglesReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTrianglesReq)(unsafe.Pointer(req)).Flength) + len1)
		}
		len1 <<= int32(2)
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(len1) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
			libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, triangles, libc.Uint32FromInt32(len1))
			*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(len1+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
		} else {
...
func XXRenderCompositeTriStrip(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, points uintptr, npoint int32) {
	...
	for npoint > int32(2) {
		req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderTriStrip), uint32(m_sz_xRenderTriStripReq))
		...
		(*TxRenderTriStripReq)(unsafe.Pointer(req)).Fsrc = src
		(*TxRenderTriStripReq)(unsafe.Pointer(req)).Fdst = dst
		if maskFormat != 0 {
			v1 = (*TXRenderPictFormat)(unsafe.Pointer(maskFormat)).Fid
		} else {
			v1 = uint32(0)
		}
		(*TxRenderTriStripReq)(unsafe.Pointer(req)).FmaskFormat = v1
		(*TxRenderTriStripReq)(unsafe.Pointer(req)).FxSrc = int16(xSrc)
		(*TxRenderTriStripReq)(unsafe.Pointer(req)).FySrc = int16(ySrc)
		n = npoint
		len1 = n * int32(libc.Int32FromInt32(m_sz_xPointFixed)>>libc.Int32FromInt32(2))
		if !((*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0) && libc.Uint32FromInt32(len1) > (*TDisplay)(unsafe.Pointer(dpy)).Fmax_request_size-uint32((*TxRenderTriStripReq)(unsafe.Pointer(req)).Flength) {
		...
		if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTriStripReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
				_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTriStripReq)(unsafe.Pointer(req)).Flength) - int32(1))
				...
				*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
				...
				len1 = len1
				(*TxRenderTriStripReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTriStripReq)(unsafe.Pointer(req)).Flength) + len1)
			}
		} else {
			(*TxRenderTriStripReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTriStripReq)(unsafe.Pointer(req)).Flength) + len1)
		}
		len1 <<= int32(2)
		if (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr+uintptr(len1) <= (*TDisplay)(unsafe.Pointer(dpy)).Fbufmax {
			libc.Xmemcpy(tls, (*TDisplay)(unsafe.Pointer(dpy)).Fbufptr, points, libc.Uint32FromInt32(len1))
			*(*uintptr)(unsafe.Pointer(dpy + 108)) += uintptr(libc.Uint32FromInt32(len1+libc.Int32FromInt32(3)) & libc.Uint32FromInt32(^libc.Int32FromInt32(3)))
		} else {
...
func XXRenderCompositeTriFan(tls *libc.TLS, dpy uintptr, op int32, src TPicture, dst TPicture, maskFormat uintptr, xSrc int32, ySrc int32, points uintptr, npoint int32) {
	...
	npoint--
	for npoint > int32(1) {
		req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderTriFan), libc.Uint32FromInt32(libc.Int32FromInt32(m_sz_xRenderTriFanReq)+libc.Int32FromInt32(m_sz_xPointFixed)))
		...
		(*TxRenderTriFanReq)(unsafe.Pointer(req)).Fsrc = src
		(*TxRenderTriFanReq)(unsafe.Pointer(req)).Fdst = dst
		if maskFormat != 0 {
			v1 = (*TXRenderPictFormat)(unsafe.Pointer(maskFormat)).Fid
		} else {
			v1 = uint32(0)
		}
		(*TxRenderTriFanReq)(unsafe.Pointer(req)).FmaskFormat = v1
		...
		n = npoint
		len1 = n * int32(libc.Int32FromInt32(m_sz_xPointFixed)>>libc.Int32FromInt32(2))
		if !((*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0) && libc.Uint32FromInt32(len1) > (*TDisplay)(unsafe.Pointer(dpy)).Fmax_request_size-uint32((*TxRenderTriFanReq)(unsafe.Pointer(req)).Flength) {
		...
		if libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTriFanReq)(unsafe.Pointer(req)).Flength)+len1) > uint32(libc.Uint32FromInt32(65535)) {
			if (*TDisplay)(unsafe.Pointer(dpy)).Fbigreq_size != 0 {
				_BRlen = libc.Uint32FromInt32(libc.Int32FromUint16((*TxRenderTriFanReq)(unsafe.Pointer(req)).Flength) - int32(1))
				...
				*(*TCARD32)(unsafe.Pointer(req + 1*4)) = _BRlen + libc.Uint32FromInt32(len1) + uint32(2)
				...
				len1 = len1
				(*TxRenderTriFanReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTriFanReq)(unsafe.Pointer(req)).Flength) + len1)
			}
		} else {
			(*TxRenderTriFanReq)(unsafe.Pointer(req)).Flength = libc.Uint16FromInt32(libc.Int32FromUint16((*TxRenderTriFanReq)(unsafe.Pointer(req)).Flength) + len1)
		}
	...
	if libc.Int32FromUint8((*TXErrorEvent)(unsafe.Pointer(evt)).Frequest_code) == int32(m_X_CreatePixmap) && libc.Int32FromUint8((*TXErrorEvent)(unsafe.Pointer(evt)).Ferror_code) == int32(m_BadValue) {
		...
		for {
			...
			if (*T_DepthCheckRec)(unsafe.Pointer(d)).Fdpy == dpy {
				if libc.Int32FromUint32((*TXErrorEvent)(unsafe.Pointer(evt)).Fserial-(*T_DepthCheckRec)(unsafe.Pointer(d)).Fserial) >= 0 {
					*(*TCARD32)(unsafe.Pointer(d + 8)) |= uint32(libc.Uint32FromUint32(1) << ((*TXErrorEvent)(unsafe.Pointer(evt)).Fresourceid - libc.Uint32FromInt32(1)))
				}
				break
			}
			goto _1
...
func _XRenderHasDepths(tls *libc.TLS, dpy uintptr) (r int32) {
	...
	for {
		...
		scr = (*struct {
			...
			Fprivate19           int32
			Fxdefaults           uintptr
		})(unsafe.Pointer(dpy)).Fscreens + uintptr(s)*80
		d = 0
		for {
			if !(d < (*TScreen)(unsafe.Pointer(scr)).Fndepths) {
				break
			}
			depths |= uint32(libc.Uint32FromUint32(1) << ((*(*TDepth)(unsafe.Pointer((*TScreen)(unsafe.Pointer(scr)).Fdepths + uintptr(d)*12))).Fdepth - libc.Int32FromInt32(1)))
			goto _2
		_2:
			;
			d++
		}
		missing = ^depths & uint32(libc.Uint32FromUint32(1)<<(libc.Int32FromInt32(1)-libc.Int32FromInt32(1))|libc.Uint32FromUint32(1)<<(libc.Int32FromInt32(4)-libc.Int32FromInt32(1))|libc.Uint32FromUint32(1)<<(libc.Int32FromInt32(8)-libc.Int32FromInt32(1))|libc.Uint32FromUint32(1)<<(libc.Int32FromInt32(24)-libc.Int32FromInt32(1))|libc.Uint32FromUint32(1)<<(libc.Int32FromInt32(32)-libc.Int32FromInt32(1)))
		if missing != 0 {
			/*
			...
			for {
				...
				if missing&uint32(libc.Uint32FromUint32(1)<<(d-libc.Int32FromInt32(1))) != 0 && d != int32(1) {
					p = libx11.XXCreatePixmap(tls, dpy, (*TScreen)(unsafe.Pointer((*struct {
						...
						Fprivate19           int32
						Fxdefaults           uintptr
					})(unsafe.Pointer(dpy)).Fscreens+uintptr(s)*80)).Froot, uint32(1), uint32(1), libc.Uint32FromInt32(d))
...
func _XRenderExtAddDisplay(tls *libc.TLS, extinfo uintptr, dpy uintptr, ext_name uintptr) (r uintptr) {
	...
	_, _ = codes, dpyinfo
	dpyinfo = libc.Xmalloc(tls, libc.Uint32FromInt64(16))
	if !(dpyinfo != 0) {
		return libc.UintptrFromInt32(0)
	}
...
func __XRenderFindFormat(tls *libc.TLS, xri uintptr, format TPictFormat) (r uintptr) {
	...
	for {
		...
		if (*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fid == format {
			return (*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32
		}
		goto _1
	_1:
		;
...
func XXRenderQueryFormats(tls *libc.TLS, dpy uintptr) (r int32) {
	...
	var nbytes, rlength, v1, v2, v3 uint32
	var nd, nf, ns, nv int32
	var _ /* async at bp+0 */ T_XAsyncHandler
	var _ /* async_state at bp+12 */ T_XrenderVersionState
	var _ /* rep at bp+28 */ TxRenderQueryPictFormatsReply
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = depth, format, info, nbytes, nd, nf, ns, nv, req, rlength, screen, visual, vreq, xData, xDepth, xFormat, xScreen, xSubpixel, xVisual, xri, v1, v2, v3
	info = XXRenderFindDisplay(tls, dpy)
	if !(info != 0 && (*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Fcodes != 0) {
		return 0
	}
	...
	vreq = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderQueryVersion), uint32(m_sz_xRenderQueryVersionReq))
	...
	(*(*T_XrenderVersionState)(unsafe.Pointer(bp + 12))).Fversion_seq = (*TDisplay)(unsafe.Pointer(dpy)).Frequest
	(*(*T_XrenderVersionState)(unsafe.Pointer(bp + 12))).Ferror1 = m_False
	...
	(*(*T_XAsyncHandler)(unsafe.Pointer(bp))).Fdata = bp + 12
	(*TDisplay)(unsafe.Pointer(dpy)).Fasync_handlers = bp
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderQueryPictFormats), uint32(m_sz_xRenderQueryPictFormatsReq))
	...
	if !(libx11.X_XReply(tls, dpy, bp+28, 0, m_xFalse) != 0) {
	...
	if (*(*T_XrenderVersionState)(unsafe.Pointer(bp + 12))).Ferror1 != 0 {
		if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
			(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
		}
		if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
	...
	if !(xri != 0) || !(xData != 0) || nbytes < rlength {
		...
		libx11.X_XEatDataWords(tls, dpy, (*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).Flength)
		if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
			(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
		}
		if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
	...
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fmajor_version = (*(*T_XrenderVersionState)(unsafe.Pointer(bp + 12))).Fmajor_version
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fminor_version = (*(*T_XrenderVersionState)(unsafe.Pointer(bp + 12))).Fminor_version
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fformat = xri + libc.UintptrFromInt32(1)*64
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fnformat = libc.Int32FromUint32((*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumFormats)
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fscreen = (*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr((*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumFormats)*32
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fnscreen = libc.Int32FromUint32((*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumScreens)
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fdepth = (*TXRenderInfo)(unsafe.Pointer(xri)).Fscreen + uintptr((*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumScreens)*16
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fndepth = libc.Int32FromUint32((*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumDepths)
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fvisual = (*TXRenderInfo)(unsafe.Pointer(xri)).Fdepth + uintptr((*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumDepths)*12
	(*TXRenderInfo)(unsafe.Pointer(xri)).Fnvisual = libc.Int32FromUint32((*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumVisuals)
	libx11.X_XRead(tls, dpy, xData, libc.Int32FromUint32(rlength))
	format = (*TXRenderInfo)(unsafe.Pointer(xri)).Fformat
	xFormat = xData
	nf = 0
	for {
		if !(libc.Uint32FromInt32(nf) < (*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumFormats) {
			break
		}
		(*TXRenderPictFormat)(unsafe.Pointer(format)).Fid = (*TxPictFormInfo)(unsafe.Pointer(xFormat)).Fid
		...
		(*TXRenderPictFormat)(unsafe.Pointer(format)).Fcolormap = (*TxPictFormInfo)(unsafe.Pointer(xFormat)).Fcolormap
		format += 32
		xFormat += 28
		goto _4
	_4:
	...
	for {
		...
		(*TXRenderScreen)(unsafe.Pointer(screen)).Ffallback = __XRenderFindFormat(tls, xri, (*TxPictScreen)(unsafe.Pointer(xScreen)).Ffallback)
		(*TXRenderScreen)(unsafe.Pointer(screen)).Fsubpixel = m_SubPixelUnknown
		xDepth = xScreen + libc.UintptrFromInt32(1)*8
		if libc.Uint32FromInt32((*TXRenderScreen)(unsafe.Pointer(screen)).Fndepths) > (*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumDepths {
			libc.Xfree(tls, xri)
			libc.Xfree(tls, xData)
			libx11.X_XEatDataWords(tls, dpy, (*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).Flength)
			if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		...
		(*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumDepths -= libc.Uint32FromInt32((*TXRenderScreen)(unsafe.Pointer(screen)).Fndepths)
		nd = 0
		for {
			...
			if libc.Uint32FromInt32((*TXRenderDepth)(unsafe.Pointer(depth)).Fnvisuals) > (*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumVisuals {
				libc.Xfree(tls, xri)
				libc.Xfree(tls, xData)
				libx11.X_XEatDataWords(tls, dpy, (*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).Flength)
				if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
			...
			(*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumVisuals -= libc.Uint32FromInt32((*TXRenderDepth)(unsafe.Pointer(depth)).Fnvisuals)
			nv = 0
			for {
				if !(nv < (*TXRenderDepth)(unsafe.Pointer(depth)).Fnvisuals) {
					break
				}
				(*TXRenderVisual)(unsafe.Pointer(visual)).Fvisual = __XRenderFindVisual(tls, dpy, (*TxPictVisual)(unsafe.Pointer(xVisual)).Fvisual)
				(*TXRenderVisual)(unsafe.Pointer(visual)).Fformat = __XRenderFindFormat(tls, xri, (*TxPictVisual)(unsafe.Pointer(xVisual)).Fformat)
				visual += 8
				xVisual += 8
				goto _7
			_7:
	...
	ns = 0
	for {
		if !(libc.Uint32FromInt32(ns) < (*(*TxRenderQueryPictFormatsReply)(unsafe.Pointer(bp + 28))).FnumSubpixel) {
			break
		}
...
func XXRenderQuerySubpixelOrder(tls *libc.TLS, dpy uintptr, screen int32) (r int32) {
	...
	xri = (*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Finfo
	return (*(*TXRenderScreen)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fscreen + uintptr(screen)*16))).Fsubpixel
}
...
func XXRenderSetSubpixelOrder(tls *libc.TLS, dpy uintptr, screen int32, subpixel int32) (r int32) {
	...
	xri = (*TXRenderExtDisplayInfo)(unsafe.Pointer(info)).Finfo
	(*(*TXRenderScreen)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fscreen + uintptr(screen)*16))).Fsubpixel = subpixel
	return int32(m_True)
}
...
func XXRenderFindFormat(tls *libc.TLS, dpy uintptr, mask uint32, template uintptr, count int32) (r uintptr) {
	var info, xri uintptr
	var nf, v2 int32
	...
	for {
		...
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(0)) != 0 {
			if (*TXRenderPictFormat)(unsafe.Pointer(template)).Fid != (*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fid {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(1)) != 0 {
			if (*TXRenderPictFormat)(unsafe.Pointer(template)).Ftype1 != (*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Ftype1 {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(2)) != 0 {
			if (*TXRenderPictFormat)(unsafe.Pointer(template)).Fdepth != (*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdepth {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(3)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.Fred) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.Fred) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(4)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.FredMask) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.FredMask) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(5)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.Fgreen) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.Fgreen) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(6)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.FgreenMask) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.FgreenMask) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(7)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.Fblue) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.Fblue) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(8)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.FblueMask) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.FblueMask) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(9)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.Falpha) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.Falpha) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(10)) != 0 {
			if int32((*TXRenderPictFormat)(unsafe.Pointer(template)).Fdirect.FalphaMask) != int32((*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fdirect.FalphaMask) {
				goto _1
			}
		}
		if mask&libc.Uint32FromInt32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(11)) != 0 {
			if (*TXRenderPictFormat)(unsafe.Pointer(template)).Fcolormap != (*(*TXRenderPictFormat)(unsafe.Pointer((*TXRenderInfo)(unsafe.Pointer(xri)).Fformat + uintptr(nf)*32))).Fcolormap {
				goto _1
			}
		}
		v2 = count
...
func XXRenderFindStandardFormat(tls *libc.TLS, dpy uintptr, format int32) (r uintptr) {
	if 0 <= format && format < int32(m_PictStandardNUM) {
		return XXRenderFindFormat(tls, dpy, _standardFormats[format].Fmask, uintptr(unsafe.Pointer(&_standardFormats))+uintptr(format)*36, 0)
	}
	return libc.UintptrFromInt32(0)
}
...
func XXRenderQueryPictIndexValues(tls *libc.TLS, dpy uintptr, format uintptr, num uintptr) (r uintptr) {
	...
	req = libx11.X_XGetRequest(tls, dpy, uint8(m_X_RenderQueryPictIndexValues), uint32(m_sz_xRenderQueryPictIndexValuesReq))
	...
	(*TxRenderQueryPictIndexValuesReq)(unsafe.Pointer(req)).Fformat = (*TXRenderPictFormat)(unsafe.Pointer(format)).Fid
	if !(libx11.X_XReply(tls, dpy, bp, 0, m_xFalse) != 0) {
		if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
			(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
		}
	...
	if (*(*TxRenderQueryPictIndexValuesReply)(unsafe.Pointer(bp))).Flength < libc.Uint32FromInt32(libc.Int32FromInt32(m_INT_MAX)>>libc.Int32FromInt32(2)) && (*(*TxRenderQueryPictIndexValuesReply)(unsafe.Pointer(bp))).FnumIndexValues < uint32(libc.Uint32FromInt32(m_INT_MAX)/libc.Uint32FromInt64(12)) {
		/* request data length */
		...
		rlength = (*(*TxRenderQueryPictIndexValuesReply)(unsafe.Pointer(bp))).FnumIndexValues * uint32(12)
	...
	if !(values != 0) {
		libx11.X_XEatDataWords(tls, dpy, (*(*TxRenderQueryPictIndexValuesReply)(unsafe.Pointer(bp))).Flength)
		if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
			(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
		}
		if (*TDisplay)(unsafe.Pointer(dpy)).Fsynchandler != 0 {
	...
	*(*int32)(unsafe.Pointer(num)) = libc.Int32FromUint32((*(*TxRenderQueryPictIndexValuesReply)(unsafe.Pointer(bp))).FnumIndexValues)
	...
	for {
		...
		libx11.X_XRead(tls, dpy, bp+32, int32(m_sz_xIndexValue))
		(*(*TXIndexValue)(unsafe.Pointer(values + uintptr(i)*12))).Fpixel = (*(*TxIndexValue)(unsafe.Pointer(bp + 32))).Fpixel
		(*(*TXIndexValue)(unsafe.Pointer(values + uintptr(i)*12))).Fred = (*(*TxIndexValue)(unsafe.Pointer(bp + 32))).Fred
		(*(*TXIndexValue)(unsafe.Pointer(values + uintptr(i)*12))).Fgreen = (*(*TxIndexValue)(unsafe.Pointer(bp + 32))).Fgreen
		(*(*TXIndexValue)(unsafe.Pointer(values + uintptr(i)*12))).Fblue = (*(*TxIndexValue)(unsafe.Pointer(bp + 32))).Fblue
		(*(*TXIndexValue)(unsafe.Pointer(values + uintptr(i)*12))).Falpha = (*(*TxIndexValue)(unsafe.Pointer(bp + 32))).Falpha
		goto _4
	_4:
		;
		i++
	...
	/* skip any padding */
	if nbytes > nread {
		libx11.X_XEatData(tls, dpy, nbytes-nread)
	}
	if (*TDisplay)(unsafe.Pointer(dpy)).Flock_fns != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*T_XLockPtrs)(unsafe.Pointer((*TDisplay)(unsafe.Pointer(dpy)).Flock_fns)).Funlock_display})))(tls, dpy)
	}
...
var XXRenderExtensionName = [7]uint8{'R', 'E', 'N', 'D', 'E', 'R'}
