// Code generated for linux/arm by 'generator --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libXau/include/linux/arm -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libXdmcp/include/linux/arm -lXau -lXdmcp -o libxcb.go --package-name libxcb src/.libs/libxcb.a', DO NOT EDIT.
...
func _write_vec(tls *libc.TLS, c uintptr, vector uintptr, count uintptr) (r int32) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fout_fd.Fnfd != 0 {
		*(*Tmsghdr)(unsafe.Pointer(bp + 76)) = Tmsghdr{
		...
		libc.Xmemcpy(tls, hdr+libc.UintptrFromInt32(1)*12, c+4336+16572, libc.Uint32FromInt32((*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fout_fd.Fnfd)*uint32(4))
		...
		for {
			...
			libc.Xclose(tls, *(*int32)(unsafe.Pointer(c + 4336 + 16572 + uintptr(i)*4)))
			goto _2
		_2:
			;
			i++
...
func Xxcb_connect_to_fd(tls *libc.TLS, fd int32, auth_info uintptr) (r uintptr) {
	var c uintptr
	_ = c
	c = libc.Xcalloc(tls, uint32(1), uint32(21064))
	if !(c != 0) {
		libc.Xclose(tls, fd)
...
func Xxcb_prefetch_maximum_request_length(tls *libc.TLS, c uintptr) {
	...
	libc.Xpthread_mutex_lock(tls, c+4336+16536)
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag == int32(_LAZY_NONE) {
		...
		if ext != 0 && (*Txcb_query_extension_reply_t)(unsafe.Pointer(ext)).Fpresent != 0 {
			...
			*(*Txcb_big_requests_enable_cookie_t)(unsafe.Pointer(c + 4336 + 16568)) = Xxcb_big_requests_enable(tls, c)
		} else {
			(*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag = int32(_LAZY_FORCED)
			*(*Tuint32_t)(unsafe.Pointer(c + 4336 + 16568)) = uint32((*Txcb_setup_t)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fsetup)).Fmaximum_request_length)
		}
	}
	libc.Xpthread_mutex_unlock(tls, c+4336+16536)
}
...
func Xxcb_get_maximum_request_length(tls *libc.TLS, c uintptr) (r1 Tuint32_t) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag == int32(_LAZY_COOKIE) {
		r = Xxcb_big_requests_enable_reply(tls, c, *(*Txcb_big_requests_enable_cookie_t)(unsafe.Pointer(c + 4336 + 16568)), uintptr(0))
		(*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag = int32(_LAZY_FORCED)
		if r != 0 {
			*(*Tuint32_t)(unsafe.Pointer(c + 4336 + 16568)) = (*Txcb_big_requests_enable_reply_t)(unsafe.Pointer(r)).Fmaximum_request_length
			libc.Xfree(tls, r)
		} else {
			*(*Tuint32_t)(unsafe.Pointer(c + 4336 + 16568)) = uint32((*Txcb_setup_t)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fsetup)).Fmaximum_request_length)
		}
	...
	libc.Xpthread_mutex_unlock(tls, c+4336+16536)
	return *(*Tuint32_t)(unsafe.Pointer(c + 4336 + 16568))
}
...
func _send_fds(tls *libc.TLS, c uintptr, fds uintptr, num_fds uint32) {
	...
	for num_fds > uint32(0) {
		...
		*(*int32)(unsafe.Pointer(c + 4336 + 16572 + uintptr(v1)*4)) = *(*int32)(unsafe.Pointer(fds))
		fds += 4
		num_fds--
	}
...
func _insert_pending_discard(tls *libc.TLS, c uintptr, prev_next uintptr, seq Tuint64_t) {
	var pend uintptr
	_ = pend
	pend = libc.Xmalloc(tls, uint32(32))
	if !(pend != 0) {
		X_xcb_conn_shutdown(tls, c, int32(m_XCB_CONN_CLOSED_MEM_INSUFFICIENT))
		return
	}
...
func Xxcb_get_extension_data(tls *libc.TLS, c uintptr, ext uintptr) (r uintptr) {
	...
	libc.Xpthread_mutex_lock(tls, c+20984)
	...
	libc.Xpthread_mutex_unlock(tls, c+20984)
	if data != 0 {
...
func X_xcb_ext_init(tls *libc.TLS, c uintptr) (r int32) {
	if libc.Xpthread_mutex_init(tls, c+20984, uintptr(0)) != 0 {
		return 0
	}
	return int32(1)
}
...
func X_xcb_ext_destroy(tls *libc.TLS, c uintptr) {
	...
	var v2 uintptr
	_, _ = v1, v2
	libc.Xpthread_mutex_destroy(tls, c+20984)
	for {
		v2 = c + 20984 + 32
		v1 = *(*int32)(unsafe.Pointer(v2))
		*(*int32)(unsafe.Pointer(v2))--
...
func Xxcb_generate_id(tls *libc.TLS, c uintptr) (r Tuint32_t) {
	...
	libc.Xpthread_mutex_lock(tls, c+21020)
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Flast >= (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Fmax-(*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Finc+uint32(1) {
		if (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Flast == uint32(0) {
			...
			if !(xc_misc_reply != 0) || !((*Txcb_query_extension_reply_t)(unsafe.Pointer(xc_misc_reply)).Fpresent != 0) {
				libc.Xpthread_mutex_unlock(tls, c+21020)
				return libc.Uint32FromInt32(-libc.Int32FromInt32(1))
			}
			/* get new range */
...
func X_xcb_xid_init(tls *libc.TLS, c uintptr) (r int32) {
	if libc.Xpthread_mutex_init(tls, c+21020, uintptr(0)) != 0 {
		return 0
	}
...
func X_xcb_xid_destroy(tls *libc.TLS, c uintptr) {
	libc.Xpthread_mutex_destroy(tls, c+21020)
}
...
func X_xcb_map_put(tls *libc.TLS, list uintptr, key Tuint64_t, data uintptr) (r int32) {
	var cur uintptr
	_ = cur
	cur = libc.Xmalloc(tls, uint32(24))
	if !(cur != 0) {
		return 0
	}
...
func __xcb_parse_display(tls *libc.TLS, name uintptr, host uintptr, protocol uintptr, displayp uintptr, screenp uintptr) (r int32) {
	...
	if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp))))) == int32('\000') {
		...
		*(*uintptr)(unsafe.Pointer(bp))++
		...
		if *(*uintptr)(unsafe.Pointer(bp + 4)) == *(*uintptr)(unsafe.Pointer(bp)) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 4))))) != int32('\000') {
			goto error_out
		}
	}
...
func __xcb_open_tcp(tls *libc.TLS, host uintptr, protocol uintptr, port uint16) (r int32) {
	...
	var _ /* service at bp+36 */ [6]uint8
