// Code generated for linux/riscv64 by 'generator --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libXau/include/linux/riscv64 -I /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libXdmcp/include/linux/riscv64 -lXau -lXdmcp -o libxcb.go --package-name libxcb src/.libs/libxcb.a', DO NOT EDIT.
...
func _write_vec(tls *libc.TLS, c uintptr, vector uintptr, count uintptr) (r int32) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fout_fd.Fnfd != 0 {
		*(*Tmsghdr)(unsafe.Pointer(bp + 80)) = Tmsghdr{
		...
		libc.Xmemcpy(tls, hdr+libc.UintptrFromInt32(1)*16, c+4400+16592, libc.Uint64FromInt32((*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fout_fd.Fnfd)*uint64(4))
		...
		for {
			...
			libc.Xclose(tls, *(*int32)(unsafe.Pointer(c + 4400 + 16592 + uintptr(i)*4)))
			goto _2
		_2:
			;
			i++
...
func Xxcb_connect_to_fd(tls *libc.TLS, fd int32, auth_info uintptr) (r uintptr) {
	var c uintptr
	_ = c
	c = libc.Xcalloc(tls, uint64(1), uint64(21176))
	if !(c != 0) {
		libc.Xclose(tls, fd)
...
func Xxcb_prefetch_maximum_request_length(tls *libc.TLS, c uintptr) {
	...
	libc.Xpthread_mutex_lock(tls, c+4400+16544)
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag == int32(_LAZY_NONE) {
		...
		if ext != 0 && (*Txcb_query_extension_reply_t)(unsafe.Pointer(ext)).Fpresent != 0 {
			...
			*(*Txcb_big_requests_enable_cookie_t)(unsafe.Pointer(c + 4400 + 16588)) = Xxcb_big_requests_enable(tls, c)
		} else {
			(*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag = int32(_LAZY_FORCED)
			*(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16588)) = uint32((*Txcb_setup_t)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fsetup)).Fmaximum_request_length)
		}
	}
	libc.Xpthread_mutex_unlock(tls, c+4400+16544)
}
...
func Xxcb_get_maximum_request_length(tls *libc.TLS, c uintptr) (r1 Tuint32_t) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag == int32(_LAZY_COOKIE) {
		r = Xxcb_big_requests_enable_reply(tls, c, *(*Txcb_big_requests_enable_cookie_t)(unsafe.Pointer(c + 4400 + 16588)), uintptr(0))
		(*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag = int32(_LAZY_FORCED)
		if r != 0 {
			*(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16588)) = (*Txcb_big_requests_enable_reply_t)(unsafe.Pointer(r)).Fmaximum_request_length
			libc.Xfree(tls, r)
		} else {
			*(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16588)) = uint32((*Txcb_setup_t)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fsetup)).Fmaximum_request_length)
		}
	...
	libc.Xpthread_mutex_unlock(tls, c+4400+16544)
	return *(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16588))
}
...
func _send_fds(tls *libc.TLS, c uintptr, fds uintptr, num_fds uint32) {
	...
	for num_fds > uint32(0) {
		...
		*(*int32)(unsafe.Pointer(c + 4400 + 16592 + uintptr(v1)*4)) = *(*int32)(unsafe.Pointer(fds))
		fds += 4
		num_fds--
	}
...
func X_xcb_out_init(tls *libc.TLS, out uintptr) (r int32) {
	...
	if libc.Xpthread_mutex_init(tls, out+16544, uintptr(0)) != 0 {
		return 0
	}
...
func X_xcb_out_destroy(tls *libc.TLS, out uintptr) {
	libc.Xpthread_mutex_destroy(tls, out+16544)
	libc.Xpthread_cond_destroy(tls, out)
	libc.Xpthread_cond_destroy(tls, out+56)
}
...
func Xxcb_get_extension_data(tls *libc.TLS, c uintptr, ext uintptr) (r uintptr) {
	...
	libc.Xpthread_mutex_lock(tls, c+21064)
	...
	libc.Xpthread_mutex_unlock(tls, c+21064)
	if data != 0 {
...
func X_xcb_ext_init(tls *libc.TLS, c uintptr) (r int32) {
	if libc.Xpthread_mutex_init(tls, c+21064, uintptr(0)) != 0 {
		return 0
	}
	return int32(1)
}
...
func X_xcb_ext_destroy(tls *libc.TLS, c uintptr) {
	...
	var v2 uintptr
	_, _ = v1, v2
	libc.Xpthread_mutex_destroy(tls, c+21064)
	for {
		v2 = c + 21064 + 48
		v1 = *(*int32)(unsafe.Pointer(v2))
		*(*int32)(unsafe.Pointer(v2))--
...
func Xxcb_generate_id(tls *libc.TLS, c uintptr) (r Tuint32_t) {
	...
	libc.Xpthread_mutex_lock(tls, c+21120)
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Flast >= (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Fmax-(*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Finc+uint32(1) {
		if (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Flast == uint32(0) {
			...
			if !(xc_misc_reply != 0) || !((*Txcb_query_extension_reply_t)(unsafe.Pointer(xc_misc_reply)).Fpresent != 0) {
				libc.Xpthread_mutex_unlock(tls, c+21120)
				return libc.Uint32FromInt32(-libc.Int32FromInt32(1))
			}
			/* get new range */
...
func X_xcb_xid_init(tls *libc.TLS, c uintptr) (r int32) {
	if libc.Xpthread_mutex_init(tls, c+21120, uintptr(0)) != 0 {
		return 0
	}
...
func X_xcb_xid_destroy(tls *libc.TLS, c uintptr) {
	libc.Xpthread_mutex_destroy(tls, c+21120)
}
...
func __xcb_parse_display_path_to_socket(tls *libc.TLS, name uintptr, host uintptr, protocol uintptr, displayp uintptr, screenp uintptr) (r int32) {
	...
	var len1 Tsize_t
	var lscreen uint64
	var _ /* endptr at bp+4224 */ uintptr
	var _ /* path at bp+128 */ [4096]uint8
	...
	libc.Xmemcpy(tls, bp+128, name, len1+uint64(1))
	res = libc.Xstat(tls, bp+128, bp)
	if 0 != res {
		if res != -int32(1) || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(m_ENOENT) && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(m_ENOTDIR) {
			return 0
		}
		dot = libc.Xstrrchr(tls, bp+128, int32('.'))
		if !(dot != 0) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(dot + 1))) < int32('1') || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(dot + 1))) > int32('9') {
			return 0
		}
		*(*uint8)(unsafe.Pointer(dot)) = uint8('\000')
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		lscreen = libc.Xstrtoul(tls, dot+uintptr(1), bp+4224, int32(10))
		if lscreen > uint64(m_INT_MAX1) || !(*(*uintptr)(unsafe.Pointer(bp + 4224)) != 0) || *(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 4224)))) != 0 || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
			return 0
		}
		if 0 != libc.Xstat(tls, bp+128, bp) {
			return 0
		}
		_screen = libc.Int32FromUint64(lscreen)
	}
	if host != 0 {
		*(*uintptr)(unsafe.Pointer(host)) = libc.Xstrdup(tls, bp+128)
...
func __xcb_open(tls *libc.TLS, host uintptr, protocol uintptr, display int32) (r int32) {
	...
	if protocol != 0 && libc.Xstrcmp(tls, __ccgo_ts+4, protocol) == 0 && host != 0 && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(host))) == int32('/') {
		/* Full path to socket provided, ignore everything else */
		filelen = libc.Xstrlen(tls, host) + uint64(1)
		if filelen > uint64(m_INT_MAX1) {
			return -int32(1)
		}
		...
		if (!(protocol != 0) || libc.Xstrcmp(tls, __ccgo_ts+4, protocol) != 0) && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(host))) != int32('\000') && libc.Xstrcmp(tls, __ccgo_ts+4, host) != 0 {
