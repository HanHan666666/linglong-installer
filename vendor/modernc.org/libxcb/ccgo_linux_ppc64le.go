// Code generated for linux/ppc64le by 'generator --prefix-enumerator=_ --prefix-external=x_ --prefix-field=F --prefix-macro=m_ --prefix-static-internal=_ --prefix-static-none=_ --prefix-tagged-enum=_ --prefix-tagged-struct=T --prefix-tagged-union=T --prefix-typename=T --prefix-undefined=_ -extended-errors -ignore-unsupported-alignment -I /home/debian/src/modernc.org/builder/.exclude/modernc.org/libXau/include/linux/ppc64le -I /home/debian/src/modernc.org/builder/.exclude/modernc.org/libXdmcp/include/linux/ppc64le -lXau -lXdmcp -o libxcb.go --package-name libxcb src/.libs/libxcb.a', DO NOT EDIT.
...
const m_PACKAGE_STRING = "libxcb 1.14"
const m_PACKAGE_TARNAME = "libxcb"
const m_PACKAGE_URL = ""
const m_PACKAGE_VERSION = "1.14"
const m_PACKAGE_VERSION_MAJOR = 1
const m_PACKAGE_VERSION_MINOR = 14
...
const m_SO_PASSCRED = 20
const m_SO_PASSSEC = 34
const m_SO_PEEK_OFF = 42
const m_SO_PEERCRED = 21
...
const m_SO_RCVLOWAT = 16
const m_SO_RCVTIMEO = 18
...
const m_SO_SNDLOWAT = 17
const m_SO_SNDTIMEO = 19
...
func _write_vec(tls *libc.TLS, c uintptr, vector uintptr, count uintptr) (r int32) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fout_fd.Fnfd != 0 {
		*(*Tmsghdr)(unsafe.Pointer(bp + 80)) = Tmsghdr{
			...
			Fmsg_iovlen:     n,
			Fmsg_control:    bp,
			Fmsg_controllen: uint32((libc.Uint64FromInt64(16)+libc.Uint64FromInt64(8)-libc.Uint64FromInt32(1)) & ^(libc.Uint64FromInt64(8)-libc.Uint64FromInt32(1)) + libc.Uint64FromInt32((*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fout_fd.Fnfd)*libc.Uint64FromInt64(4)),
		}
		if uint64((*Tmsghdr)(unsafe.Pointer(bp+80)).Fmsg_controllen) >= uint64(16) {
		...
		libc.Xmemcpy(tls, hdr+libc.UintptrFromInt32(1)*16, c+4400+16584, libc.Uint64FromInt32((*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fout_fd.Fnfd)*uint64(4))
		...
		for {
			...
			libc.Xclose(tls, *(*int32)(unsafe.Pointer(c + 4400 + 16584 + uintptr(i)*4)))
			goto _2
		_2:
			;
			i++
...
func Xxcb_connect_to_fd(tls *libc.TLS, fd int32, auth_info uintptr) (r uintptr) {
	var c uintptr
	_ = c
	c = libc.Xcalloc(tls, uint64(1), uint64(21168))
	if !(c != 0) {
		libc.Xclose(tls, fd)
		return X_xcb_conn_ret_error(tls, int32(m_XCB_CONN_CLOSED_MEM_INSUFFICIENT))
	}
	(*Txcb_connection_t)(unsafe.Pointer(c)).Ffd = fd
	if !(_set_fd_flags(tls, fd) != 0 && libc.Xpthread_mutex_init(tls, c+24, uintptr(0)) == 0 && X_xcb_in_init(tls, c+64) != 0 && X_xcb_out_init(tls, c+4400) != 0 && _write_setup(tls, c, auth_info) != 0 && _read_setup(tls, c) != 0 && X_xcb_ext_init(tls, c) != 0 && X_xcb_xid_init(tls, c) != 0) {
...
func Xxcb_disconnect(tls *libc.TLS, c uintptr) {
	...
	X_xcb_in_destroy(tls, c+64)
	X_xcb_out_destroy(tls, c+4400)
...
func X_xcb_conn_wait(tls *libc.TLS, c uintptr, cond uintptr, vector uintptr, count uintptr) (r int32) {
	...
	for cond1 := true; cond1; cond1 = ret == -int32(1) && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(m_EINTR) {
		ret = libc.Xpoll(tls, bp, uint64(1), -int32(1))
...
func _send_request(tls *libc.TLS, c uintptr, isvoid int32, workaround _workarounds, flags int32, vector uintptr, count int32) {
	...
	for count != 0 && libc.Uint64FromInt32((*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fqueue_len)+(*(*Tiovec)(unsafe.Pointer(vector))).Fiov_len <= uint64(16384) {
		libc.Xmemcpy(tls, c+4400+124+uintptr((*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fqueue_len), (*(*Tiovec)(unsafe.Pointer(vector))).Fiov_base, (*(*Tiovec)(unsafe.Pointer(vector))).Fiov_len)
		p1 = c + 4400 + 16508
	...
	vector -= 16
	count++
	(*(*Tiovec)(unsafe.Pointer(vector))).Fiov_base = c + 4400 + 124
...
func _get_socket_back(tls *libc.TLS, c uintptr) {
	for (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Freturn_socket != 0 && (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fsocket_moving != 0 {
		libc.Xpthread_cond_wait(tls, c+4400+56, c+24)
	}
	...
	libc.Xpthread_cond_broadcast(tls, c+4400+56)
...
func _prepare_socket_request(tls *libc.TLS, c uintptr) {
	...
	for {
		...
		libc.Xpthread_cond_wait(tls, c+4400, c+24)
		goto _1
	_1:
	}
}
...
func Xxcb_prefetch_maximum_request_length(tls *libc.TLS, c uintptr) {
	...
	libc.Xpthread_mutex_lock(tls, c+4400+16536)
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag == int32(_LAZY_NONE) {
		...
		if ext != 0 && (*Txcb_query_extension_reply_t)(unsafe.Pointer(ext)).Fpresent != 0 {
			...
			*(*Txcb_big_requests_enable_cookie_t)(unsafe.Pointer(c + 4400 + 16580)) = Xxcb_big_requests_enable(tls, c)
		} else {
			(*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag = int32(_LAZY_FORCED)
			*(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16580)) = uint32((*Txcb_setup_t)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fsetup)).Fmaximum_request_length)
		}
	}
	libc.Xpthread_mutex_unlock(tls, c+4400+16536)
}
...
func Xxcb_get_maximum_request_length(tls *libc.TLS, c uintptr) (r1 Tuint32_t) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag == int32(_LAZY_COOKIE) {
		r = Xxcb_big_requests_enable_reply(tls, c, *(*Txcb_big_requests_enable_cookie_t)(unsafe.Pointer(c + 4400 + 16580)), uintptr(0))
		(*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fmaximum_request_length_tag = int32(_LAZY_FORCED)
		if r != 0 {
			*(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16580)) = (*Txcb_big_requests_enable_reply_t)(unsafe.Pointer(r)).Fmaximum_request_length
			libc.Xfree(tls, r)
		} else {
			*(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16580)) = uint32((*Txcb_setup_t)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fsetup)).Fmaximum_request_length)
		}
	...
	libc.Xpthread_mutex_unlock(tls, c+4400+16536)
	return *(*Tuint32_t)(unsafe.Pointer(c + 4400 + 16580))
}
...
func _send_fds(tls *libc.TLS, c uintptr, fds uintptr, num_fds uint32) {
	...
	for num_fds > uint32(0) {
		...
		*(*int32)(unsafe.Pointer(c + 4400 + 16584 + uintptr(v1)*4)) = *(*int32)(unsafe.Pointer(fds))
		fds += 4
		num_fds--
	}
...
func X_xcb_out_init(tls *libc.TLS, out uintptr) (r int32) {
	if libc.Xpthread_cond_init(tls, out+56, uintptr(0)) != 0 {
		return 0
	}
	...
	if libc.Xpthread_mutex_init(tls, out+16536, uintptr(0)) != 0 {
		return 0
	}
...
func X_xcb_out_destroy(tls *libc.TLS, out uintptr) {
	...
	libc.Xpthread_mutex_destroy(tls, out+16536)
}
...
func X_xcb_out_flush_to(tls *libc.TLS, c uintptr, request Tuint64_t) (r int32) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Fqueue_len != 0 {
		(*(*Tiovec)(unsafe.Pointer(bp))).Fiov_base = c + 4400 + 124
...
func _read_fds(tls *libc.TLS, c uintptr, fds uintptr, nfd int32) (r int32) {
	...
	var infd int32
	_, _ = ifds, infd
	ifds = c + 64 + 4256 + uintptr((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fin_fd.Fifd)*4
...
func _read_packet(tls *libc.TLS, c uintptr) (r int32) {
	...
	var bufsize, eventlength, lastread, length Tuint64_t
	var nfd int32
	var v1 uint64
	var _ /* genrep at bp+0 */ Txcb_generic_reply_t
	_, _, _, _, _, _, _, _, _, _, _, _ = buf, bufsize, cur, event, eventlength, lastread, length, nfd, oldpend, p, pend, v1
	length = uint64(32)
	...
	libc.Xmemcpy(tls, bp, c+64+52, uint64(8))
	...
	if libc.Int32FromUint8((*(*Txcb_generic_reply_t)(unsafe.Pointer(bp))).Fresponse_type)&int32(0x7f) != int32(m_XCB_KEYMAP_NOTIFY) {
		...
		if (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Frequest_read != lastread {
			if (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fcurrent_reply != 0 {
				X_xcb_map_put(tls, (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Freplies, uint32(lastread), (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fcurrent_reply)
				(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fcurrent_reply = uintptr(0)
				(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fcurrent_reply_tail = c + 64 + 4184
			}
		...
		for (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fpending_replies != 0 && (*Tpending_reply1)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fpending_replies)).Fworkaround != int32(_WORKAROUND_EXTERNAL_SOCKET_OWNER) && libc.Int64FromUint64((*Tpending_reply1)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fpending_replies)).Flast_request-(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Frequest_completed) <= 0 {
			...
			if !((*Tpending_reply)(unsafe.Pointer(oldpend)).Fnext != 0) {
				(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fpending_replies_tail = c + 64 + 4240
			}
		...
		_remove_finished_readers(tls, c+64+4224, (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Frequest_completed)
	}
	...
	if libc.Int32FromUint8((*(*Txcb_generic_reply_t)(unsafe.Pointer(bp))).Fresponse_type) == int32(m_XCB_REPLY) {
		if pend != 0 && (*Tpending_reply)(unsafe.Pointer(pend)).Fworkaround == int32(_WORKAROUND_GLX_GET_FB_CONFIGS_BUG) {
			p = c + 64 + 52
			(*(*Txcb_generic_reply_t)(unsafe.Pointer(bp))).Flength = *(*Tuint32_t)(unsafe.Pointer(p + 2*4)) * *(*Tuint32_t)(unsafe.Pointer(p + 3*4)) * uint32(2)
		}
		length += uint64((*(*Txcb_generic_reply_t)(unsafe.Pointer(bp))).Flength * uint32(4))
	...
	if libc.Int32FromUint8((*(*Txcb_generic_reply_t)(unsafe.Pointer(bp))).Fresponse_type)&int32(0x7f) == int32(m_XCB_XGE_EVENT) {
		eventlength = uint64((*(*Txcb_generic_reply_t)(unsafe.Pointer(bp))).Flength * uint32(4))
	}
	if libc.Int32FromUint8((*(*Txcb_generic_reply_t)(unsafe.Pointer(bp))).Fresponse_type) == int32(m_XCB_REPLY) {
		v1 = uint64(0)
	} else {
	...
	if !(_event_special(tls, c, event) != 0) {
		*(*uintptr)(unsafe.Pointer((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fevents_tail)) = event
		...
		libc.Xpthread_cond_signal(tls, c+64)
	}
...
func _get_event(tls *libc.TLS, c uintptr) (r uintptr) {
	...
	if !((*Tevent_list)(unsafe.Pointer(cur)).Fnext != 0) {
		(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fevents_tail = c + 64 + 4208
	}
	libc.Xfree(tls, cur)
	return ret
}
...
func _read_block(tls *libc.TLS, fd int32, buf uintptr, len1 Tssize_t) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	var done, ret int32
...
func _poll_for_reply(tls *libc.TLS, c uintptr, request Tuint64_t, reply uintptr, error1 uintptr) (r int32) {
	...
	if !(request != 0) {
		...
		if libc.Int64FromUint64(request-(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Frequest_read) < 0 {
			head = X_xcb_map_remove(tls, (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Freplies, uint32(request))
			if head != 0 && (*Treply_list)(unsafe.Pointer(head)).Fnext != 0 {
				X_xcb_map_put(tls, (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Freplies, uint32(request), (*Treply_list)(unsafe.Pointer(head)).Fnext)
			}
		} else {
...
func _wait_for_reply(tls *libc.TLS, c uintptr, request Tuint64_t, e uintptr) (r uintptr) {
	...
	var _ /* reader at bp+56 */ Treader_list
	...
	*(*uintptr)(unsafe.Pointer(bp)) = uintptr(0)
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Freturn_socket != 0 || X_xcb_out_flush_to(tls, c, request) != 0 {
		*(*Tpthread_cond_t)(unsafe.Pointer(bp + 8)) = Tpthread_cond_t{}
		*(*int32)(unsafe.Pointer(bp + 8)) = 0
		_insert_reader(tls, c+64+4224, bp+56, request, bp+8)
		for !(_poll_for_reply(tls, c, request, bp, e) != 0) {
			if !(X_xcb_conn_wait(tls, c, bp+8, uintptr(0), uintptr(0)) != 0) {
				break
			}
		}
		_remove_reader(tls, c+64+4224, bp+56)
...
func Xxcb_wait_for_event(tls *libc.TLS, c uintptr) (r uintptr) {
	...
	for {
		...
		if !(X_xcb_conn_wait(tls, c, c+64, uintptr(0), uintptr(0)) != 0) {
			break
		}
	}
	X_xcb_in_wake_up_next_reader(tls, c)
...
func Xxcb_request_check(tls *libc.TLS, c uintptr, cookie Txcb_void_cookie_t) (r uintptr) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = uintptr(0)
	...
	if libc.Int64FromUint64(request-(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Frequest_expected) >= 0 && libc.Int64FromUint64(request-(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Frequest_completed) > 0 {
		X_xcb_out_send_sync(tls, c)
		X_xcb_out_flush_to(tls, c, (*Txcb_connection_t)(unsafe.Pointer(c)).Fout.Frequest)
	}
...
func Xxcb_wait_for_special_event(tls *libc.TLS, c uintptr, se uintptr) (r uintptr) {
	...
	libc.Xpthread_mutex_lock(tls, c+24)
	_insert_special(tls, c+64+4232, bp, se)
	...
	_remove_special(tls, c+64+4232, bp)
	X_xcb_in_wake_up_next_reader(tls, c)
	libc.Xpthread_mutex_unlock(tls, c+24)
	return event
}
...
func Xxcb_register_for_special_xge(tls *libc.TLS, c uintptr, ext uintptr, eid Tuint32_t, stamp uintptr) (r uintptr) {
	...
	se = libc.Xcalloc(tls, uint64(1), uint64(88))
	if !(se != 0) {
		libc.Xpthread_mutex_unlock(tls, c+24)
		return libc.UintptrFromInt32(0)
	}
...
func X_xcb_in_init(tls *libc.TLS, in uintptr) (r int32) {
	...
	(*T_xcb_in)(unsafe.Pointer(in)).Fevents_tail = in + 4208
	(*T_xcb_in)(unsafe.Pointer(in)).Fpending_replies_tail = in + 4240
	return int32(1)
}
...
func X_xcb_in_wake_up_next_reader(tls *libc.TLS, c uintptr) {
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Freaders != 0 {
		...
		if (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fspecial_waiters != 0 {
			...
			pthreadret = libc.Xpthread_cond_signal(tls, c+64)
		}
	}
}
...
func X_xcb_in_replies_done(tls *libc.TLS, c uintptr) {
	...
	_, _ = pend, prev_next
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fpending_replies_tail != c+64+4240 {
...
func X_xcb_in_read(tls *libc.TLS, c uintptr) (r int32) {
	...
	*(*Tiovec)(unsafe.Pointer(bp)) = Tiovec{
		Fiov_base: c + 64 + 52 + uintptr((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fqueue_len),
	...
	*(*Tmsghdr)(unsafe.Pointer(bp + 96)) = Tmsghdr{
	...
	if n > 0 {
		if uint64((*(*Tmsghdr)(unsafe.Pointer(bp + 96))).Fmsg_controllen) >= uint64(16) {
			if uint64((*Tmsghdr)(unsafe.Pointer(bp+96)).Fmsg_controllen) >= uint64(16) {
			...
			for {
				...
				if (*Tcmsghdr)(unsafe.Pointer(hdr)).Fcmsg_level == int32(m_SOL_SOCKET) && (*Tcmsghdr)(unsafe.Pointer(hdr)).Fcmsg_type == int32(m_SCM_RIGHTS) {
					nfd = libc.Int32FromUint64((uint64((*Tcmsghdr)(unsafe.Pointer(hdr)).Fcmsg_len) - ((libc.Uint64FromInt64(16)+libc.Uint64FromInt64(8)-libc.Uint64FromInt32(1)) & ^(libc.Uint64FromInt64(8)-libc.Uint64FromInt32(1)) + libc.Uint64FromInt32(libc.Int32FromInt32(0)))) / uint64(4))
					libc.Xmemcpy(tls, c+64+4256+uintptr((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fin_fd.Fnfd)*4, hdr+libc.UintptrFromInt32(1)*16, libc.Uint64FromInt32(nfd)*uint64(4))
					(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fin_fd.Fnfd += nfd
				}
				goto _1
			_1:
				;
				if uint64((*Tcmsghdr)(unsafe.Pointer(hdr)).Fcmsg_len) < uint64(16) || (uint64((*Tcmsghdr)(unsafe.Pointer(hdr)).Fcmsg_len)+uint64(8)-uint64(1))&libc.Uint64FromInt64(^libc.Int64FromUint64(libc.Uint64FromInt64(8)-libc.Uint64FromInt32(1)))+uint64(16) >= libc.Uint64FromInt64(int64((*Tmsghdr)(unsafe.Pointer(bp+96)).Fmsg_control+uintptr((*Tmsghdr)(unsafe.Pointer(bp+96)).Fmsg_controllen))-int64(hdr)) {
					v3 = uintptr(0)
				} else {
					v3 = hdr + uintptr((uint64((*Tcmsghdr)(unsafe.Pointer(hdr)).Fcmsg_len)+libc.Uint64FromInt64(8)-libc.Uint64FromInt32(1))&libc.Uint64FromInt64(^libc.Int64FromUint64(libc.Uint64FromInt64(8)-libc.Uint64FromInt32(1))))
				}
				hdr = v3
			}
		}
	...
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fin_fd.Fnfd != 0 {
		...
		libc.Xmemmove(tls, c+64+4256, c+64+4256+uintptr((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fin_fd.Fifd)*4, libc.Uint64FromInt32((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fin_fd.Fnfd)*uint64(4))
		...
		if (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fqueue_len == 0 && (*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fin_fd.Fnfd != 0 {
			...
			for {
				...
				libc.Xclose(tls, *(*int32)(unsafe.Pointer(c + 64 + 4256 + uintptr(i)*4)))
				goto _4
			_4:
				;
				i++
...
func X_xcb_in_read_block(tls *libc.TLS, c uintptr, buf uintptr, len1 int32) (r int32) {
	...
	libc.Xmemcpy(tls, buf, c+64+52, libc.Uint64FromInt32(done))
	(*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fqueue_len -= done
	libc.Xmemmove(tls, c+64+52, c+64+52+uintptr(done), libc.Uint64FromInt32((*Txcb_connection_t)(unsafe.Pointer(c)).Fin.Fqueue_len))
	if len1 > done {
...
func Xxcb_get_extension_data(tls *libc.TLS, c uintptr, ext uintptr) (r uintptr) {
	...
	libc.Xpthread_mutex_lock(tls, c+21056)
	...
	libc.Xpthread_mutex_unlock(tls, c+21056)
	if data != 0 {
...
func X_xcb_ext_init(tls *libc.TLS, c uintptr) (r int32) {
	if libc.Xpthread_mutex_init(tls, c+21056, uintptr(0)) != 0 {
		return 0
	}
	return int32(1)
}
...
func X_xcb_ext_destroy(tls *libc.TLS, c uintptr) {
	...
	var v2 uintptr
	_, _ = v1, v2
	libc.Xpthread_mutex_destroy(tls, c+21056)
	for {
		v2 = c + 21056 + 48
		v1 = *(*int32)(unsafe.Pointer(v2))
		*(*int32)(unsafe.Pointer(v2))--
...
func Xxcb_generate_id(tls *libc.TLS, c uintptr) (r Tuint32_t) {
	...
	libc.Xpthread_mutex_lock(tls, c+21112)
	if (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Flast >= (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Fmax-(*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Finc+uint32(1) {
		if (*Txcb_connection_t)(unsafe.Pointer(c)).Fxid.Flast == uint32(0) {
			...
			if !(xc_misc_reply != 0) {
				libc.Xpthread_mutex_unlock(tls, c+21112)
				return libc.Uint32FromInt32(-libc.Int32FromInt32(1))
			}
			/* get new range */
...
func X_xcb_xid_init(tls *libc.TLS, c uintptr) (r int32) {
	if libc.Xpthread_mutex_init(tls, c+21112, uintptr(0)) != 0 {
		return 0
	}
...
func X_xcb_xid_destroy(tls *libc.TLS, c uintptr) {
	libc.Xpthread_mutex_destroy(tls, c+21112)
}
...
func X_xcb_map_put(tls *libc.TLS, list uintptr, key uint32, data uintptr) (r int32) {
	var cur uintptr
	_ = cur
...
func X_xcb_map_remove(tls *libc.TLS, list uintptr, key uint32) (r uintptr) {
...
func __xcb_parse_display(tls *libc.TLS, name uintptr, host uintptr, protocol uintptr, displayp uintptr, screenp uintptr) (r int32) {
	...
	if !(name != 0) || !(*(*uint8)(unsafe.Pointer(name)) != 0) {
	...
	if slash != 0 {
		...
		if protocol != 0 {
			...
			*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(protocol)) + uintptr(len1))) = uint8('\000')
		}
	...
	if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp))))) == int32('\000') {
		...
		if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp))))) != int32('.') {
			goto error_out
		}
		*(*uintptr)(unsafe.Pointer(bp))++
		screen = libc.Int32FromUint64(libc.Xstrtoul(tls, *(*uintptr)(unsafe.Pointer(bp)), bp+8, int32(10)))
		if *(*uintptr)(unsafe.Pointer(bp + 8)) == *(*uintptr)(unsafe.Pointer(bp)) || libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 8))))) != int32('\000') {
			goto error_out
		}
	}
	...
	*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(host)) + uintptr(len1))) = uint8('\000')
...
func __xcb_open(tls *libc.TLS, host uintptr, protocol uintptr, display int32) (r int32) {
	...
	if (!(protocol != 0) || libc.Xstrcmp(tls, __ccgo_ts+12, protocol) != 0) && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(host))) != int32('\000') && libc.Xstrcmp(tls, __ccgo_ts+12, host) != 0 {
	...
	libc.Xfree(tls, file)
	if fd < 0 && !(protocol != 0) && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(host))) == int32('\000') {
...
var _unix_base = [17]uint8{'/', 't', 'm', 'p', '/', '.', 'X', '1', '1', '-', 'u', 'n', 'i', 'x', '/', 'X'}
...
func __xcb_open_tcp(tls *libc.TLS, host uintptr, protocol uintptr, port uint16) (r int32) {
	...
	var _ /* service at bp+48 */ [6]uint8
	...
	if libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(host))) == int32('\000') {
		host = __ccgo_ts + 37
	}
	...
	if v2 = libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(host))) == int32('['); v2 {
		v1 = libc.Xstrrchr(tls, host, int32(']'))
		bracket = v1
	}
	if v2 && v1 != 0 && libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(bracket + 1))) == int32('\000') {
		*(*uint8)(unsafe.Pointer(bracket)) = uint8('\000')
		host++
		(*(*Taddrinfo)(unsafe.Pointer(bp))).Fai_flags |= int32(m_AI_NUMERICHOST)
		(*(*Taddrinfo)(unsafe.Pointer(bp))).Fai_family = int32(m_PF_INET6)
	}
	libc.X__builtin_snprintf(tls, bp+48, uint64(6), __ccgo_ts+47, libc.VaList(bp+72, libc.Int32FromUint16(port)))
...
func __xcb_open_abstract(tls *libc.TLS, protocol uintptr, file uintptr, filelen Tsize_t) (r int32) {
	...
	*(*Tsockaddr_un)(unsafe.Pointer(bp)) = Tsockaddr_un{}
	...
	(*(*Tsockaddr_un)(unsafe.Pointer(bp))).Fsun_family = uint16(m_PF_LOCAL)
	namelen = uint32(uint64(libc.UintptrFromInt32(0)+2) + libc.Uint64FromInt32(1) + filelen)
	fd = __xcb_socket(tls, int32(m_PF_LOCAL), int32(m_SOCK_STREAM), 0)
	if fd == -int32(1) {
		return -int32(1)
	}
...
func _get_authptr(tls *libc.TLS, sockname uintptr, display int32) (r uintptr) {
	...
	var family uint16
	var v1 uint64
	var _ /* dispbuf at bp+256 */ [40]uint8
	var _ /* hostnamebuf at bp+0 */ [256]uint8
	...
	dispbuflen = libc.X__builtin_snprintf(tls, bp+256, uint64(40), __ccgo_ts+90, libc.VaList(bp+304, display))
	if dispbuflen < 0 {
		return uintptr(0)
	}
	...
	if _authname_match(tls, int32(_AUTH_XA1), (*TXauth)(unsafe.Pointer(authptr)).Fname, uint64((*TXauth)(unsafe.Pointer(authptr)).Fname_length)) != 0 {
		...
		*(*int32)(unsafe.Pointer(bp)) = 0
		for {
			...
			*(*uint8)(unsafe.Pointer((*Txcb_auth_info_t)(unsafe.Pointer(info)).Fdata + uintptr(*(*int32)(unsafe.Pointer(bp))))) = *(*uint8)(unsafe.Pointer((*TXauth)(unsafe.Pointer(authptr)).Fdata + uintptr(*(*int32)(unsafe.Pointer(bp)))))
			goto _1
		_1:
			;
		...
		*(*Tuint32_t)(unsafe.Pointer(bp + 20)) = libc.Xhtonl(tls, libc.Uint32FromInt64(libc.Xtime(tls, uintptr(0))))
		...
		for *(*int32)(unsafe.Pointer(bp)) < libc.Int32FromInt32(192)/libc.Int32FromInt32(8) {
			...
			*(*int32)(unsafe.Pointer(bp))++
			*(*uint8)(unsafe.Pointer((*Txcb_auth_info_t)(unsafe.Pointer(info)).Fdata + uintptr(v2))) = uint8(0)
		}
...
func Xxcb_create_window_value_list_serialize(tls *libc.TLS, _buffer uintptr, value_mask Tuint32_t, _aux uintptr) (r int32) {
	...
	var _ /* xcb_pad0 at bp+0 */ [3]uint8
	...
	xcb_pad = uint32(0)
	*(*[3]uint8)(unsafe.Pointer(bp)) = [3]uint8{}
