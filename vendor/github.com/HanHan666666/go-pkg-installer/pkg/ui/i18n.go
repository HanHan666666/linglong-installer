...
var uiTranslations = map[string]map[string]string{
	"en": {
		...
		"dialog.uos.dev_mode.title": "Error",
		"dialog.uos.dev_mode.msg":   "Developer mode is disabled, root access is unavailable, and installation cannot continue.",
	...
	"zh": {
		...
		"dialog.uos.dev_mode.title": "错误",
		"dialog.uos.dev_mode.msg":   "未开启开发者模式，无法获取root权限，无法继续安装",
